...
Término: {2}
 ...
 <label anchor=""Right"" halign=""Far"" valign=""Center"">
  <text><![CDATA[ ]]></text> 
    ...
    //Ok
    public bool incluiParticipantesSelecionados(string[] arrayParticipantesEventos, string codigoEvento)
    {
        bool retorno = false;
        string comandoSQL = "";
        string mensagem = "";
        ...
        try
        {
            comandoSQL = string.Format(@"
                        ...
                        ", bancodb, Ownerdb, codigoEvento);//, whereDestinatarios);
    ...
    //Ok
    public bool excluiEvento(string codigoEvento, ref string mensagem)
    {
        int registrosAfetados = 0;
        bool retorno = false;
