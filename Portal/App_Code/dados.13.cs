    ...
    public void exportaGridView(ASPxGridViewExporter gve, string tipoExportacao)
    {
        ...
        using (MemoryStream stream = new MemoryStream())
        {
            ...
            else if (tipoExportacao == "XLS")
            {
                ...
                gve.WriteXlsToResponse(nomeArquivo, new DevExpress.XtraPrinting.XlsExportOptionsEx() { ExportType = DevExpress.Export.ExportType.WYSIWYG | DevExpress.Export.ExportType.DataAware });
            }
