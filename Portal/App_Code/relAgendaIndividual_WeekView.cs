...
public class relAgendaIndividual_WeekView : DevExpress.XtraScheduler.Reporting.XtraSchedulerReport
{
    ...
    public relAgendaIndividual_WeekView()
    {
        InitializeComponent();
    }
    ...
    {
        // string resourceFileName = "relAgendaIndividual_WeekView.resx";
