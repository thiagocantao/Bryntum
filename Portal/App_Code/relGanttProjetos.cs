...
/// </summary>
public class relGanttProjetos : DevExpress.XtraReports.UI.XtraReport
{
    ...
    private void InitData()
    {
        ...
        string command = string.Format(
            "SELECT * FROM [dbo].[f_GetGanttProjetosImpressao]({0},{1}) ORDER BY StringOrdenacao"
    ...
    {
        string resourceFileName = "relGanttProjetos.resx";
        System.Resources.ResourceManager resources = global::Resources.relGanttProjetos.ResourceManager;
