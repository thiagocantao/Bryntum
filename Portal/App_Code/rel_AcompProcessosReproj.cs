...
/// </summary>
public class rel_AcompProcessosReproj : DevExpress.XtraReports.UI.XtraReport
{
    #region Fields
    ...
    public rel_AcompProcessosReproj(int codigoUsuario, int codigoEntidade, int codigoUnidade, int ano)
    {
        InitializeComponent();
    ...
    private void InsereCamposDinamicosNaCapa()
    {
        ...
        stringSize = g.MeasureString("MAR/ABR 2013", drawFontMarAbr2013);
        x = (img.Width - stringSize.Width) / 2;
        y = img.Height * 0.65f;
        g.DrawString("MAR/ABR 2013", drawFontMarAbr2013, drawBrush, x, y);
        g.Flush();
        g.Save();
        ...
        stringSize = g1.MeasureString("MAR/ABR 2013", drawFontMarAbr2013);
        x = (img.Width - stringSize.Width) / 2;
        y = img.Height * 0.65f;
        g1.DrawString("MAR/ABR 2013", drawFontMarAbr2013, drawBrush, x, y);
        g1.Flush();
        g1.Save();
...
"do processo\' )";
        ...
        simpleDiagram1.LabelsResolveOverlappingMinIndent = 3;
        ...
        this.xrChart2.Legend.HorizontalIndent = 20;
        ...
        pieSeriesLabel1.EnableAntialiasing = DefaultBoolean.True;
        pieSeriesLabel1.Border.Visibility = DevExpress.Utils.DefaultBoolean.False;
        pieSeriesLabel1.Font = new System.Drawing.Font("Verdana", 8F);
        pieSeriesLabel1.LineLength = 4;
        pieSeriesLabel1.LineVisibility = DevExpress.Utils.DefaultBoolean.False;
        ...
        pieSeriesLabel1.TextPattern = "{VP:P1}";
        series7.Label = pieSeriesLabel1;
        ...
        this.xrChart2.SeriesTemplate.Label = pieSeriesLabel2;
        ...
        chartTitle1.Font = new System.Drawing.Font("Verdana", 8F);
    ...
    {
        var Ldraw = e.LegendDrawOptions as PieDrawOptions;
    ...
    private void GroupFooter2_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
    {
        ...
        if (rows.Length > 0)
        {
            ...
            PieSeriesView myView = (PieSeriesView)xrChart2.Series[0].View;
