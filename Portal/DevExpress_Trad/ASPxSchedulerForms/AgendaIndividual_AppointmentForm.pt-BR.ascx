...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="AgendaIndividual_AppointmentForm" CodeFile="AgendaIndividual_AppointmentForm.pt-BR.ascx.cs" %>
                ...
                <tr>
                    ...
                    <td class="dxscControlCell">
                        <dxe:ASPxDateEdit ClientInstanceName="edtStartDate" ID="edtStartDate" runat="server" 
                            Width="100%" Date='<%# ((AppointmentFormTemplateContainer)Container).Start %>' 
                            EditFormat="Custom" DateOnError="Undo" AllowNull="false" Font-Names="Verdana" 
                            Font-Size="8pt" DisplayFormatString="dd/MM/yyyy HH:mm" 
                            EditFormatString="dd/MM/yyyy HH:mm" UseMaskBehavior="True" >
                            <DisabledStyle ForeColor="Black">
                            </DisabledStyle>
                        </dxe:ASPxDateEdit>
                    </td>
                ...
                <tr>
                    ...
                    <td class="dxscControlCell">
                        <dxe:ASPxDateEdit id="edtEndDate" runat="server" Date='<%# ((AppointmentFormTemplateContainer)Container).End %>'
                            EditFormat="Custom" Width="100%" DateOnError="Undo" AllowNull="false" 
                            Font-Names="Verdana" Font-Size="8pt" DisplayFormatString="dd/MM/yyyy HH:mm" 
                            EditFormatString="dd/MM/yyyy HH:mm" UseMaskBehavior="True" 
                            ClientInstanceName="edtEndDate">
                            <DisabledStyle ForeColor="Black">
                            </DisabledStyle>
                        </dxe:ASPxDateEdit>
                    </td>
...
<% } %><dxe:ASPxLabel ID="ASPxLabel1" runat="server" AssociatedControlID="edtStatus" Text="Descrição:" Wrap="false" Font-Names="Verdana" Font-Size="8pt">
    ...
    <tr>
        <td class="dxscDoubleCell" colspan="2" style="height: 90px;">
            <table cellpadding="0" cellspacing="0" style="width: 100%">
                <tr>
                    <td><dxe:ASPxLabel ID="ASPxLabel2" runat="server" Text="Descrição:" AssociatedControlID="chkReminder" Font-Names="Verdana" Font-Size="8pt" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <dxhe:ASPxHtmlEditor ID="txtDescricao" runat="server" Height="190px" 
                            Width="690px" 
                            Html="<%# ((AppointmentFormTemplateContainer)Container).Appointment.Description %>">
	...
	_dxDescricao.SetText(s.GetHtml());
                            ...
                            <SettingsSpellChecker Culture="Portuguese (Brazil)">
                                <Dictionaries>
                                    <dxwsc:ASPxSpellCheckerDictionary AlphabetPath="~/DevExpress_Trad/ASPxSpellCheckerForms/pt_BR.aff"
                                        Culture="Portuguese (Brazil)" DictionaryPath="~/DevExpress_Trad/ASPxSpellCheckerForms/pt_BR.dic" EncodingName="Unicode (UTF-8)">
                                    </dxwsc:ASPxSpellCheckerDictionary>
                                    <dxwsc:ASPxSpellCheckerDictionary AlphabetPath="~/DevExpress_Trad/ASPxSpellCheckerForms/es_ES.aff"
                                        Culture="Spanish" DictionaryPath="~/DevExpress_Trad/ASPxSpellCheckerForms/es_ES.dic">
                                    </dxwsc:ASPxSpellCheckerDictionary>
                                    <dxwsc:ASPxSpellCheckerDictionary AlphabetPath="~/DevExpress_Trad/ASPxSpellCheckerForms/en_US.aff"
                                        Culture="English" DictionaryPath="~/DevExpress_Trad/ASPxSpellCheckerForms/en_US.dic">
                                    </dxwsc:ASPxSpellCheckerDictionary>
                                </Dictionaries>
        ...
        <td style="width: 100%; height: 100%;" align="right">
            <table style="height: 100%;">
                <tr>
                    ...
                    <td>
                        <dxe:ASPxButton runat="server" ClientInstanceName="btnOk" ID="btnOk" Text="OK" 
                            AutoPostBack="False" 
                            Width="91px" Font-Names="Verdana" Font-Size="8pt">
...
e.processOnServer = false;
	 	...
	 	var meuDataInicio = (dataInicio.getMonth() +1) + '/' + dataInicio.getDate() + '/' + dataInicio.getFullYear() + ' ' + dataInicio.getHours() +':' + dataInicio.getMinutes();
                 	dataInicio = Date.parse(meuDataInicio);
	 	var dataTermino = new Date(edtEndDate.GetValue());
	 	var meuDataTermino = (dataTermino.getMonth() +1) + '/' + dataTermino.getDate() + '/' + dataTermino.getFullYear()+ ' ' + dataTermino.getHours() +':' + dataTermino.getMinutes();
		...
		else
		{
 		...
 		aspxAppointmentSave(&quot;calendarioAgenda&quot;);
        	}	                        
}" />
                        </dxe:ASPxButton>
                    </td>
