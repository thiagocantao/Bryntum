...
public partial class AgendaIndividual_AppointmentForm : SchedulerFormControl
{
    private const int INT_Corporativo = 11;
    private const int INT_AtividadeProjetoAnalise = 12;
    private const int INT_AtividadeProjetoAprovado = 13;
    private int[] rotulosBloqueados = { INT_Corporativo, 
    ...
    public bool RotuloPermiteEdicao
    {
        get
        {
            ...
            return !rotulosBloqueados.Contains(int.Parse(apt.LabelKey.ToString()));
        }
    }
	...
	public override void DataBind() {
        ...
        if ((apt.CustomFields["Tipo"] != null && apt.CustomFields["Tipo"].ToString() == "R") || (!container.IsNewAppointment && !RotuloPermiteEdicao))
        {
        ...
        {
            foreach (int indiceRotulo in rotulosBloqueados.Reverse())
                edtLabel.Items.RemoveAt(indiceRotulo);
