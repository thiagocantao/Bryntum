...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="AgendaInstitucional_AppointmentForm" CodeFile="AgendaInstitucional_AppointmentForm.pt-BR.ascx.cs" %>
                ...
                <tr>
                    ...
                    <td class="dxscControlCell">
                        <dxe:ASPxComboBox ClientInstanceName="_dx" ID="edtLabel" runat="server" 
                            ...
                            Font-Names="Verdana" Font-Size="8pt" ClientEnabled="False" >
                            <DisabledStyle ForeColor="Black">
                            </DisabledStyle>
                        </dxe:ASPxComboBox>
                    </td>
        ...
        <td class="dxscSingleCell">
            <table class="dxscLabelControlPair" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="dxscControlCell">
                        <dxe:ASPxDateEdit ClientInstanceName="edtStartDate" ID="edtStartDate" runat="server" Width="100%" 
                        ...
                        Font-Size="8pt" DisplayFormatString="dd/MM/yyyy HH:mm" EditFormatString="dd/MM/yyyy HH:mm" UseMaskBehavior="True" >
                            <DisabledStyle ForeColor="Black">
                            </DisabledStyle>
                        </dxe:ASPxDateEdit>
                    </td>
                ...
                <tr>
                    ...
                    <td class="dxscControlCell">
                        <dxe:ASPxDateEdit id="edtEndDate" runat="server" Date='<%# ((AppointmentFormTemplateContainer)Container).End %>'
                            EditFormat="Custom" Width="100%" DateOnError="Undo" AllowNull="false" Font-Names="Verdana" Font-Size="8pt" 
