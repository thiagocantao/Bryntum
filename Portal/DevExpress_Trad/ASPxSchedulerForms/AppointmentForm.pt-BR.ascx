...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="AppointmentForm" CodeFile="AppointmentForm.pt-BR.ascx.cs" %>
    ...
    <tr>
        <td class="dxscDoubleCell" colspan="2" style="height: 90px;">
            <table cellpadding="0" cellspacing="0" style="width: 100%">
                ...
                <tr>
                    <td>
                        <dxhe:ASPxHtmlEditor ID="txtDescricao" runat="server" Height="150px" Width="690px" Html="<%# ((AppointmentFormTemplateContainer)Container).Appointment.Description %>">
                            <SettingsDialogs>
                                <InsertImageDialog>
