...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="ConflitosAgenda_AppointmentForm" CodeFile="ConflitosAgenda_AppointmentForm.pt-BR.ascx.cs" %>
        ...
        <td class="dxscSingleCell">
            <table class="dxscLabelControlPair" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="dxscControlCell">
                        <dxe:ASPxDateEdit ClientInstanceName="_dx" ID="edtStartDate" runat="server" Width="100%" Date='<%# ((AppointmentFormTemplateContainer)Container).Start %>' EditFormat="Custom" DateOnError="Undo" AllowNull="false" Font-Names="Verdana" Font-Size="8pt" DisplayFormatString="{0:dd/MM/yyyy HH:mm}" EditFormatString="dd/MM/yyyy HH:mm" >
                            <DisabledStyle ForeColor="Black">
                            </DisabledStyle>
                        </dxe:ASPxDateEdit>
                    </td>
                ...
                <tr>
                    ...
                    <td class="dxscControlCell">
                        <dxe:ASPxDateEdit id="edtEndDate" runat="server" Date='<%# ((AppointmentFormTemplateContainer)Container).End %>'
                            EditFormat="Custom" Width="100%" DateOnError="Undo" AllowNull="false" Font-Names="Verdana" Font-Size="8pt" DisplayFormatString="{0:dd/MM/yyyy HH:mm}" EditFormatString="dd/MM/yyyy HH:mm">
                            <DisabledStyle ForeColor="Black">
                            </DisabledStyle>
                        </dxe:ASPxDateEdit>
                    </td>
    ...
    <tr>
        <td class="dxscDoubleCell" colspan="2" style="height: 90px;">
            <table cellpadding="0" cellspacing="0" style="width: 100%">
                ...
                <tr>
                    <td>
                        <dxhe:ASPxHtmlEditor ID="txtDescricao" runat="server" Height="150px" Width="690px">
                            <SettingsDialogs>
                                <InsertImageDialog>
                        ...
                        <dxe:ASPxMemo ID="tbDescription" runat="server" ClientInstanceName="_dx" ClientVisible="False"
