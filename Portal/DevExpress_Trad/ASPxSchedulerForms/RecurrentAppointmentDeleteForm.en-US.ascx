...
{************************************************************************************}
--%>
<%@ Control Language="C#" AutoEventWireup="true" Inherits="RecurrentAppointmentDeleteForm" CodeFile="RecurrentAppointmentDeleteForm.en-US.ascx.cs" %>
...
<table style="width:100%; height:100%">
    <tr>
        ...
        <td style="width:100%;">
            <dxe:ASPxLabel ID="lblConfirm" runat="server" Text='<%# "Do you really want to delete the recurring event? \"" + ((DevExpress.Web.ASPxScheduler.RecurrentAppointmentDeleteFormTemplateContainer)Container).Appointment.Subject + "\"?"%>'/>
        </td>
    </tr>
    <tr>
        <td style="width:100%;">
            <dxe:ASPxRadioButtonList ID="rbAction" runat="server" ValueType="System.Int32" SelectedIndex="0">
                                ...
                                <Items>
                                    <dxe:ListEditItem Text="All Events" Value="1" />
                                    <dxe:ListEditItem Text="Only this Occurrence" Value="2" />
                                </Items>
