...
{************************************************************************************}
--%>
<%@ Control Language="C#" AutoEventWireup="true" Inherits="RecurrentAppointmentDeleteForm" CodeFile="RecurrentAppointmentDeleteForm.pt-BR.ascx.cs" %>
...
<table style="width:100%; height:100%">
    <tr>
        <td rowspan="2"  style="vertical-align:top;">
            <dxe:ASPxImage id="Image" runat="server" EnableViewState="False" ImageUrl='~/imagens/confirmacao.png' Width="48px" Height="48px"  >
            </dxe:ASPxImage>
        </td>
        <td style="width:100%;">
            <dxe:ASPxLabel ID="lblConfirm" runat="server" Text='<%# "Deseja Realmente Excluir o Evento Recorrente \"" + ((DevExpress.Web.ASPxScheduler.RecurrentAppointmentDeleteFormTemplateContainer)Container).Appointment.Subject + "\"?"%>'/>
        </td>
    </tr>
    <tr>
        <td style="width:100%;">
            <dxe:ASPxRadioButtonList ID="rbAction" runat="server" ValueType="System.Int32" SelectedIndex="0">
                                ...
                                <Items>
                                    <dxe:ListEditItem Text="Todas as Ocorrências" Value="1" />
                                    <dxe:ListEditItem Text="Somente esta Ocorrência" Value="2" />
                                </Items>
