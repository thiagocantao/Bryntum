<%@ Page Language="C#" AutoEventWireup="true" CodeFile="md_003.aspx.cs" Inherits="_Dashboard_VisaoCorporativa_md_003" %>
                        ...
                        <tr>
                            <td align="left">
                                <dxe:ASPxLabel ID="ASPxLabel1" runat="server" 
                                    Text="Alocação Semanal(h)">
                                </dxe:ASPxLabel>
                                &nbsp;</td>
                            <td align="right">
                                <img align="right" alt="Visualizar gráfico em modo ampliado" onclick="javascript:f_zoomGrafico('../zoom.aspx', '', 'Flashs/ScrollCombi2D.swf', '<%=grafico_xmlzoom %>', '0')"
