...
public partial class _relAnaliseIndicadores2 : System.Web.UI.Page
{
    #region Fields
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            cDados.VerificaAcessoTela(this, codigoUsuarioLogado, codigoEntidade, codigoEntidade, "null", "EN", 0, "null", "EN_EstRelInd");
        }
  ...
  WHERE (CodigoLista = @CodigoLista)";
    ...
    private PivotArea GetPivotArea(string strPivotArea)
    {
        switch (strPivotArea.ToUpper())
        {
            ...
            default:
                throw new ArgumentException(Resources.traducao.relAnaliseIndicadores2_a__rea_informada_n_o___v_lida_);
        }
    }
    ...
    protected void callback_Callback(object source, DevExpress.Web.CallbackEventArgs e)
    {
        ...
        switch (parameter)
        {
            case "export":
                ...
                exporter.ExportToXls(stream, options);
 ...
 DELETE 
  ...
  WHERE CodigoListaUsuario IN(SELECT lu.CodigoListaUsuario FROM ListaUsuario lu WHERE lu.CodigoUsuario = @CodigoUsuario AND lu.CodigoLista = @CodigoLista)
    ...
    private void defineAlturaTela()
    {
        ...
        Div2.Style.Add("height", (alturaPrincipal - 310) + "px");//a div vai ficar com essa altura
