<%@ Page Language="C#" AutoEventWireup="true" CodeFile="relMonitoramentoSMD.aspx.cs" Inherits="_Estrategias_Relatorios_relMonitoramentoSMD" %>
    ...
    <div>
        ...
        <table>
            ...
            <td>
                    ...
                    cellspacing="0" style="width:100%"><tr runat="server"><td runat="server" style="padding: 3px" 
                                            valign="top">
...
<dxwpg:ASPxPivotGrid ID="pgDados" runat="server" ClientIDMode="AutoID" 
                        ...
                        <Fields>
   <dxpgwx:PivotGridField ID="fieldAno" Area="ColumnArea" AreaIndex="0" 
                                FieldName="Ano" Visible="False" AllowedAreas="ColumnArea, FilterArea">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldNomeIndicador" Area="RowArea" AreaIndex="4" 
                                Caption="Indicador" FieldName="NomeIndicador" 
                                AllowedAreas="RowArea, FilterArea">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldNomeUnidadeNegocio" Area="RowArea" 
                                AreaIndex="5" Caption="Unidade" FieldName="NomeUnidadeNegocio" 
                                AllowedAreas="RowArea, FilterArea">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldGrupoProduto" Area="RowArea" AreaIndex="0" 
                                Caption="Grupo de Produto" FieldName="GrupoProduto" 
                                AllowedAreas="RowArea, FilterArea">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldClientela" Area="RowArea" AreaIndex="3" 
                                Caption="Clientela" FieldName="Clientela" 
                                AllowedAreas="RowArea, FilterArea">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldCR" Area="RowArea" AreaIndex="1" Caption="CR" 
                                FieldName="CR" Visible="False" AllowedAreas="RowArea, FilterArea">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldFinanciamento" Area="RowArea" AreaIndex="6" 
                                Caption="Financiamento" FieldName="Financiamento" 
                                AllowedAreas="RowArea, FilterArea">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldProduto" Area="RowArea" AreaIndex="1" 
                                Caption="Produto" FieldName="Produto" AllowedAreas="RowArea, FilterArea">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldTituloFormulario" Area="RowArea" AreaIndex="2" 
                                Caption="Título Formulário" FieldName="TituloFormulario" 
                                AllowedAreas="RowArea, FilterArea">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldCNAE1" AreaIndex="0" FieldName="CNAE" 
                                AllowedAreas="FilterArea">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldCNPJ1" AreaIndex="1" FieldName="CNPJ" 
                                AllowedAreas="FilterArea">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldIndustrial1" AreaIndex="2" 
                                FieldName="Industrial" AllowedAreas="FilterArea">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldModalidade1" AreaIndex="3" 
                                FieldName="Modalidade" AllowedAreas="FilterArea" Caption="Modalidade">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldSerie1" AreaIndex="4" FieldName="Serie" 
                                AllowedAreas="FilterArea">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldCargaHoraria1" AreaIndex="5" 
                                FieldName="CargaHoraria" AllowedAreas="FilterArea">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldCodigoEntidade1" AreaIndex="6" 
                                FieldName="CodigoEntidade" AllowedAreas="FilterArea" Visible="False">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldTipoControle1" Area="ColumnArea" AreaIndex="0" 
                                Caption="Tipo Controle" FieldName="TipoControle" Visible="False" 
                                AllowedAreas="ColumnArea, FilterArea">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldqtdPrevistoAno0" Area="DataArea" AreaIndex="6" 
                            ...
                            <dxpgwx:PivotGridField ID="fieldqtdRealAno0" Area="DataArea" AreaIndex="8" 
                                FieldName="qtdRealAno0" AllowedAreas="DataArea" 
                                CellFormat-FormatString="{0:n0}" CellFormat-FormatType="Custom">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldqtdRealAno1" Area="DataArea" AreaIndex="4" 
                                FieldName="qtdRealAno1" AllowedAreas="DataArea" 
                                CellFormat-FormatString="{0:n0}" CellFormat-FormatType="Custom">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldqtdRealAno2" Area="DataArea" AreaIndex="2" 
                                FieldName="qtdRealAno2" AllowedAreas="DataArea" 
                                CellFormat-FormatString="{0:n0}" CellFormat-FormatType="Custom">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldqtdPrevistoPeriodoAno0" Area="DataArea" 
                                AreaIndex="7" FieldName="qtdPrevistoPeriodoAno0" AllowedAreas="DataArea" 
                                CellFormat-FormatString="{0:n0}" CellFormat-FormatType="Custom">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldqtdRealPeriodoAno1" Area="DataArea" 
                                AreaIndex="5" FieldName="qtdRealPeriodoAno1" AllowedAreas="DataArea" 
                                CellFormat-FormatString="{0:n0}" CellFormat-FormatType="Custom">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldqtdRealPeriodoAno2" Area="DataArea" 
                                AreaIndex="3" FieldName="qtdRealPeriodoAno2" AllowedAreas="DataArea" 
                                CellFormat-FormatString="{0:n0}" CellFormat-FormatType="Custom">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldRealPlanoAnual" Area="DataArea" AreaIndex="9" 
                                Caption="fieldRealPlanoAnual" AllowedAreas="DataArea" 
                                CellFormat-FormatString="{0:n0}" CellFormat-FormatType="Custom">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldRealPlano0" Area="DataArea" AreaIndex="10" 
                                Caption="fieldRealPlano0" AllowedAreas="DataArea" 
                                CellFormat-FormatString="{0:n0}" CellFormat-FormatType="Custom">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldRealPlano1" Area="DataArea" AreaIndex="11" 
                                Caption="fieldRealPlano1" AllowedAreas="DataArea" 
                                CellFormat-FormatString="{0:n0}" CellFormat-FormatType="Custom">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldRealPlano2" Area="DataArea" AreaIndex="12" 
                                Caption="fieldRealPlano2" AllowedAreas="DataArea" 
                                CellFormat-FormatString="{0:n0}" CellFormat-FormatType="Custom">
                            </dxpgwx:PivotGridField>
                            <dxpgwx:PivotGridField ID="fieldvalorRealOrcAno" AllowedAreas="DataArea" 
                                Area="DataArea" AreaIndex="1" Caption="Orc. Realizado" 
                                CellFormat-FormatString="n2" CellFormat-FormatType="Numeric" 
                                FieldName="valorRealOrcAno">
                            </dxpgwx:PivotGridField>
                        ...
                        <OptionsView ShowColumnTotals="False" ShowColumnGrandTotalHeader="False" 
                            HorizontalScrollBarMode="Auto" ShowDataHeaders="False" VerticalScrollBarMode="Visible" />
