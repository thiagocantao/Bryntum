...
public partial class mt_002 : System.Web.UI.Page
{
    ...
    private void geraGrafico()
    {
        ...
        if (cDados.DataSetOk(dsGrafico))
        {
            ...
            xml = cDados.getGraficoPeriodosIndicadorMetas(dt, "", 9, casasDecimais, 9, 2, 12, codigoIndicador.ToString());
    ...
    {
        DataSet dsProjetos = cDados.getProjetosIndicador(codigoIndicador, codigoUnidadeNegocio, "");
