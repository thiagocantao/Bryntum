<%@ Page Language="C#" AutoEventWireup="true" CodeFile="visaoMetas_02.aspx.cs" Inherits="_Portfolios_visaoCorporativa_01" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function abreIndicador(coin, cun) {
            window.open('../indicador/index.aspx?NivelNavegacao=2&COIN=' + coin + '&UN=' + cun, '_top');
        }
    </script>
</head>
<body style="margin: 0px">
	...
	if(e.group.GetExpanded())
	{
		...
		var codigoUnidade = e.group.items[0].name.split(';')[2];
		document.getElementById('frm2_' + e.group.name).src = &quot;mt_002.aspx?CI=&quot; + codigoIndicador + &quot;&amp;UN=&quot; + codigoUnidade + &quot;&amp;CD=&quot; + casasDecimais;
	}
}" />
                ...
                <dxpc:PopupControlContentControl runat="server">
                    <table id="pnCallback_grid_DXPEForm_DXEFT" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="left" rowspan="1" style="height: 10px"></td>
                            </tr>
                            <tr>
                                <td align="left" rowspan="1">
                            ...
                            <tr>
                                <td rowspan="1" style="height: 10px"></td>
                            </tr>
                            <tr>
                                <td align="left" rowspan="1">
