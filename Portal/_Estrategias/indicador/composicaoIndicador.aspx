<%@ Page Language="C#" AutoEventWireup="true" CodeFile="composicaoIndicador.aspx.cs"
    Inherits="_Estrategias_indicador_composicaoIndicador" %>
                        ...
                        <table>
                            <tr>
                                <td>&nbsp;<dxe:ASPxLabel ID="lblTitulo" CssClass="lblTituloTela" runat="server" ClientInstanceName="lblTituloSelecao"
                                    Font-Bold="True" Text="Dados do Indicador">
                                </dxe:ASPxLabel>
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <tr>
                                        <td>
                                            <dxpgwx:ASPxPivotGridExporter ID="ASPxPivotGridExporter1" runat="server"
                                                ASPxPivotGridID="pvgDadosIndicador"
                            ...
                            <td valign="top">
                                <div id="Div2" style="overflow: auto; height: <%=alturaDivGrid %>; width: <%=larguraDivGrid %>">
                                    ...
                                    <dxwpg:ASPxPivotGrid ID="pvgDadosIndicador" runat="server" ClientInstanceName="pvgDadosIndicador"
                                        Width="100%" OnCustomFieldSort="pvgDadosIndicador_CustomFieldSort" OnCustomSummary="pvgDadosIndicador_CustomSummary"
                                        OnFieldAreaIndexChanged="pvgDadosIndicador_FieldAreaIndexChanged" OnFieldFilterChanged="pvgDadosIndicador_FieldFilterChanged"
                                        OnFieldVisibleChanged="pvgDadosIndicador_FieldVisibleChanged" OnCustomCellDisplayText="pvgDadosIndicador_CustomCellDisplayText"
                                        OnFieldAreaChanged="pvgDadosIndicador_FieldAreaChanged"
                                        ClientIDMode="AutoID">
                                        <Fields>
                                            <dxwpg:PivotGridField FieldName="Unidade" ID="fldUnidade" AllowedAreas="RowArea, ColumnArea, FilterArea" Area="RowArea" AreaIndex="1" Caption="Unidade" UseNativeFormat="True">
                                                <CellStyle></CellStyle>
                                                <HeaderStyle></HeaderStyle>
                                                <ValueStyle></ValueStyle>
                                                <ValueTotalStyle></ValueTotalStyle>
                                            </dxwpg:PivotGridField>
                                            <dxwpg:PivotGridField FieldName="Dado" ID="fldDado" AllowedAreas="RowArea, ColumnArea" Area="RowArea" AreaIndex="0" Caption="Dado" UseNativeFormat="True">
                                                <CellStyle></CellStyle>
                                                <HeaderStyle></HeaderStyle>
                                                <ValueStyle></ValueStyle>
                                                <ValueTotalStyle></ValueTotalStyle>
                                            </dxwpg:PivotGridField>
                                            <dxwpg:PivotGridField FieldName="Mes" ID="fldMes" AllowedAreas="RowArea, ColumnArea, FilterArea" Area="ColumnArea" AreaIndex="0" Visible="False" Caption="M&#234;s" SortMode="Custom" UseNativeFormat="True">
                                                <CellStyle></CellStyle>
                                                <HeaderStyle></HeaderStyle>
                                                <ValueStyle></ValueStyle>
                                                <ValueTotalStyle></ValueTotalStyle>
                                            </dxwpg:PivotGridField>
                                            <dxwpg:PivotGridField FieldName="Valor" ID="fldValor" AllowedAreas="DataArea" Area="DataArea" AreaIndex="0" Caption="Valor" SummaryType="Custom" CellFormat-FormatType="Numeric" TotalCellFormat-FormatType="Numeric" GrandTotalCellFormat-FormatType="Numeric" ValueFormat-FormatType="Numeric" TotalValueFormat-FormatType="Numeric" UseNativeFormat="True">
                                                <CellStyle></CellStyle>
                                                <HeaderStyle></HeaderStyle>
                                                <ValueStyle></ValueStyle>
                                                <ValueTotalStyle></ValueTotalStyle>
                                            ...
                                            <dxwpg:PivotGridField FieldName="Indicador" ID="fldIndicador" AllowedAreas="RowArea, ColumnArea, FilterArea" Area="RowArea" AreaIndex="0" Visible="False" Caption="Indicador">
                                                <CellStyle></CellStyle>
                                                <HeaderStyle></HeaderStyle>
                                                <ValueStyle></ValueStyle>
                                                <ValueTotalStyle></ValueTotalStyle>
