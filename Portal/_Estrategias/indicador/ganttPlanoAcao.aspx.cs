...
public partial class _Estrategias_indicador_ganttPlanoAcao : System.Web.UI.Page
{
    dados cDados;
    ...
    {
        DataSet ds = cDados.getDadosIndicador(codigoIndicador, "");

        if (cDados.DataSetOk(ds) && cDados.DataTableOk(ds.Tables[0]))
        {
            txtIndicador.Text = ds.Tables[0].Rows[0]["NomeIndicador"].ToString();
        }
        else
        {
            txtIndicador.Text = "";
    ...
    private void defineLarguraTela()
    {
        ...
        alturaGrafico = (alturaPrincipal - 280).ToString();
    }
    ...
    private void geraGrafico()
    {
        ...
        DataSet ds = cDados.getCronogramaGanttPlanoAcao(codigoIndicador, codigoEntidade, "IN", where);
