<%@ Page Language="C#" AutoEventWireup="true" CodeFile="resumoIndicador.aspx.cs"
    Inherits="_Estrategias_indicador_resumoIndicador" %>
...
<body class="body">
                ...
                <tr style="height: 26px">
                    <td valign="middle" style="padding-right: 10px;">
                        <table cellpadding="0" cellspacing="0" style="width: 100%;">
                            <tr>
                                <td>
                                    <dxe:ASPxLabel CssClass="titulo-tela" ID="lblTitulo" runat="server" ClientInstanceName="lblTituloSelecao"
                                        Font-Bold="True" Text="Detalhes">
                                    </dxe:ASPxLabel>
                                </td>
                                <td align="right" style="width: 170px">
                                    <dxe:ASPxLabel ID="lblUnidade" EncodeHtml="False" runat="server"
                                        Text="Unidade de Negócio:&nbsp;" ClientInstanceName="lblUnidade">
                                    </dxe:ASPxLabel>
                                </td>
                                <td style="width: 110px">
                                    <dxe:ASPxComboBox ID="ddlUnidade" runat="server"
                                        ...
                                        <Columns>
                                            <dxe:ListBoxColumn Caption="Sigla da Unidade" Width="150px" />
                                            <dxe:ListBoxColumn Caption="Nome da Unidade" Width="250px" />
                                        </Columns>
                                    </dxe:ASPxComboBox>
                                </td>
                                ...
                                <td style="width: 120px">
                                    <dxe:ASPxComboBox ID="ddlPeriodo" runat="server"
                                        Width="100%" ClientInstanceName="ddlPeriodo" EnableCallbackMode="True">
                                    </dxe:ASPxComboBox>
                                </td>
	...
	if(ddlUnidade.GetValue() == s.cp_UNL)
		...
		parent.lblEntidadeDiferente.SetText(&quot;*Voc&#234; est&#225; Visualizando as Informa&#231;&#245;es da Unidade: &quot; + ddlUnidade.GetText());
	callback.PerformCallback('A');
                                    ...
                                    <table cellpadding="0" cellspacing="0" style="width: 100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxLabel ID="ASPxLabel10" runat="server"
                                                                Text="Mapa Estratégico:" Visible="False">
                                                            </dxe:ASPxLabel>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxTextBox ID="txtMapa" runat="server" ClientEnabled="False" Width="100%" Visible="False">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxLabel ID="ASPxLabel1" runat="server"
                                                                Text="Objetivo Estratégico:" Visible="False">
                                                            </dxe:ASPxLabel>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <tr>
                                            <td style="padding-top: 5px">
                                                <iframe id="periodoIndicador" src="<%=telaPeriodo %>" width="100%" height="<%=alturaGrid %>"
