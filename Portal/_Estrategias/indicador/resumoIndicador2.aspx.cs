...
public partial class _Estrategias_indicador_resumoIndicador2 : System.Web.UI.Page
{
    dados cDados;
    private int codigoIndicador = 0, codigoObjetivo = 0, codigoMapa = 0, codigoUnidade = 0;
    public int alturaGrafico = 220, alturaGrid = 145;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.TH(this.TS("resumoIndicador2"));
    }
    ...
    private void defineObjetosSessao()
    {
        if (!IsPostBack)
        {
            ...
            if (cDados.getInfoSistema("AnoIndicador") != null && cDados.getInfoSistema("MesIndicador") != null)
            {
                ...
                ddlPeriodo.Value = string.Format("{0}{1:D2}", ano, mes);
            }
        }
    ...
    private void montaCampos()
    {
        ...
        if (cDados.DataTableOk(dtCampos))
        {
            ...
            txtPolaridade.Text = (dtCampos.Rows[0]["Polaridade"].ToString() == "POS") ? Resources.traducao.resumoIndicador2_quanto_maior__melhor : Resources.traducao.resumoIndicador2_quanto_maior__pior;
            ...
            if (dtCampos.Rows[0]["Polaridade"].ToString() == "NEG")
            {
                ...
                imgPolaridade.ToolTip = Resources.traducao.resumoIndicador2_polaridade_negativa_quanto_maior__pior_;
            }
            else
            {
                imgPolaridade.ImageUrl = "~/imagens/botoes/PolaridadeP.png";
                imgPolaridade.ToolTip = Resources.traducao.resumoIndicador2_polaridade_positiva_quanto_maior__melhor_;
            }
        }
    }
    ...
    private void defineAlturaTela()
    {
        ...
        alturaGrid = (alturaPrincipal - 440);
    }
    ...
    private void verificaTelaApresentada()
    {
        if (ddlUnidade.SelectedIndex != -1)
        {            
            graficoInicial = "./graficos/grafico_003.aspx?COIN=" + codigoIndicador + "&COE=" + codigoObjetivo;   
