<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ObjetivoEstrategico_AcoesSugeridas.aspx.cs" Inherits="_Estrategias_objetivoEstrategico_ObjetivoEstrategico_AcoesSugeridas" %>
...
<body style="margin: 0px;">
    <form id="form1" runat="server">
	 ...
	 var  labelAcaoSugerida = hfGeral.Get('labelAcaoSugeridaEstrategia');
    
    if (window.onClick_btnCancelar)
		onClick_btnCancelar();
    if('Incluir' == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(labelAcaoSugerida + ' ' + traducao.ObjetivoEstrategico_AcoesSugeridas_inclu_da_com_sucesso_);
    else if('Editar' == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(traducao.ObjetivoEstrategico_AcoesSugeridas_dados_gravados_com_sucesso_);
    else if('Excluir' == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(labelAcaoSugerida + ' ' + traducao.ObjetivoEstrategico_AcoesSugeridas_exclu_da_com_sucesso_);
}" />
                                    <PanelCollection>
                                        <dxp:PanelContent runat="server">
                                            <dxwgv:ASPxGridView runat="server" ClientInstanceName="gvDados" KeyFieldName="CodigoAcaoSugerida" AutoGenerateColumns="False" Width="100%" ID="gvDados" OnCustomButtonInitialize="gvDados_CustomButtonInitialize">
     ...
     {	
		...
		pcDados.Show();
                                                ...
                                                <Columns>
                                                    ...
                                                    <dxwgv:GridViewDataTextColumn FieldName="DescricaoAcao" Name="DescricaoAcao" Caption="Descri&#231;&#227;o" VisibleIndex="1"></dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn FieldName="TextoAcaoSugerida" Name="TextoAcaoSugerida" Caption="Texto" Visible="False" VisibleIndex="2"></dxwgv:GridViewDataTextColumn>
                                                </Columns>
                                            ...
                                            <dxpc:ASPxPopupControl runat="server" ClientInstanceName="pcDados" CloseAction="None" HeaderText="Detalhes" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ShowCloseButton="False" Width="700px" ID="pcDados">
                                                <ContentStyle>
                                                    ...
                                                    <dxpc:PopupControlContentControl runat="server">
                                                        <table cellspacing="0" cellpadding="0" width="700px" border="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <dxe:ASPxLabel runat="server" Text="Descri&#231;&#227;o:" Width="700px" ClientInstanceName="lblDescricao" ID="lblDescricao"></dxe:ASPxLabel>

                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="100%" MaxLength="250" ClientInstanceName="txtDescricao" ID="txtDescricao">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <dxhe:ASPxHtmlEditor runat="server" ClientInstanceName="htmlTexto" Width="700px" Height="200px" ID="htmlTexto">
                                                                            <Toolbars>
                                                                    ...
                                                                    <td align="right">
                                                                        <table class="formulario-botoes" cellspacing="0" cellpadding="0" border="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        <dxe:ASPxButton runat="server" ClientInstanceName="btnSalvar" Text="Salvar" Width="90px" ID="btnSalvar" AutoPostBack="False">
                                                                                            <ClientSideEvents Click="function(s, e) {
	e.processOnServer = false;
                                                                                                if(verificarDadosPreenchidos()== true){
    ...
    if (window.onClick_btnCancelar)
       onClick_btnCancelar();
                                            ...
                                            <dxpc:ASPxPopupControl runat="server" ClientInstanceName="pcUsuarioIncluido" HeaderText="Incluir a Entidade Atual" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ShowCloseButton="False" ShowHeader="False" Width="270px" ID="pcUsuarioIncluido">
                                                <ContentCollection>
                                                    <dxpc:PopupControlContentControl runat="server">
