 ...
 * MUDANÇAS
 * 
 * 24/03/2011 :: Alejandro : Alteração de acesso a tela [OB_CnsEtg], e dos códigos de permissão
 *  
 */
using System;
using System.Data;
...
public partial class _Estrategias_objetivoEstrategico_ObjetivoEstrategico_Estrategias : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            bPodeAcessarTela = cDados.VerificaAcessoEmAlgumObjeto(idUsuarioLogado, codigoUnidadeLogada, "OB", "OB_CnsEtg");
            if (!bPodeAcessarTela)
    ...
    private void headerOnTela()
    {
        ...
        Header.Controls.Add(cDados.getLiteral(@"<script type=""text/javascript"" language=""javascript"" src=""../../scripts/ObjetivoEstrategico_Estrategias.js""></script>"));
        Header.Controls.Add(cDados.getLiteral(@"<script type=""text/javascript"" language=""javascript"" src=""../../scripts/_Strings.js""></script>"));
        this.TH(this.TS("barraNavegacao", "ObjetivoEstrategico_Estrategias"));
    }
    ...
    {
        DataTable dt = cDados.getParametrosSistema("labelLinhasAtuacao", "labelLinhaAtuacao").Tables[0];
        if (dt.Rows.Count > 0)
        {
            labelPlural = dt.Rows[0]["labelLinhasAtuacao"].ToString();
            labelSingular = dt.Rows[0]["labelLinhaAtuacao"].ToString();
        }
    ...
    private void getPermissoesTela()
    {
        ...
        podeIncluir = (cDados.VerificaPermissaoUsuario(idUsuarioLogado, codigoEntidadeUnidadeSelecionada, codigoObjetivoEstrategico, "NULL", "OB", 0, "NULL", "OB_IncEtg"));
        podeEditar = (cDados.VerificaPermissaoUsuario(idUsuarioLogado, codigoEntidadeUnidadeSelecionada, codigoObjetivoEstrategico, "NULL", "OB", 0, "NULL", "OB_AltEtg"));
        podeExcluir = (cDados.VerificaPermissaoUsuario(idUsuarioLogado, codigoEntidadeUnidadeSelecionada, codigoObjetivoEstrategico, "NULL", "OB", 0, "NULL", "OB_ExcEtg"));
        podeConsultar = true;
    ...
    {
        DataSet ds = cDados.getObjetivoEstrategicoEstrategias(codigoObjetivoEstrategico.ToString());
    ...
    private string persisteInclusaoRegistro()
    {
        ...
        try
        {
            ...
            if (cDados.incluiObjetivoEstrategicoEstrategias(descricao, memoTexto, idUsuarioLogado.ToString(), codigoTipoAssociacao.ToString(), codigoObjetivoEstrategico.ToString(), codigoUnidadeLogada.ToString()))
            {
                carregarGrid();
    ...
    {   // busca a chave primaria
        ...
        try
        {
            if (cDados.atualizaObjetivoEstrategicoEstrategias(descricao, memoTexto, codigoTipoAssociacao.ToString()
    ...
    {   // busca a chave primaria
        ...
        cDados.excluiObjetivoEstrategicoEstrategias(idUsuarioLogado.ToString(), chave);
        carregarGrid();
        //gvDados.ClientVisible = false;
    ...
    protected void menu_ItemClick(object source, DevExpress.Web.MenuItemEventArgs e)
    {
        ...
        cDados = CdadosUtil.GetCdados(listaParametrosDados);
        cDados.eventoClickMenu((source as ASPxMenu), parameter, ASPxGridViewExporter1, "EstratObjEst");
    }
    ...
    protected void menu_Init(object sender, EventArgs e)
    {
        ...
        cDados = CdadosUtil.GetCdados(listaParametrosDados);
        cDados.setaDefinicoesBotoesInserirExportar((sender as ASPxMenu), podeIncluir, "Click_NovaAcaoSugerida();", true, true, false, "EstratObjEst", "Estratégias", this);
    }
