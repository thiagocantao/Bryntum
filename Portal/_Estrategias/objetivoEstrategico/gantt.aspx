<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gantt.aspx.cs" Inherits="_Estrategias_objetivoEstrategico_gantt" %>
...
<head id="Head1" runat="server">
    <base target="_self" />
    <title><asp:Literal runat="server" Text="<%$ Resources:traducao, gantt_gantt_dos_projetos_associados_ao_objetivo_estrat_gico_selecionado %>" /></title>
                                            ...
                                            <table cellpadding="0" cellspacing="0" enableviewstate="false">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td id="legAmarelo" runat="server" 
                                                            style="width: 10px; border: 1px solid #808080; background-color: #7342d7;">
                                                        </td>
                                                        <td style="padding-left: 3px; padding-right:10px">
                                                        ...
                                                        <td style="padding-left: 3px; padding-right:10px">
                                                            <span>
                                                            <asp:Label ID="Label7" runat="server" Font-Italic="True" Text="Marcos em Itálico"></asp:Label>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </tbody>
