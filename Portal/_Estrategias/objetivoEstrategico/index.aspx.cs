...
public partial class _Estrategias_objetivoEstrategico_index : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            Master.verificaAcaoFavoritos(true, "Objetivo Estratégico", "OBJ_ES", "OBJ", codigoObjetivoEstrategico, "Adicionar Objetivo aos Favoritos");
        }
    }
    ...
    private string getAlturaTela()
    {
        ...
        return (alturaTela - 148).ToString();
    }
