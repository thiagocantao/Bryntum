...
public partial class gantt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            codigoObjetivo = int.Parse(Request.QueryString["CT"].ToString());
        }        
    ...
    {        
        DataSet ds = cDados.getTemaEstrategico(codigoObjetivo, "");

        if (cDados.DataSetOk(ds) && cDados.DataTableOk(ds.Tables[0]))
        {
            txtObjetivoEstrategico.Text = ds.Tables[0].Rows[0]["Tema"].ToString();
        }
        else
        {
    ...
    private void geraGrafico()
    {
        ...
        string nomeGrafico = @"/ArquivosTemporarios/GanttTarefasPlanoAcaoTEM_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        DataSet ds = cDados.getCronogramaGanttPlanoAcao(codigoObjetivo, codigoEntidade, "TM", where);
