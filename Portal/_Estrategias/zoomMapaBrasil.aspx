<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zoomMapaBrasil.aspx.cs" Inherits="_Estrategias_zoomMapaBrasil" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="../scripts/FusionMaps.js" language="javascript"></script>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <script type="text/javascript">
                                                    getGraficoMapa('<%=grafico_swf %>', "grafico_1", '890', '600', '<%=grafico_xml %>', 'chartdiv');
                                                </script>                                                 
                                            </td>
                                        </tr>
                                    </table>
