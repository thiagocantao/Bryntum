<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vc_001.aspx.cs" Inherits="_Orcamentos_graficos_vc_001" %>
...
<body style="margin:0px">
    ...
    <div style="text-align: center">
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="#FFFFFF"
            ...
            Height="215px" Width="210px" ImageFolder="~/App_Themes/PlasticBlue/{0}/" ClientInstanceName="ASPxRoundPanel1">
                    ...
                    <tr>
                        <td align="left">
                            <dxe:ASPxLabel ID="ASPxLabel1" runat="server" 
                                Text="Orçamento - Desempenho">
                            </dxe:ASPxLabel>
                            &nbsp;</td>
                        <td align="right">
                            <img align="right" alt="Visualizar gráfico em modo ampliado" onclick="javascript:f_zoomBullets('../zoomBullets.aspx', 'Desempenho do Orçamento' ,'HBullet.swf', '<%=grafico1_xmlzoom %>', 'HBullet.swf', '<%=grafico2_xmlzoom %>', 'HBullet.swf', '<%=grafico3_xmlzoom %>')"
