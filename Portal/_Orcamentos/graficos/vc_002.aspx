<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vc_002.aspx.cs" Inherits="_Orcamentos_graficos_vc_002" %>
...
<body style="margin:0px">
    ...
    <div style="text-align: center">
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="#FFFFFF"
            ...
            <HeaderTemplate>
                <table style="WIDTH: 100%" cellspacing="0" cellpadding="0"><tbody><tr><td align=left><dxe:ASPxLabel id="ASPxLabel1" runat="server" Text="Orçamento - Resultado">
                            </dxe:ASPxLabel>  </td><td align=right><IMG style="CURSOR: pointer" 
                    onclick="javascript:f_zoomGrafico('../zoom.aspx', '', 'Flashs/AngularGauge.swf', '<%=grafico_xmlzoom %>', '0')" 
