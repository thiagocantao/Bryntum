<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CalculoPesoCriteriosCategoria.aspx.cs" Inherits="_Portfolios_Administracao_CalculoPesoObjetosCategoria" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function alteraValor(s, e, numeroLinha, numeroColuna) {
            try {
                ...
                //window.top.mostraMensagem(e.message, 'Atencao', true, false, null);
            }
        }
        ...
        function format_number(pnumber, decimals) {
            var result = pnumber.toString().replace('.', ',');

            if (result.indexOf(',') != -1) {
                var indexString = result.indexOf(',') + decimals + 1;
                result = result.substring(0, parseInt(indexString));
            }
        ...
        function validaBotoesSalvarFechar(botaoHabilitado) {
            var btnSalvar = window.parent.document.getElementById('pcModalComFooter_TPCFm1_btnSalvarPcModal');
            if (botaoHabilitado == 'false') {
                btnSalvar.style.display = 'none';
            }
        }

        document.addEventListener("DOMContentLoaded", function (event) {
            validaBotoesSalvarFechar(hfBotaoSalvarHabilitado.Get('habilitado'));
        });
            ...
            <tr>
               <td>
                ...
                <td style="width: 25px">
                 ...
                 <td>
                    <dxe:ASPxTextBox ID="txtGrupo" runat="server" ClientEnabled="False"
                        Width="100%">
                        <DisabledStyle BackColor="#EBEBEB" ForeColor="Black">
                        </DisabledStyle>
                    </dxe:ASPxTextBox>
            ...
            <tr>
                <td>
                      <dxwgv:ASPxGridView ID="gridMatriz" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridMatriz"
                         KeyFieldName="Criterio" Width="100%" OnHtmlDataCellPrepared="gridMatriz_HtmlDataCellPrepared">
...
s.SetHeight(sHeight);
                        ...
                        <Columns>
                            <dxwgv:GridViewDataTextColumn Caption="Crit&#233;rios" FieldName="Criterio" VisibleIndex="0">
                                <HeaderStyle HorizontalAlign="Center" />
                                <CellStyle HorizontalAlign="Center">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Caption="Crit&#233;rio A" Visible="False" VisibleIndex="1">
                                <HeaderStyle HorizontalAlign="Center" />
                            </dxwgv:GridViewDataTextColumn>
                        </Columns>
                    ...
                    <dxhf:ASPxHiddenField ID="hfBotaoSalvarHabilitado" runat="server" ClientInstanceName="hfBotaoSalvarHabilitado">
                    </dxhf:ASPxHiddenField>
                </td>
            </tr>
        </table>
