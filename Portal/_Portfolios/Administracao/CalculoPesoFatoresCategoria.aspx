<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CalculoPesoFatoresCategoria.aspx.cs" Inherits="_Portfolios_Administracao_CalculoPesoFatoresCategoria" %>
            ...
            <tr>
                <td>
                    <dxwgv:ASPxGridView ID="gridMatriz" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridMatriz"
                         KeyFieldName="Fator" Width="100%" OnHtmlDataCellPrepared="gridMatriz_HtmlDataCellPrepared">
...
<HeaderFilter MinHeight="140px"></HeaderFilter>
                        ...
                        <Columns>
                            <dxwgv:GridViewDataTextColumn Caption="Fatores" FieldName="Criterio" VisibleIndex="0">
                                <HeaderStyle HorizontalAlign="Center" />
                                <CellStyle HorizontalAlign="Center">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Caption="Fator A" Visible="False" VisibleIndex="1">
                                <HeaderStyle HorizontalAlign="Center" />
                            </dxwgv:GridViewDataTextColumn>
                        </Columns>
                        <Settings VerticalScrollBarMode="Visible" VerticalScrollableHeight="385" />
                    </dxwgv:ASPxGridView>
