<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sb_001.aspx.cs" Inherits="_Portfolios_sb_001" %>
                ...
                <HeaderTemplate>
                    <table style="width: 100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td align="left">
                                    <dxe:ASPxLabel ID="ASPxLabel1" runat="server"    Text="<%# Resources.traducao.projetos_por_categoria %>">
                                    </dxe:ASPxLabel>
                                </td>
                                <td align="right"></td>
                            </tr>
