...
public partial class _Portfolios_sb_001 : System.Web.UI.Page
{
    dados cDados;
    ...
    private void geraGrafico()
    {
        ...
        string nomeGrafico = @"/ArquivosTemporarios/ProjetosCategoria_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        xml = cDados.getGraficoProjetosCategoria(ds.Tables[0], "Projetos", Resources.traducao.projeto, "n0", "", 9, "../../ImageSaving/FusionChartsSave.aspx");
        ...
        nomeGrafico = "\\ArquivosTemporarios\\ProjetosCategoriaZOOM_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
                
        //função para gerar a estrutura xml para criação do gráfico de quantidade de projetos por entidade
        xml = cDados.getGraficoProjetosCategoria(ds.Tables[0], "Projetos", Resources.traducao.projeto, "n0", "Projetos por Categoria", 15, "../../ImageSaving/FusionChartsSave.aspx");
