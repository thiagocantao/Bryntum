...
public partial class _Portfolios_sb_003 : System.Web.UI.Page
{
    dados cDados;
    ...
    private void geraGrafico()
    {
        ...
        string nomeGrafico = @"/ArquivosTemporarios/ReceitaCategoria_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        xml = cDados.getGraficoProjetosCategoria(ds.Tables[0], "Receita", Resources.traducao.receita, "c2", "", 9, "../../ImageSaving/FusionChartsSave.aspx");
        ...
        nomeGrafico = "\\ArquivosTemporarios\\ReceitaCategoriaZOOM_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;

        //função para gerar a estrutura xml para criação do gráfico de quantidade de projetos por entidade
        xml = cDados.getGraficoProjetosCategoria(ds.Tables[0], "Receita", "Receita", "c2", "Receita por Categoria", 15, "../../ImageSaving/FusionChartsSave.aspx");
