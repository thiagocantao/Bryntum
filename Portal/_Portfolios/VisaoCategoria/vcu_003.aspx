<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vcu_003.aspx.cs" Inherits="_Portfolios_VisaoCategoria_vcu_003" %>
...
<body style="margin:0px">
    ...
    <div style="text-align: center">
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="#FFFFFF"
            ...
            <HeaderTemplate>
                <table style="WIDTH: 100%" cellspacing="0" cellpadding="0"><tbody><tr><td align=left><dxe:ASPxLabel id="ASPxLabel1" runat="server">
                            </dxe:ASPxLabel>  &nbsp;&nbsp;</td><td align=right><IMG style="CURSOR: pointer" 
                    onclick="javascript:f_zoomGrafico('../zoom.aspx', '', 'Flashs/Bubble.swf', '<%=grafico_xmlzoom %>', '0')" 
