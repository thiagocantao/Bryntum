...
public partial class _Portfolios_VisaoCategoria_vcu_005 : System.Web.UI.Page
{
    dados cDados;
    ...
    private void geraGrafico()
    {
        ...
        DataSet ds = cDados.getDespesaReceitaUnidade(int.Parse(cDados.getInfoSistema("IDUsuarioLogado").ToString()), int.Parse(cDados.getInfoSistema("CodigoEntidade").ToString()), int.Parse(cDados.getInfoSistema("CodigoPortfolio").ToString()), int.Parse(cDados.getInfoSistema("CodigoCarteira").ToString()), where);
        ...
        //função para gerar a estrutura xml para criação do gráfico de quantidade de projetos por entidade
        xml = cDados.getGraficoDespesaReceitaCategorias(ds.Tables[0], "Despesa/Receita por Unidade", 15, "../../ImageSaving/FusionChartsSave.aspx");
