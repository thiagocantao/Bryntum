...
public partial class _Portfolios_VisaoCategoria_vcu_gantt : System.Web.UI.Page
{
    dados cDados;
    ...
    private void geraGrafico()
    {
        ...
        string nomeGrafico = @"/ArquivosTemporarios/GanttProjetoCategoria_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        string where = " AND proj.CodigoCategoria = " + cDados.getInfoSistema("CodigoCategoria").ToString();
