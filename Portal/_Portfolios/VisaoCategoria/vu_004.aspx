<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vu_004.aspx.cs" Inherits="_Portfolios_VisaoCategoria_vu_004" %>
...
<body style="margin:0px">
    ...
    <div style="text-align: center">
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="#FFFFFF"
            ...
            <HeaderTemplate>
                <table style="WIDTH: 100%" cellspacing="0" cellpadding="0"><tbody><tr><td align=left><dxe:ASPxLabel id="ASPxLabel1" runat="server" Text="Projetos (Desempenho e Categoria)">
                            </dxe:ASPxLabel>  &nbsp;</td><td align=right><IMG style="CURSOR: pointer" 
                    onclick="javascript:f_zoomGrafico('../zoom.aspx', '', 'Flashs/MSColumn2D.swf', '<%=grafico_xmlzoom %>', '0')" 
