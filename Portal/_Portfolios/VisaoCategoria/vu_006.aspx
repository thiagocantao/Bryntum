<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vu_006.aspx.cs" Inherits="_Portfolios_VisaoCategoria_vu_006" %>
                    ...
                    <table>
                        ...
                        <tr>
                            <td style="border-top: #c6c6c6 1px solid; color: white; border-bottom: #c6c6c6 1px solid;
                                height: 18px; background-color: #ebebeb" align="center">
                                <strong>
                        ...
                        <tr>
                            <td>
                                <table>
                                        ...
                                        <td align="left" style="width: 111px">
                                            <span><strong>
                                                <asp:Label ID="lblTituloCustoRealData" runat="server" Font-Bold="False"
                                                    Text="Despesa Realizado:"></asp:Label>
                                            </strong></span>
                                        </td>
                                        <td align="right">
                                    ...
                                    <tr>
                                        <td align="left" style="width: 111px; height: 15px">
                                            <strong><span>
                                    ...
                                    <tr>
                                        <td align="left" style="width: 111px; height: 10px">
                                        </td>
                                    ...
                                    <tr id="rec2">
                                        <td align="left" style="width: 111px; height: 14px">
                                            <span><strong>
                                    ...
                                    <tr id="esforco01">
                                        <td align="left" style="width: 111px; height: 16px">
                                            <span><strong>
                        ...
                        <tr>
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td align="left" style="width: 110px; height: 15px">
                                            <strong><span>
                                    ...
                                    <tr id="esforco04">
                                        <td align="left" style="width: 110px; height: 16px">
                                            <span><strong>
