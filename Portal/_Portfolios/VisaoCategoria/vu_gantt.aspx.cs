...
public partial class _Portfolios_VisaoCategoria_vu_gantt : System.Web.UI.Page
{
    dados cDados;
    ...
    private void defineLarguraTela()
    {
        ...
        alturaGrafico = (altura - 150).ToString();
    ...
    private void geraGrafico()
    {
        ...
        string nomeGrafico = @"/ArquivosTemporarios/GanttProjetoUnidade_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        DataSet ds = cDados.getDadosGanttPortfolioUnidade(codigoUsuario, codigoEntidade, codigoPortfolio, int.Parse(cDados.getInfoSistema("CodigoCarteira").ToString()), where);
        ...
        if (cDados.DataSetOk(ds) && cDados.DataTableOk(ds.Tables[0]))
        {
            ...
            xml = cDados.getGraficoGanttProjetos(ds.Tables[0], "Unidade");
        }
        else
        {
