...
public partial class _Portfolios_VisaoCorporativa_vc_006 : System.Web.UI.Page
{
    dados cDados;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataSet ds = cDados.getNumerosInstituicao(int.Parse(cDados.getInfoSistema("IDUsuarioLogado").ToString()), int.Parse(cDados.getInfoSistema("CodigoEntidade").ToString()), int.Parse(cDados.getInfoSistema("CodigoPortfolio").ToString()), int.Parse(cDados.getInfoSistema("CodigoCarteira").ToString()), "");
    ...
    private void defineLarguraTela()
    {
        ...
        ASPxRoundPanel1.ContentHeight = (altura - 184);
