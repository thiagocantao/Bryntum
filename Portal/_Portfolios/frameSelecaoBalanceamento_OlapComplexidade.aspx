<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frameSelecaoBalanceamento_OlapComplexidade.aspx.cs" Inherits="_Portfolios_frameSelecaoBalanceamento_OlapComplexidade" %>
                    ...
                    <td>
                        <div style="overflow: auto;">
                            ...
                            <dxwpg:ASPxPivotGrid ID="grid" runat="server" ClientInstanceName="grid"
                                Width="99%" OnCustomCallback="grid_CustomCallback"
                              ...
                              <ClientSideEvents Init="function(s, e) 
                                ...
                                <Fields>
                                    ...
                                    <dxwpg:PivotGridField ID="colCriterio" AllowedAreas="RowArea, ColumnArea, FilterArea" AreaIndex="1" FieldName="Criterio" Caption="Complexidade" Area="RowArea">
                                    </dxwpg:PivotGridField>
                                    <dxwpg:PivotGridField ID="colValorCriterio" AllowedAreas="DataArea" Area="DataArea"
                                        ...
                                        ValueFormat-FormatString="n2" ValueFormat-FormatType="Numeric" Caption="Valor Complexidade" SummaryType="Custom">
                                    </dxwpg:PivotGridField>
                                    <dxwpg:PivotGridField ID="field" AllowedAreas="RowArea, ColumnArea, FilterArea" Area="RowArea"
                                        Caption="Op&#231;&#227;o Complexidade" FieldName="OpcaoCriterio" Visible="False" AreaIndex="2">
                                    </dxwpg:PivotGridField>
                                </Fields>
