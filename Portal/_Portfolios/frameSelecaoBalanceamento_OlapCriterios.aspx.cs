...
public partial class _Portfolios_frameSelecaoBalanceamento_OlapCriterios : System.Web.UI.Page
{
    ...
    {
        DataTable dtOlap = cDados.getOlapCriterios(codigoEntidadeUsuarioResponsavel, codigoPortfolio, 'I', " AND Cenario" + ddlCenario.Value + " = 'S'").Tables[0];
    ...
    protected void menu_Init(object sender, EventArgs e)
    {
        ...
        cDados = CdadosUtil.GetCdados(listaParametrosDados);
        cDados.setaDefinicoesBotoesExportarLayoutOLAP((sender as ASPxMenu), true, false, "OlapCriterios", Resources.traducao.frameSelecaoBalanceamento_OlapCriterios_olap_crit_rios, this, grid);
    }
