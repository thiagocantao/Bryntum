<%@ Page Language="C#" MasterPageFile="~/novaCdis.master" AutoEventWireup="true" CodeFile="visaoUnidade.aspx.cs" Inherits="_Portfolios_visaoUnidade" Title="Portal da Estratégia" %>
<asp:Content ID="Content1" ContentPlaceHolderID="AreaTrabalho" Runat="Server">
	...
	if(statusVC != 1)
	{	    
		    document.getElementById('frmVC').src = './VisaoCategoria/vu_gantt.aspx';
	}
	else
	{		
			document.getElementById('frmVC').src = './VisaoCategoria/visaoUnidade_01.aspx';
	}
}" />
                </dxcb:ASPxCallback>
            </td>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <table>
                                <tr>
                                    <td>
                            <dxe:ASPxImage ID="imgVisao" runat="server" ImageUrl="~/imagens/botoes/btnGantt.png" 
                                            ToolTip="Visualizar Gantt" ClientInstanceName="imgVisao">
                                <ClientSideEvents Click="function(s, e) 
{
	...
	{	
		if(s.GetValue() == &quot;C&quot;)
		{
			window.top.gotoURL('_Portfolios/visaoCategoria.aspx', '_self');
		}
	}
}" />
                                <Items>
                        ...
                        <td align="left" style="width: 290px">
                            <dxe:ASPxComboBox ID="ddlUnidade" runat="server" 
                                Width="285px" ClientInstanceName="ddlUnidade" EnableSynchronization="True" >
                            </dxe:ASPxComboBox>
                        </td>
                                ...
                                <ClientSideEvents Click="function(s, e) 
{
	callBackVC.PerformCallback('AtualizarVC');
        ...
        <tr>
            <td>
                <iframe frameborder="0" name="graficos" scrolling="no" src="./VisaoCategoria/visaoUnidade_01.aspx"
