...
public partial class _Processos_Visualizacao_ExportacaoDadosBiblioteca : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (stream != null)
        {
            ...
            string fileType = Request.QueryString["exportType"];
            bool bInline = Convert.ToBoolean(Request.QueryString["bInline"]);
            ExportReport(stream, fileName, fileType, bInline);
        }
        else
