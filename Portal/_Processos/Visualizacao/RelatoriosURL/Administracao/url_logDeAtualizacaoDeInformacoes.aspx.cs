...
public partial class _Processos_Visualizacao_RelatoriosURL_Administracao_url_logDeAtualizacaoDeInformacoes : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            cDados.VerificaAcessoTelaSemMaster(this, codigoUsuarioLogado, codigoEntidade, codigoEntidade, "null", "EN", 0, "null", "EN_CnsLogAlt");
        }
        ...
        using (MemoryStream stream = new MemoryStream())
        {
            ...
            else
            {
                string script = @"<script type='text/Javascript' language='Javascript'>
                                    window.top.mostraMensagem(traducao.url_logDeAtualizacaoDeInformacoes_erro_ao_exportar_os_dados__verifique_se_n_o_foi_ultrapassado_o_n_mero_m_ximo_de_256_colunas_, 'erro', true, false, null);                                   
                                 </script>";
