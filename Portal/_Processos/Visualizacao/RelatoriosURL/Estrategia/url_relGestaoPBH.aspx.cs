...
public partial class _Processos_Visualizacao_RelatoriosURL_Estrategia_url_relGestaoPBH : System.Web.UI.Page
{
    dados cDados;
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            cDados.VerificaAcessoTelaSemMaster(this, codigoUsuarioResponsavel, codigoEntidadeUsuarioResponsavel, codigoEntidadeUsuarioResponsavel, "null", "EN", 0, "null", "EN_RelGesFiPBHPDTI");
        }
    }
    ...
    private void defineAlturaTela()
    {
        ...
        tlDados.Settings.ScrollableHeight = alturaPrincipal - 260;
