...
public partial class _Processos_Visualizacao_RelatoriosURL_Estrategia_url_relGestaoPBHLoa : System.Web.UI.Page
{
    dados cDados;
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            cDados.VerificaAcessoTelaSemMaster(this, codigoUsuarioResponsavel, codigoEntidadeUsuarioResponsavel, codigoEntidadeUsuarioResponsavel, "null", "EN", 0, "null", "EN_RelGesFinPBHLOA");
        }
    }
    ...
    private void carregaGrid()
    {
        ...
        BEGIN
            ...
            SELECT * FROM {0}.{1}.f_pbh_RelatorioGestaoLOA(@CodigoUsuario, @CodigoEntidade, @CodigoCarteira, @ano)
            WHERE Descricao like '%{5}%'

        END", cDados.getDbName(), cDados.getDbOwner(), codigoUsuarioResponsavel, codigoEntidadeUsuarioResponsavel, ddlAno.SelectedItem.Value.ToString(), txtDescricao.Text);
        DataSet ds = cDados.getDataSet(comandoSQL);
        tlDados.DataSource = ds.Tables[0];
        tlDados.DataBind();
    }

    private void populaFiltro()
    {
        ddlAno.Items.Clear();
        int anoAtual = DateTime.Now.Year;
        for (int i = anoAtual; i >= 2010; i--)
        {
            ddlAno.Items.Add(i.ToString(), i);
        }
    ...
    private void HeaderOnTela()
    {
        ...
        Header.Controls.Add(cDados.getLiteral(@"<script type=""text/javascript"" language=""javascript"" src=""../../../../scripts/relGestaoPBHLoa.js""></script>"));
        Header.Controls.Add(cDados.getLiteral(@"<script type=""text/javascript"" language=""javascript"" src=""../../../../scripts/barraNavegacao.js""></script>"));
        this.TH(this.TS("barraNavegacao", "relGestaoPBHLoa"));
    }
    ...
    private void defineAlturaTela()
    {
        ...
        tlDados.Settings.ScrollableHeight = alturaPrincipal - 270;      
    }
