...
public partial class _Processos_Visualizacao_RelatoriosURL_Projetos_url_OLAP_DesempCartProgProj : System.Web.UI.Page
{
    ...
    {
        DataSet dsUnidade = cDados.getUnidadesNegocioEntidade(codigoEntidadeUsuarioResponsavel, "");
    ...
    {
        if ((e.Column.FieldName == "CorStatus" || e.Column.FieldName == "Farol") && e.RowKind == DevExpress.Web.ASPxTreeList.TreeListRowKind.Data)
        {
    ...
    protected void menu_Init(object sender, EventArgs e)
    {
        ...
        cDados.setaDefinicoesBotoesInserirExportar((sender as ASPxMenu), false, "", false, true, false, "DesCartProgProj", "Desempenho dos Programas", this);
    }
