<%@ Page Language="C#" AutoEventWireup="true" CodeFile="url_OLAP_ProjetoseObras.aspx.cs"
    Inherits="_Processos_Visualizacao_RelatoriosURL_Projetos_url_OLAP_ProjetoseObras"
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <dxpgwx:ASPxPivotGridExporter ID="ASPxPivotGridExporter1" runat="server" 
                                ASPxPivotGridID="pvgContratos" 
                                oncustomexportcell="ASPxPivotGridExporter1_CustomExportCell" 
                                oncustomexportfieldvalue="ASPxPivotGridExporter1_CustomExportFieldValue">
                                ...
                                <dxwpg:ASPxPivotGrid ID="pvgContratos" runat="server" ClientInstanceName="pvgContratos"
                                    ...
                                    <Fields>
                                        ...
                                        <dxwpg:PivotGridField ID="f_SiglaUnidade" AllowedAreas="RowArea, ColumnArea, FilterArea"
                                            Area="RowArea" Caption="Unidade de Neg&#243;cio" FieldName="SiglaUnidade" AreaIndex="1"
