...
public partial class _Processos_Visualizacao_RelatoriosURL_Projetos_url_OLAP_ProjetoseObras : System.Web.UI.Page
{
    ...
    protected void ASPxPivotGridExporter1_CustomExportCell(object sender, DevExpress.Web.ASPxPivotGrid.WebCustomExportCellEventArgs e)
    {
        ...
        /*if (e.RowField != null)
        {
            if (e.RowField.FieldName.Contains("CorStatusProjeto") && (e.RowValue.Value != null))
            {
                e.Appearance.Font = new Font("Wingdings", 18, FontStyle.Bold, GraphicsUnit.Point);
                e.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
                e.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;

                if (e.RowValue.Value.ToString().Equals("Vermelho"))
                {
                    e.Brick.Text = "l";
                    e.Brick.TextValue = "l";
                    e.Appearance.ForeColor = Color.Red;
                }
                else if (e.RowValue.Value.ToString().Equals("Amarelo"))
                {
                    e.Brick.Text = "l";
                    e.Brick.TextValue = "l";
                    e.Appearance.ForeColor = Color.Yellow;
                }
                else if (e.RowValue.Value.ToString().Equals("Verde"))
                {
                    e.Brick.Text = "l";
                    e.Brick.TextValue = "l";
                    e.Appearance.ForeColor = Color.Green;
                }
                else if (e.RowValue.Value.ToString().Equals("Azul"))
                {
                    e.Brick.Text = "l";
                    e.Brick.TextValue = "l";
                    e.Appearance.ForeColor = Color.Blue;
                }
                else if (e.RowValue.Value.ToString().Equals("Branco"))
                {
                    e.Brick.Text = "l";
                    e.Brick.TextValue = "l";
                    e.Appearance.ForeColor = Color.WhiteSmoke;
                }
                else if (e.RowValue.Value.ToString().Equals("Laranja"))
                {
                    e.Brick.Text = "l";
                    e.Brick.TextValue = "l";
