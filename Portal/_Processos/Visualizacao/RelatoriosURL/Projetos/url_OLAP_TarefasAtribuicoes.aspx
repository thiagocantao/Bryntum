<%@ Page Language="C#" AutoEventWireup="true" CodeFile="url_OLAP_TarefasAtribuicoes.aspx.cs"
    Inherits="_Processos_Visualizacao_RelatoriosURL_Projetos_url_OLAP_TarefasAtribuicoes"
...
<body style="margin: 0px">
    ...
    <div>
        <table border="0" cellpadding="0" cellspacing="0" style="background-image: none;
            width: 100%">
...
btnSelecionar.SetEnabled(true);
	...
	btnSelecionar.SetEnabled(true);
                            ...
                            <td align="left" style="width: 85px; height: 26px; padding-right: 5px;" 
                                valign="middle">
	...
	hfGeral.Set(&quot;tipoArquivo&quot;,s.GetValue());
                                    ...
                                    <td align="right" width="60">
                                        <dxe:ASPxButton ID="Aspxbutton1" runat="server" 
                                            OnClick="btnExcel_Click" Text="Exportar" HorizontalAlign="Right">
                                            <Paddings Padding="0px" />
                                        </dxe:ASPxButton>
                                    </td>
                                </tr>
                        ...
                        <td colspan="1" valign="top">
                            <div id="Div2" style="overflow: auto; height: <%=alturaTabela %>; width: <%=larguraTabela %>">
                                <dxwpg:ASPxPivotGrid ID="grid" runat="server" ClientInstanceName="grid"
                                    Width="98%" ClientIDMode="AutoID" OnCustomFieldSort="grid_CustomFieldSort">
                                    <Fields>
                                        ...
                                        <dxwpg:PivotGridField ID="fieldNomeRecurso" AllowedAreas="RowArea, ColumnArea, FilterArea"
                                            Area="ColumnArea" AreaIndex="0" Caption="Nome Recurso" FieldName="NomeRecurso">
                                        </dxwpg:PivotGridField>
