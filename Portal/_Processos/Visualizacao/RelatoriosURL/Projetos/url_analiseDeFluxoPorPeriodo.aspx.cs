...
public partial class _Processos_Visualizacao_RelatoriosURL_Projetos_url_analiseDeFluxoPorPeriodo : System.Web.UI.Page
{
    dados cDados;
    ...
    private void defineAlturaTela()
    {
      ...
      //  gvDados.JSProperties["cp_Altura"] = alturaFrames;

        gvDados.Settings.VerticalScrollableHeight = altura - 355;
    }
    ...
    protected void gvDados_DetailRowExpandedChanged(object sender, DevExpress.Web.ASPxGridViewDetailRowEventArgs e)
    {
        if (e.Expanded)
        {
            ...
            if (grid != null)
                aplicaFormatacaoGrid(grid);
        }
    }

    private void aplicaFormatacaoGrid(ASPxGridView grid)
    {
    ...
    protected void menu_ItemClick(object source, DevExpress.Web.MenuItemEventArgs e)
    {
        ...
        cDados = CdadosUtil.GetCdados(listaParametrosDados);
        cDados.eventoClickMenu((source as ASPxMenu), parameter, gvExporter, "RelFlxPorPer");
    }
    ...
    protected void menu_Init(object sender, EventArgs e)
    {
        ...
        cDados = CdadosUtil.GetCdados(listaParametrosDados);
        cDados.setaDefinicoesBotoesInserirExportar((sender as ASPxMenu), false, "", false, true, true, "RelFlxPorPer", "Análise de Fluxo por Período", this);
    }
