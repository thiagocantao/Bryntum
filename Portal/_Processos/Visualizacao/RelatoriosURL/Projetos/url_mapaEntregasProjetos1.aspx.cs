...
public partial class _Processos_Visualizacao_RelatoriosURL_Projetos_url_mapaEntregasProjetos1 : System.Web.UI.Page
{
    dados cDados;
    ...
    protected void menu_Init(object sender, EventArgs e)
    {
        ...
        cDados = CdadosUtil.GetCdados(listaParametrosDados);
        cDados.setaDefinicoesBotoesInserirExportar((sender as ASPxMenu), false, "", false, true, false, "MapEntPrj1", "Mapa de marco-crítico", this);
    }
