...
public partial class _Processos_Visualizacao_RelatoriosURL_Projetos_url_relAnaliseInclusaoAditivo : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            cDados.VerificaAcessoTelaSemMaster(this, codigoUsuarioResponsavel, codigoEntidadeUsuarioResponsavel, codigoEntidadeUsuarioResponsavel, "null", "EN", 0, "null", "EN_PrjRelIncAdt");
        }
    ...
    private void defineAlturaTela()
    {
        ...
        gvDados.Settings.VerticalScrollableHeight = alturaPrincipal - 270;
    }
