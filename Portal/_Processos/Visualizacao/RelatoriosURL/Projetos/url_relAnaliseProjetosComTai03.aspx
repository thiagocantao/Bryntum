<%@ Page Language="C#" AutoEventWireup="true" CodeFile="url_relAnaliseProjetosComTai03.aspx.cs"
    Inherits="_Processos_Visualizacao_RelatoriosURL_Projetos_url_relAnaliseProjetosComTai03"
                        ...
                        <td colspan="1" valign="top">
                            <div id="Div1" style="overflow: auto; height: <%=alturaTabela %>; width: <%=larguraTabela %>">
                                <dxwpg:ASPxPivotGrid ID="pvgDadosProjeto" runat="server" ClientInstanceName="pvgDadosProjeto"
                                    ...
                                    OnCustomCellStyle="pvgDadosProjeto_CustomCellStyle" OnCustomCellDisplayText="pvgDadosProjeto_CustomCellDisplayText"
                                    ClientIDMode="AutoID" OnCustomFilterPopupItems="pvgDadosProjeto_CustomFilterPopupItems">
                                    <Fields>
                                        ...
                                        <dxwpg:PivotGridField ID="fieldAtrasosCronograma" Area="DataArea" Caption="Atrasos no Cronograma"
                                            FieldName="AtrasosCronograma" AllowedAreas="DataArea" AreaIndex="5" Visible="False">
                                        </dxwpg:PivotGridField>
                                        <dxwpg:PivotGridField ID="fieldEntregasRealizadas" Area="DataArea" Caption="Entregas Realizadas"
                                            FieldName="EntregasRealizadas" AllowedAreas="DataArea" AreaIndex="5" Visible="False">
                                        </dxwpg:PivotGridField>
                                        <dxwpg:PivotGridField ID="fieldEntregasAtrasadas" Area="DataArea" Caption="Entregas Atrasadas"
                                            FieldName="EntregasAtrasadas" AllowedAreas="DataArea" AreaIndex="5" Visible="False">
                                        </dxwpg:PivotGridField>
                                        <dxwpg:PivotGridField ID="fieldProximasEntregas" Area="DataArea" Caption="Entregas nos próx. 30 dias"
                                            FieldName="ProximasEntregas" AllowedAreas="DataArea" AreaIndex="5" Visible="False">
                                        </dxwpg:PivotGridField>
                                        ...
                                        <dxwpg:PivotGridField ID="fieldDataInicio" AllowedAreas="RowArea" Area="RowArea"
                                            Caption="Data de Início do Projeto" FieldName="DataInicio" Visible="False" AreaIndex="1">
                                        </dxwpg:PivotGridField>
                                        <dxwpg:PivotGridField ID="fieldDataTermino" AllowedAreas="RowArea" Area="RowArea"
                                            Caption="Data de Término do Projeto" FieldName="DataTermino" Visible="False"
                                            AreaIndex="1">
                                        </dxwpg:PivotGridField>
                                        <dxwpg:PivotGridField ID="fieldValorContrapartida" AllowedAreas="DataArea" Area="DataArea"
                                            Caption="Valor das Contrapartidas" FieldName="ValorContrapartida" Visible="False"
                                            AreaIndex="8">
                                        </dxwpg:PivotGridField>
                                        <dxwpg:PivotGridField ID="fieldFontesFinanciamento" Area="RowArea" Caption="Fontes de Financiamento"
                                            FieldName="FontesFinanciamento" Visible="False" AreaIndex="1">
                                        </dxwpg:PivotGridField>
                                        <dxwpg:PivotGridField ID="fieldIndicaLinhaFinanciamento" AllowedAreas="RowArea, ColumnArea"
                                            Area="RowArea" Caption="Linha de Financiamento" FieldName="IndicaLinhaFinanciamento"
                                            Visible="False" AreaIndex="1">
                                        </dxwpg:PivotGridField>
                                        <dxwpg:PivotGridField ID="fieldSetorIndustrial" AllowedAreas="RowArea" Area="RowArea"
                                            Caption="Setor Industrial" FieldName="SetorIndustrial" Visible="False" AreaIndex="1">
                                        </dxwpg:PivotGridField>
                                        <dxwpg:PivotGridField ID="fieldPublicoAlvo" AllowedAreas="RowArea" Area="RowArea"
                                            Caption="Cliente" FieldName="PublicoAlvo" Visible="False" AreaIndex="1">
                                        </dxwpg:PivotGridField>
                                        <dxwpg:PivotGridField ID="fieldObjetivoGeral" AllowedAreas="RowArea" Area="RowArea"
                                            Caption="Objetivo do Projeto" FieldName="ObjetivoGeral" Visible="False" AreaIndex="1">
                                        </dxwpg:PivotGridField>
                                        <dxwpg:PivotGridField ID="fieldJustificativa" AllowedAreas="RowArea" Area="RowArea"
                                            Caption="Justificativa" FieldName="Justificativa" Visible="False" AreaIndex="1">
                                        </dxwpg:PivotGridField>
                                        <dxwpg:PivotGridField ID="fieldEscopo" AllowedAreas="RowArea" Area="RowArea" Caption="Escopo"
                                            FieldName="Escopo" Visible="False" AreaIndex="1">
                                        </dxwpg:PivotGridField>
                                    </Fields>
                                    <OptionsView ShowRowGrandTotalHeader="False" HorizontalScrollBarMode="Visible" />
