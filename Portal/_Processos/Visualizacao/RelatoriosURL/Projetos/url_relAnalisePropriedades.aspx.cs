...
public partial class _Processos_Visualizacao_RelatoriosURL_Projetos_url_relAnalisePropriedades : System.Web.UI.Page
{
    dados cDados;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            cDados.VerificaAcessoTelaSemMaster(this, codigoUsuario, codigoEntidadeUsuarioResponsavel, codigoEntidadeUsuarioResponsavel, "null", "EN", 0, "null", "EN_AcsRelProp");
        }
...
gvOcupantes mesmo tamanho
        ...
        alturaTabela = (altura - 260) + "px";//a div vai ficar com essa altura
        larguraTabela = (largura -200) + "px";

        //calculo baseado na hierarquia de tamanho da variavel: alturaTabela
        pgControlPropriedades.Height = new Unit((altura - 365) + "px");

        gvPropriedades.Settings.VerticalScrollableHeight = (altura - 375);
        gvOcupantes.Settings.VerticalScrollableHeight = (altura - 375);

        Div1.Style.Add("height", ((altura - 270) + 0).ToString() + "px");
        Div1.Style.Add("width", (largura - 210) + "px");
