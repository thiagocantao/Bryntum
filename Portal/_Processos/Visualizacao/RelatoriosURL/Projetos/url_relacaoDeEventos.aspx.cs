...
public partial class _Processos_Visualizacao_RelatoriosURL_Projetos_url_relacaoDeEventos : System.Web.UI.Page
{
    dados cDados;
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            cDados.VerificaAcessoTelaSemMaster(this, idUsuarioLogado, CodigoEntidade, CodigoEntidade, "null", "EN", 0, "null", "EN_AcsRelEven");
        }
    ...
    private void defineAlturaTela(string resolucaoCliente)
    {
        ...
        if (altura > 0)
            gvDados.Settings.VerticalScrollableHeight = altura - 195;
    }
