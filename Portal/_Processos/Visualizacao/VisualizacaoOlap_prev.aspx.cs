...
public partial class _Processos_Visualizacao_VisualizacaoOlap_prev : System.Web.UI.Page
{
    #region Constants
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        this.TH(this.TS("VisualizacaoOlap_prev"));
    }
 ...
 SELECT CodigoLista, 
  ...
  WHERE (CodigoLista = @CodigoLista)";
        ...
        foreach (string campo in campos)
        {
            if (campo != "")
            {
                ...
                try
                {
                    ...
                    pgDados.Fields[fieldName].FilterValues.FilterType = PivotFilterType.Excluded;
                }
                finally
                {
                    // Unlocks the control.
    ...
    private void DefineDimensoesTela()
    {
        ...
        //divOlap.Style.Clear();
        divOlap.Style.Add(HtmlTextWriterStyle.Overflow, "auto");
        divOlap.Style.Add(HtmlTextWriterStyle.Height, (alturaTela - 250) + "px");
    }
    ...
    private string getFilter()
    {
        ...
        foreach (DevExpress.Web.ASPxPivotGrid.PivotGridField field in pgDados.Fields)
        {
            if (field.FilterValues.Count > 0)
            {
                ...
                foreach (object valores in field.FilterValues.ValuesExcluded)//O original era: ValuesExcluded
                {
