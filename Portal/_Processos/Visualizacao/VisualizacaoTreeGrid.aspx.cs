...
public partial class _Processos_Visualizacao_VisualizacaoTreeGrid : System.Web.UI.Page
{
    #region Constants
    ...
    private void DefinirConfiguracaoToolbar()
    {
        ...
        var toolbar = tlDados.Toolbars.FindByName("MainToolbar");
        var iMenu = toolbar.Items.FindByName("preFiltro");
...
DECLARE @CodigoLista Int,
    ...
    protected void menu_Load(object sender, EventArgs e)
    {
		...
		DsListaProcessos.ListaRow item = ds.Lista.Single();
        tlDados.Toolbars.FindByName("MainToolbar").Items.FindByName("layout").Text = item.NomeListaUsuario;
    ...
    protected void tlDados_CustomJSProperties(object sender, TreeListCustomJSPropertiesEventArgs e)
    {
        DsListaProcessos.ListaRow item = ds.Lista.Single(l => l.CodigoLista == codigoLista);
        ...
        e.Properties["cp_codigo_lista_usuario"] = codigoListaUsuario;
    }

    protected void tlDados_ExportRenderBrick(object sender, ASPxTreeListExportRenderBrickEventArgs e)
    {
