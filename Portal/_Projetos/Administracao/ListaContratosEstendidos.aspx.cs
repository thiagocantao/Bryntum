...
public partial class _Projetos_Administracao_ListaContratosEstendidos : System.Web.UI.Page
{
    dados cDados;
    ...
    {  
        ...
        if (codigoProjeto != -1)
        {
            gvDados.JSProperties["cp_Largura"] = "750px";
            pcDados.Width = 800;
        }
        else
            gvDados.JSProperties["cp_Largura"] = "950px";
    ...
    {   // Calcula a altura da tela
        ...
        gvDados.JSProperties["cp_Altura"] = "";
    ...
    private void carregaGvDados()
    {
        ...
        if (codigoProjeto != -1)
            strWhere = " AND cont.CodigoProjeto = " + codigoProjeto;
  ...
  //Excluído - O campo já vem formatado da f_GetListaContratosEstendidos
  //      else if (coluna.FieldName == "CNPJ_CPF")
  //      {
  //          string indicaPessoaFisicaJuridica = gvDados.GetRowValues(e.VisibleIndex, "IndicaPessoaFisicaJuridica").ToString();
  //          if (e.CellValue.ToString() != "")
  //          {
  //              e.Cell.Text = indicaPessoaFisicaJuridica == "J" ? string.Format(@"{0:00\.000\.000\/0000\-00}", Convert.ToDouble(e.CellValue.ToString())) : string.Format(@"{0:000\.000\.000\-00}", Convert.ToDouble(e.CellValue.ToString()));
  //          }
  ...
  //      }
    ...
    public string getValorAditadoGrid(string valorCAditivos, string valorOriginal)
    {
        ...
        {
            novoValorCAditivo = string.Format("{0:c2}", Decimal.Parse(valorCAditivos));
        }
    ...
    {
        string valorOriginal = Eval("ValorContratoOriginal").ToString();
        string valorContrato = Eval("ValorContrato").ToString();
        string valorCAditivos = valorOriginal == valorContrato ? valorOriginal : valorContrato; // Eval("ValorContrato").ToString();
        ...
        if (valorCAditivos == "" || ValorMedido == "")
            ...
            return string.Format("{0:c2}", (Decimal.Parse(valorCAditivos) - Decimal.Parse(ValorMedido)));
    }
    ...
    protected void gvExporter_RenderBrick(object sender, DevExpress.Web.ASPxGridViewExportRenderingEventArgs e)
    {
        ...
        if ((e.Column != null) &&  e.Column.Name.ToString() == "SaldoContratual")
        {
            ...
            if (e.KeyValue != null && e.KeyValue.ToString() != "")
            {
                ...
                if (valorMedido != "" && valorContrato != "")
                    e.TextValue = Decimal.Parse(valorContrato) - Decimal.Parse(valorMedido);
    ...
    protected void menu_ItemClick(object source, DevExpress.Web.MenuItemEventArgs e)
    {
        ...
        cDados = CdadosUtil.GetCdados(listaParametrosDados);
        cDados.eventoClickMenu((source as ASPxMenu), parameter, gvExporter, "LstContraEst");
    }
    ...
    protected void menu_Init(object sender, EventArgs e)
    {
        ...
        cDados = CdadosUtil.GetCdados(listaParametrosDados);
        cDados.setaDefinicoesBotoesInserirExportar((sender as ASPxMenu), podeIncluir, "novoRegistro();", true, true, false, "LstContraEst", "Contratos", this);
    }
