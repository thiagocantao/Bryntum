<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cadastroAcoesProcesso.aspx.cs" Inherits="_Projetos_Administracao_cadastroAcoesProcesso" %>
...
<head id="Head1" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function validaCamposFormulario() {
            ...
            if (!confirm("Voce esta alterando a fonte de recursos da ação para ''Sem Recursos'' se houver registro no orçamento para esta ação os mesmos serão excluidos!\n\nConfirma a alteração?")) {
                numAux++;
                ...
                <table cellpadding="0" cellspacing="0" class="style1">
                    ...
                    <tr>
                        <td style="padding-right: 5px; width: 75px;">
                            <dxe:ASPxSpinEdit ID="txtNumero" runat="server" Number="1" 
                                NumberType="Integer" Width="100%" ClientInstanceName="txtNumero" 
            ...
            <td>
                <table cellpadding="0" cellspacing="0" class="style1">
                    ...
                    <tr>
                        ...
                        <td class="style7">
                            <dxe:ASPxComboBox ID="ddlFonteRecursos" runat="server" 
                                ClientInstanceName="ddlFonteRecursos"  
        ...
        <tr>
            <td align="right">
                <dxe:ASPxButton ID="btnSalvar" runat="server" 
                    Text="Salvar Dados da Ação" Width="165px" 
                    AutoPostBack="False" style="margin-left: 0px">
...
<dxp:PanelContent ID="PanelContent2" runat="server" SupportsDisabledAttribute="True">
    <dxwgv:ASPxGridView ID="gvMetasAcao" runat="server" AutoGenerateColumns="False" 
        ClientInstanceName="gvMetasAcao"  
        KeyFieldName="CodigoMeta" OnCustomCallback="gvMetasAcao_CustomCallback" 
        OnRowDeleting="gvMetasAcao_RowDeleting" 
        OnRowInserting="gvMetasAcao_RowInserting" 
	...
	if(s.cp_Msg != null &amp;&amp; s.cp_Msg != '')
        ...
        <Columns>
            <dxwgv:GridViewCommandColumn ButtonRenderMode="Image" Caption=" " 
                ShowInCustomizationForm="True" VisibleIndex="0" Width="80px" ShowEditButton="true" ShowDeleteButton="true" ShowCancelButton="true" ShowUpdateButton="true">
                <HeaderTemplate>
            ...
            <dxwgv:GridViewDataTextColumn Caption="Meta" FieldName="Meta" Name="Meta" 
        ...
        <SettingsText ConfirmDelete="Deseja realmente excluir o registro?" 
            PopupEditFormCaption="Metas" />
        <Styles>
            <Header>
