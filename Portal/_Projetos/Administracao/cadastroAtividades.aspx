<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cadastroAtividades.aspx.cs" Inherits="_Projetos_Administracao_cadastroAtividades" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function verificaDataIntervalo(s) {
            return (s >= dataInicio.GetValue()  && s <= dataTermino.GetValue())
        }
        ...
        function validaCamposFormulario() {
            ...
            if (txtNumeroAtividade.GetText() == "") {
                numAux++;
                mensagem += "\n" + numAux + ") O número da atividade deve ser informado.";
            }
            ...
            if (txtNomeAtividade.GetText().length < 10) {
                numAux++;
                mensagem += "\n" + numAux + ") O campo 'Nome da atividade' deve ser informado com no mínimo 10 caracteres.";
            }
...
//            if (ckbSemRecursos.GetChecked() ) {
//                if (!confirm("Voce esta alterando a fonte de recursos da atividade para ''Sem Recursos'' se houver registro no orçamento para esta atividade os mesmos serão excluidos!\n\nConfirma a alteração?")) {
//                    numAux++;
...
<dxp:PanelContent runat="server" SupportsDisabledAttribute="True">
                    ...
                    <tr>
                        ...
                        <td style="padding-right: 3px; width: 95px;">
                            <dxe:ASPxSpinEdit ID="txtNumeroAtividade" runat="server" 
                                ClientInstanceName="txtNumeroAtividade"  
                    ...
                    <tr>
                        <td style="width: 95px; padding-right: 3px">
                            <dxe:ASPxDateEdit ID="dataInicio" runat="server" 
                                ...
                                Width="100%" DisplayFormatString="dd/MM/yyyy" EditFormat="Custom" 
                ...
                <table cellpadding="0" cellspacing="0" class="style1">
                    <tr>
                        ...
                        <table>
                            <tr>
                                <td>
                                    &nbsp;</td>
                                <td style="padding-left: 10px">
                                    <dxe:ASPxImage ID="ASPxImage5" runat="server" ClientInstanceName="imgAjuda" 
                                        Cursor="pointer" Height="18px" ImageUrl="~/imagens/ajuda.png" 
                                        meta:resourceKey="ASPxImage10Resource1" 
                                        ToolTip="Marque se atividade é um evento institucional." Width="18px">
                                    </dxe:ASPxImage>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="padding-left: 10px">
                                    <dxe:ASPxImage ID="ASPxImage6" runat="server" ClientInstanceName="imgAjuda" 
                                        Cursor="pointer" Height="18px" ImageUrl="~/imagens/ajuda.png" 
                                        meta:resourceKey="ASPxImage10Resource1" ToolTip="Informe o local do evento." 
                                        Width="18px">
                                    </dxe:ASPxImage>
                                </td>
                            </tr>
                    ...
                    <tr>
                        <td align="left" class="style8">
                            <dxe:ASPxCheckBox ID="ckbIndicaEventoInstitucional" runat="server" 
                                CheckState="Unchecked" ClientInstanceName="ckbIndicaEventoInstitucional" 
                                 Text="Evento Institucional">
                                <ClientSideEvents CheckedChanged="function(s, e) {
	txtLocalEvento.SetEnabled(s.GetChecked());
	mmObjeto.SetEnabled(s.GetChecked());
	...
	if(s.GetChecked() == false)
	{
		...
		mmObjeto.SetText(&quot;&quot;);
                        ...
                        <td>
                            <dxe:ASPxTextBox ID="txtLocalEvento" runat="server" 
                                ClientInstanceName="txtLocalEvento"  
        ...
        <tr>
            ...
            <table>
                <tr>
                    ...
                    <td style="padding-left: 10px">
                        <dxe:ASPxImage ID="ASPxImage7" runat="server" ClientInstanceName="imgAjuda" 
                            Cursor="pointer" Height="18px" ImageUrl="~/imagens/ajuda.png" 
                            meta:resourceKey="ASPxImage10Resource1" ToolTip="Informe detalhes do evento." 
                            Width="18px">
                        </dxe:ASPxImage>
                    </td>
                </tr>
...
<HeaderTemplate>
            ...
            <dxwgv:GridViewDataComboBoxColumn Caption="Área da Parceria" FieldName="CodigoParceiro" 
                VisibleIndex="0">
                <PropertiesComboBox DisplayFormatString="{1}">
...
<HeaderTemplate>
            ...
            <dxwgv:GridViewDataTextColumn Caption="Produto" VisibleIndex="1" 
                FieldName="Meta">
                <PropertiesTextEdit MaxLength="500">
                    <ValidationSettings CausesValidation="True">
                        <RequiredField ErrorText="Campo Obrigatório" IsRequired="True" />
...
<HeaderTemplate>
            ...
            <dxwgv:GridViewDataDateColumn Caption="Data" VisibleIndex="2" Width="160px" 
                FieldName="Data">
                <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" 
                    EditFormatString="dd/MM/yyyy" DisplayFormatInEditMode="True" >
                    <ClientSideEvents Validation="function(s, e) {
	var valido = verificaDataIntervalo(s.GetValue());

	if(valido == false)
	{
		e.errorText = 'A data não está no intervalo de datas da atividade!';		
	}
