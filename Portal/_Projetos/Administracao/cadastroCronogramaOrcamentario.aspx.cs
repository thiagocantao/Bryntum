...
public partial class _Projetos_Administracao_cadastroAcoes : System.Web.UI.Page
{
    ...
    {
         DataSet dsAcao = cDados.getAtividadeAcaoIniciativa(codigoAtividade, "");
         ...
         if (!IsPostBack)
         {
             ...
             {
                 DataSet ds = cDados.getContaAtividade(codigoCronograma, " AND co.CodigoAcao = " + codigoAtividade);
    ...
    private void carregaComboContas()
    {
        ...
        DataSet ds = cDados.getPlanoContasAnoAtual(codigoProjeto, codigoCronograma, codigoAtividade, "");
    ...
    protected void callbackSalvar_Callback(object source, DevExpress.Web.CallbackEventArgs e)
    {
        ...
        if (codigoCronograma == -1)
        {
            //retorno = cDados.incluiContaAtividade(codigoProjeto, codigoAtividade, codigoConta, quantidade, valorUnitario, valorTotal, memoriaCalculo, plan01, plan02, plan03, plan04, plan05, plan06, plan07, plan08, plan09, plan10, plan11, plan12);
        ...
        {
            //retorno = cDados.atualizaContaAtividade(codigoCronograma, codigoAtividade, codigoConta, quantidade, valorUnitario, valorTotal, memoriaCalculo, plan01, plan02, plan03, plan04, plan05, plan06, plan07, plan08, plan09, plan10, plan11, plan12);
