<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cadastroCronogramaOrcamentarioProcesso.aspx.cs" Inherits="_Projetos_Administracao_cadastroCronogramaOrcamentarioProcesso" %>
...
<head id="Head1" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function validaCamposFormulario() {
            ...
            if (txtValorUnitario.GetValue() == null || txtValorUnitario.GetText() == "" || txtValorUnitario.GetValue() == 0) {
                numAux++;
            ...
            if (mmObjeto.length < 10)
                msg += "O campo 'Memória de cálculo' deve ser informado com no mínimo 10 caracteres.\n";
            if (mensagem != "") {
...
<SpinButtons ShowIncrementButtons="False"></SpinButtons>
        ...
        <tr>
            <td scope="height:3px" class="style12">
                &nbsp;</td>
        </tr>
        <tr>
            <td>
 ...
 <dxe:ASPxLabel runat="server" Text="&amp;nbsp;de 4000" EncodeHtml="False" 
        ...
        <tr>
            <td>
            <dxe:ASPxMemo runat="server" Width="100%" ClientInstanceName="mmObjeto" 
                     ID="mmObjeto" Height="100px">
