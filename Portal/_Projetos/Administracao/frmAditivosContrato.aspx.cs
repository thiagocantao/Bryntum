...
public partial class administracao_frmAditivosContrato : System.Web.UI.Page
{
    ...
    protected void gvDados_CustomButtonInitialize(object sender, DevExpress.Web.ASPxGridViewCustomButtonEventArgs e)
    {
        ...
        {
            if (podeEditar && editavel == "S" && codigoWF == "")
            {
                e.Enabled = true;
            }
            else
        ...
        {
            if (podeExcluir && editavelTC == "TC" && codigoWF == "")
            {
                e.Enabled = true;
            }
            else if (podeExcluir && editavel == "S" && codigoWF == "")
            {
                e.Enabled = true;
            }
            else
    ...
    private string persisteInclusaoRegistro()
    {
        ...
        string novoValor = aditivar == "VL" || aditivar == "PV" || aditivar == "SC" || aditivar == "TC" ? txtNovoValor.Text : "NULL";
        string valorContrato = txtValorDoContrato.Text;
        string valorAditivo = aditivar == "VL" || aditivar == "PV" || aditivar == "SC" ? txtValorAditivo.Text : "NULL";
        string dataPrazo = aditivar == "PR" || aditivar == "PV" || aditivar == "SC" || aditivar == "TC" ? string.Format("CONVERT(DateTime, '{0:dd/MM/yyyy}', 103)", ddlDataPrazo.Date) : "NULL";
    ...
    {
        return string.Format(@"<table style=""width:100%""><tr><td align=""center"">{0}</td></tr></table>", (podeIncluir) ? @"<img src=""../../imagens/botoes/incluirReg02.png"" title=""Incluir"" onclick=""onClickBarraNavegacao('Incluir', gvDados, pcDados);"" style=""cursor: pointer;""/>" : @"<img src=""../../imagens/botoes/incluirRegDes.png"" title=""Incluir"" style=""cursor: default;""/>");
    }
}
