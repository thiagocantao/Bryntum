<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmAditivosContratoNovo.aspx.cs" Inherits="administracao_frmAditivosContratoNovo" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function validaCamposFormulario() {
            ...
            var contratacao = 2;//ddlTipoInstrumento.GetText();
            ...
            if (ddlAditivar.GetValue() == null && (contratacao != 'Termo de Encerramento de Contrato' && contratacao != 'TEC')) {
                numAux++;
                mensagem += "\n" + numAux + ") O campo: 'Repactuação de:' deve ser informado.";
            }
            ...
            if ((ddlAditivar.GetValue() == 'PR' || ddlAditivar.GetValue() == 'PV' || (contratacao == 'Termo de Encerramento de Contrato' || contratacao == 'TEC')) && ddlDataPrazo.GetValue() == null && ddlAditivar.GetValue() != 'TC') {
                numAux++;
                mensagem += "\n" + numAux + ") O campo: 'Novo Término Vigência:' deve ser informado.";
            }
            if ((ddlAditivar.GetValue() == 'VL' || ddlAditivar.GetValue() == 'PV' && (contratacao != 'Termo de Encerramento de Contrato' && contratacao != 'TEC')) && parseFloat(parseFloat(txtValorAditivo.GetValue().replace('.', '').replace(',', '.')).toFixed(2)) == 0 && ddlAditivar.GetValue() != 'TC') {
                numAux++;
                mensagem += "\n" + numAux + ") O valor da repactuação deve ser informado.";
            }

            if (valorAditivo + valorContrato < 0) {
                numAux++;
                mensagem += "\n" + numAux + ") Não é possível colocar um valor de repactuação negativo maior que o valor do contrato.";
            }
        ...
        function verificaTipoContrato(mudaValor) {
            if (ddlDataPrazo.cp_RO.toString() != "S") {
                ...
                var contratacao = 'Contrato';//ddlTipoInstrumento.GetText();
        ...
        function atualizaNovoValor() {
            ...
            if (txtValorDoContrato.GetText() != "") {
                try {
                    ...
                    var valorContrato = parseFloat(txtValorDoContrato.GetValue().toString().replace(',', '.'));
                    if (valorAditivo + valorContrato < 0) {
                        window.top.mostraMensagem('Não é possível colocar um valor de repactuação negativo maior que o valor do contrato', 'atencao', true, false, null);
        ...
        <dxcp:ASPxCallbackPanel ID="pnCallback" runat="server" ClientInstanceName="pnCallback"
            ...
            <PanelCollection>
                <dxp:PanelContent runat="server">
                    <dxhf:ASPxHiddenField runat="server" ID="hfGeral" ClientInstanceName="hfGeral"></dxhf:ASPxHiddenField>
...
"
       ...
       s.SetHeight(sHeight);
                        ...
                        <Columns>
                            ...
                            <dxwgv:GridViewDataTextColumn FieldName="NumeroContratoAditivo" Name="NumeroContratoAditivo"
                                Caption="Número Instrumento" VisibleIndex="1" Width="170px">
                                <Settings AutoFilterCondition="Contains" />
                                <Settings AutoFilterCondition="Contains"></Settings>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn FieldName="DescricaoTipoAditivo"
                                ShowInCustomizationForm="True" VisibleIndex="3" Caption="Repactuação de "
                                Width="200px">
                                <Settings AutoFilterCondition="Contains" />
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn FieldName="ValorAditivo"
                                ShowInCustomizationForm="True" VisibleIndex="4" Caption="Valor Repactuação"
                                Width="150px">
                            ...
                            <dxwgv:GridViewDataTextColumn Caption="Repactuação de" FieldName="TipoAditivo"
                        ...
                        <Templates>
                            <StatusBar>
                                <dxe:ASPxLabel ID="lblStatus0" runat="server"
                                    Text="Não é possível incluir, editar ou excluir repactuações. Este contrato possui uma repactuação pendente de aprovação no fluxo. ">
                                </dxe:ASPxLabel>
                            </StatusBar>
                        </Templates>
                    </dxwgv:ASPxGridView>
                    <dxpc:ASPxPopupControl runat="server" ClientInstanceName="pcDados"
                        ...
                        PopupVerticalAlign="WindowCenter" ShowCloseButton="False" Width="850px"
                        ID="pcDados" AllowDragging="True">
                        <ContentStyle>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="width:25%">
                                                                                <dxe:ASPxLabel ID="ASPxLabel24" runat="server"
                                                                                    Text="Valor Repactuação (R$):" Width="125px">
                                                                                </dxe:ASPxLabel>
                                                                            </td>
                                                                            <td style="width:25%">
                                                                                <dxe:ASPxLabel ID="ASPxLabel21" runat="server"
                                                                                    Text="Novo Valor do Contrato (R$):" Width="100%">
                                                                                </dxe:ASPxLabel>
                                                                            </td>
                                                                            <td style="width:25%">
                                                                                <dxe:ASPxLabel ID="ASPxLabel22" runat="server"
                                                                                    Text="Novo Término Vigência:">
                                                                                </dxe:ASPxLabel>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="left" style="padding-right: 5px; width:25%">
	...
	atualizaNovoValor();
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <dxe:ASPxMemo ID="mmMotivo" runat="server" ClientInstanceName="mmMotivo"
                                                                    Rows="4" Width="100%">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <dxe:ASPxLabel ID="ASPxLabel16" runat="server"
                                                                                Text="Responsável pela inclusão:">
                                                                            </dxe:ASPxLabel>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
            ...
            <ClientSideEvents EndCallback="function(s, e) 
{
	...
	if(&quot;Incluir&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(&quot;Repactuação incluído com sucesso!&quot;);
    else if(&quot;Editar&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(&quot;Repactuação alterado com sucesso!&quot;);
    else if(&quot;Excluir&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(&quot;Repactuação excluído com sucesso!&quot;);	
}"></ClientSideEvents>
