<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPropriedade.aspx.cs"
    Inherits="frmPropriedade" meta:resourcekey="PageResource5" %>
        ...
        function ProcessaResultadoCallback(s, e) {
            ...
            if (result && result.length && result.length > 0) {
                if (result.substring(0, 1) == "I") {
                    ...
                    window.location = "./frmPropriedade.aspx?" + result.substring(1) + "&tab=" + activeTabIndex;
                }
                                                            ...
                                                            <tr>
                                                                <td style="width: 100px; padding-right: 3px">
                                                                    <dxe:ASPxTextBox ID="txtSeq" runat="server" ClientInstanceName="txtSeq" 
                                                                         MaxLength="25" 
                                                                        meta:resourceKey="txtUnidadeGestoraResource1" Width="100%">
                                                                    </dxe:ASPxTextBox>
                                                                </td>
                                                                <td style="width: 400px; padding-right: 3px">
                                                                    <dxe:ASPxTextBox ID="txtLocalizacao" runat="server" 
                                                                        ClientInstanceName="txtLocalizacao"  
                                                                        MaxLength="255" meta:resourceKey="txtNomeProjetoResource1" Width="100%">
	...
	existeConteudoCampoAlterado = true;
                                                                ...
                                                                <td>
                                                                    <dxe:ASPxTextBox ID="txtDistrito" runat="server" 
                                                                        ...
                                                                        MaxLength="250" meta:resourceKey="txtUnidadeGestoraResource1" Width="100%">
                                                                    </dxe:ASPxTextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                <td style="width: 10%; padding-right: 3px">
                                                                    <dxe:ASPxComboBox ID="ddlUF" runat="server" ClientInstanceName="ddlUF" 
                                                                        ...
                                                                        meta:resourceKey="cmbUnidadeGestoraResource1" ShowShadow="False" 
                                                            ...
                                                            <tr>
                                                                <td style="width: 505px; padding-right: 3px">
                                                                    ...
                                                                    <dxe:ASPxTextBox ID="txtCoordenadas" runat="server" 
                                                                        ...
                                                                        MaxLength="50" meta:resourceKey="txtUnidadeGestoraResource1" Width="100%">
                                                                    </dxe:ASPxTextBox>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <dxe:ASPxTextBox ID="txtProcedenciaAquisicao" runat="server" 
                                                                        ...
                                                                        MaxLength="250" meta:resourceKey="txtUnidadeGestoraResource1" 
                                                                        Width="100%">
                                                                        <Paddings Padding="0px" />
                                                                    </dxe:ASPxTextBox>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="width: 90px; padding-right: 3px">
                                                                    <dxe:ASPxComboBox ID="ddlSpolio" runat="server" ClientInstanceName="ddlSpolio" 
                                                                        ...
                                                                        meta:resourceKey="cmbLiderResource1" SelectedIndex="1" Width="100%">
                                                                        <ClientSideEvents SelectedIndexChanged="function(s, e) {
	existeConteudoCampoAlterado = true;
	if(s.GetValue() == 'S')
	{
		...
		txtFone.SetEnabled(false);
                                                                ...
                                                                <td align="left">
                                                                    <dxe:ASPxTextBox ID="txtNomeInventariante" runat="server" ClientEnabled="False" 
                                                                        ...
                                                                        MaxLength="150" meta:resourceKey="txtUnidadeGestoraResource1" Width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding-right: 3px">
                                                                    <dxe:ASPxTextBox ID="txtEndereco" runat="server" ClientEnabled="False" 
                                                                        ...
                                                                        MaxLength="500" meta:resourceKey="txtUnidadeGestoraResource1" Width="100%">
                                                                        <DisabledStyle BackColor="#EBEBEB" ForeColor="Black">
                                                                        </DisabledStyle>
                                                                    </dxe:ASPxTextBox>
                                                                </td>
...
" />
            ...
            <tr>
                ...
                <td align="right" style="padding-top: 5px; padding-right: 5px;">
                    <dxe:ASPxButton ID="btnSalvar" runat="server" ClientInstanceName="btnSalvar"
                        ...
                        meta:resourcekey="btnSalvarResource1" Width="110px">
  ...
  INNER JOIN dbo.Municipio mun on (mun.CodigoMunicipio = pim.CodigoMunicipio)
