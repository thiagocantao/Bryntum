...
public partial class frmPropriedade : System.Web.UI.Page
{
    #region Properties
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (!string.IsNullOrEmpty(alturaTela))
            {
                ...
                divRolagem.Style.Add("height", (alturaInt - 120) + "px");
    ...
    private void CarregaDadosFormulario()
    {
        ...
        if (dv.Count > 0)
        {
            ...
            txtSeq.Value = row["SequencialImovel"];
