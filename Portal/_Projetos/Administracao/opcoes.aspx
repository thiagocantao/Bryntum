<%@ Page Language="C#" AutoEventWireup="true" CodeFile="opcoes.aspx.cs" Inherits="_Projetos_Administracao_opcoes" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-right: #e0e0e0 1px solid;
            ...
            <tr height="26px">
                <td valign="middle" style="height: 26px;padding-left:10px">
                    <asp:Label ID="lblTituloTela" runat="server" Font-Overline="False"
                        Font-Strikeout="False" Text="Gestão Projeto" Font-Bold="True"></asp:Label>
                </td>
            </tr>
        </table>
            ...
            <tr>
                ...
                <td valign="top">
                    <dxnb:ASPxNavBar ID="nvbMenuProjeto" runat="server" AutoCollapse="True"
                        ClientInstanceName="nvbMenuProjeto"  Width="170px">
<ItemStyle ></ItemStyle>
<Groups>
<dxnb:NavBarGroup Name="gpProjeto" Text="Gest&#227;o">
<ItemStyle ></ItemStyle>
</dxnb:NavBarGroup>
</Groups>
