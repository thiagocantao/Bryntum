<%@ Page Language="C#" AutoEventWireup="true" CodeFile="propostaDeIniciativa_004.aspx.cs"
    Inherits="_Projetos_Administracao_propostaDeIniciativa_004" meta:resourcekey="PageResource5" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function btnImprimir_Click(s, e) {
            ...
            var url = window.top.pcModal.cp_Path + "_Projetos/Administracao/ImpressaoTai.aspx?ModeloTai=tai004&CP=" + codigoProjeto + "&CF=" + codigoFormulario + "&Origem=" + origemMenuProjeto;
        ...
        function VerificaCamposObrigatoriosPreenchidos() {
            ...
            var cronogramaBasico = txtCronogramaBasico.GetValue() != null;
        ...
        function verificaAvancoWorkflow() {
            ...
            if (!camposPreenchidos) {
                ...
                var possuiCronogramaBasico = txtCronogramaBasico.GetValue() != null;
                ...
                if (!possuiEscopoIniciativa) {
                    camposNaoPreenchidos[cont] = "Produto Final / Resultados Esperados";
                    cont++;
                }

                if (!possuiCronogramaBasico) {
                    camposNaoPreenchidos[cont] = "Cronograma Básico";
                    cont++;
                }
        ...
        function ProcessaResultadoCallback(s, e) {
            ...
            if (result && result.length && result.length > 0) {
                ...
                if (result.substring(0, 1) == "I") {
                    ...
                    window.location = "./propostaDeIniciativa_004.aspx?CP=" + result.substring(1) + "&tab=" + activeTabIndex;
                }
...
<body>
	...
	existeConteudoCampoAlterado = true;
                                ...
                                <dxtc:TabPage Name="tabElementosResultado" Text="Resultados Esperados">
                                    <ContentCollection>
                                        <dxw:ContentControl runat="server" SupportsDisabledAttribute="True">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <dxwgv:ASPxGridView ID="gvResultados" runat="server" AutoGenerateColumns="False"
                                                                            ...
                                                                            <Columns>
                                                                                <dxwgv:GridViewCommandColumn ButtonRenderMode="Image" ShowInCustomizationForm="True" VisibleIndex="0"
                                                                                    Width="90px" ShowEditButton="true" ShowDeleteButton="true">
                                                                                    <HeaderTemplate>
	...
	existeConteudoCampoAlterado = true;
                                ...
                                <dxtc:TabPage Name="tabCronogramaOrcamento" Text="Cronograma e Orçamento">
                                    <ContentCollection>
                                        <dxw:ContentControl runat="server" SupportsDisabledAttribute="True">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <dxe:ASPxLabel ID="ASPxLabel49" runat="server" Font-Bold="True"
                                                                                                    meta:resourceKey="ASPxLabel10Resource1" Text="Estimativa de Orçamento">
                                                                                                </dxe:ASPxLabel>
                                                                                            </td>
                                                                                            ...
                                                                                            <td style="padding-left: 10px">
                                                                                                <dxe:ASPxImage ID="ASPxImage28" runat="server" ClientInstanceName="imgAjuda" Cursor="pointer"
                                                                                                    ...
                                                                                                    ToolTip="Valor total estimado para execução do projeto  (em R$)." Width="18px">
                                                                                                </dxe:ASPxImage>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                ...
                                                                                <td>
                                                                                    <table>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="padding-right: 5px; padding-left: 5px">
                                                                                                <dxe:ASPxLabel ID="lblCountObservacoes" runat="server" ClientInstanceName="lblCountObservacoes"
                                                                                                    ForeColor="Silver" Text="0 de 0">
                                                                                                </dxe:ASPxLabel>
                                                                                            </td>
                                                                                            <td style="padding-left: 10px">
                                                                                                <dxe:ASPxImage ID="ASPxImage4" runat="server" ClientInstanceName="imgAjuda" Cursor="pointer"
                                                                                                    Height="18px" ImageUrl="~/imagens/ajuda.png" ToolTip="Observações." Width="18px">
                                                                                                </dxe:ASPxImage>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <dxe:ASPxMemo ID="txtObservacoes" runat="server" ClientInstanceName="txtObservacoes"
                                                                                        ...
                                                                                        <ClientSideEvents Init="function(s, e) {
	var labelCount = lblCountObservacoes;
	var maxLength = 8000;
	labelCount.SetText(s.GetText().length + ' de ' + maxLength);
	return setMaxLength(s.GetInputElement(), maxLength, labelCount);
}"
