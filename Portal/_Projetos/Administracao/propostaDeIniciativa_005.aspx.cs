...
public partial class _Projetos_Administracao_propostaDeIniciativa_005 : System.Web.UI.Page
{
    #region Properties
    ...
    public string ConnectionString
    {
        ...
        private set
        {
            sdsAcoes.ConnectionString = 
                ...
                sdsPlanoComunicacao.ConnectionString =
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (!string.IsNullOrEmpty(alturaTela))
            {
                ...
                dv05.Style.Add("height", alturaTela + "px");
                dv06.Style.Add("height", alturaTela + "px");
                dv07.Style.Add("height", alturaTela + "px");
                dv01.Style.Add("overflow", "auto");
                dv02.Style.Add("overflow", "auto");
                dv03.Style.Add("overflow", "auto");
                dv04.Style.Add("overflow", "auto");
                dv05.Style.Add("overflow", "auto");
                dv06.Style.Add("overflow", "auto");
                dv07.Style.Add("overflow", "auto");
            }
        }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cDados.aplicaEstiloVisual(pnlDescricaoProjeto.Controls[1]);
        cDados.aplicaEstiloVisual(pnlElementosResultado.Controls[1]);
        cDados.aplicaEstiloVisual(pnlAlinhamentoEstrategico.Controls[1]);

        gvAquisicoes.DataBind();
        gvEquipe.DataBind();
        gvEstrategico.DataBind();
        gvParceiros.DataBind();
        gvPlanoComunicacao.DataBind();
    ...
    protected void gvEstrategico_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
    {
        ...
        if ("CodigoIndicador".Equals(e.Column.FieldName))
        {
            ...
            if (gvEstrategico.IsNewRowEditing)
                ...
                sdsIndicadorEstrategico.SelectParameters["CodigoIndicadorAtual"].DefaultValue = editor.Value == null ? "-1" : editor.Value.ToString();
 ...
 VALUES
        ({2}, '{3}', {4}, '{5}', 0, 0)"
            ...
            Response.Redirect(string.Format("propostaDeIniciativa_005.aspx?CP={2}&RO={0}&Altura={1}", (readOnly ? "S" : "N"), alturaTela, codProjeto), true);
        }
    }
    ...
    protected void gvRiscos_InitNewRow(object sender, DevExpress.Web.Data.ASPxDataInitNewRowEventArgs e)
    {
        e.NewValues["IndicaImpactoFinanceiro"] = "N";
        e.NewValues["IndicaImpactoPrazo"] = "N";
        e.NewValues["IndicaImpactoQualidade"] = "N";
        e.NewValues["IndicaImpactoEscopo"] = "N";
    }
    ...
    private void CarregaDadosFormulario()
    {
        ...
        if (dv.Count > 0)
        {
            ...
            cmbLinhaFinanciamento.Value = row["IndicaLinhaFinanciamento"];
            txtSetorIndustrial.Value = row["SetorIndustrial"];
        }
    }
...
DECLARE @CodigoProjeto int,
        ...
        @Escopo varchar(8000),
        @IndicaLinhaFinanciamento char(2),
        @SetorIndustrial varchar(500)
    ...
    SET @Escopo = '{16}'
    SET @IndicaLinhaFinanciamento = '{19}'
    SET @SetorIndustrial = '{20}'
...
INSERT INTO {0}.{1}.TermoAbertura03
    (  [CodigoProjeto], [NomeIniciativa], [CodigoGerenteIniciativa], [NomeGerenteIniciativa], [CodigoUnidadeNegocio], [NomeUnidadeNegocio],[DataInicio]
     , [DataTermino], [ValorEstimado], [ValorContrapartida], [FontesFinanciamento], [PublicoAlvo], [ObjetivoGeral], [Justificativa], [Escopo], [IndicaLinhaFinanciamento], [SetorIndustrial])
  VALUES
    (  @CodigoProjeto, @NomeIniciativa, @CodigoGerenteIniciativa, @NomeGerenteIniciativa, @CodigoUnidadeNegocio, @NomeUnidadeNegocio, @DataInicio 
     , @DataTermino, @ValorEstimado, @ValorContrapartida, @FontesFinanciamento, @PublicoAlvo, @ObjetivoGeral, @Justificativa, @Escopo, @IndicaLinhaFinanciamento, @SetorIndustrial)
...
END
 ...
 SELECT @CodigoProjeto AS CodigoProjeto,
        ...
        @MensagemErro AS MensagemErro"
            ...
            , cmbLinhaFinanciamento.Value ?? "NULL"
            , txtSetorIndustrial.Text.Replace("'", "''"));
        #endregion
...
UPDATE {0}.{1}.TermoAbertura03
   SET [NomeIniciativa]				= @NomeIniciativa
     ...
     , [Escopo]				        = @Escopo
     , [IndicaLinhaFinanciamento]   = @IndicaLinhaFinanciamento
     , [SetorIndustrial]            = @SetorIndustrial
