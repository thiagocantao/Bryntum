...
public partial class _Projetos_Administracao_propostaDeIniciativa009_I : System.Web.UI.Page
{
    int codigoProjeto = -1;
    dados cDados;
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        script += Environment.NewLine + "pnCarregarClick.Hide();";

        script += Environment.NewLine + "</script>";
        //this.ClientScript.RegisterClientScriptBlock(GetType(), "Client", script);
        ScriptManager.RegisterClientScriptBlock(this, GetType(), "client", script, false);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        rel_TAI_sesipe_projeto relatorio = new rel_TAI_sesipe_projeto(codigoProjeto);
