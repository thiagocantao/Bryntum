...
public partial class Cronograma_gantt : System.Web.UI.Page
{
    dados cDados;
    ...
    private void defineOpcoesEAP() 
    {
        ...
        { 
            ...
            string corpoEvento = string.Format(@"
                                             ...
                                             window.top.showModal('{1}&AM=ARG2&Altura=' + (Thisheight - 40), 'Editar EAP', null, null, ARG3, myArguments);"
                , nomeProjeto
                , urlEAP);

            if (edicaoEAP && eapBloqueadaEm != "")
            {
                btnAbrirCronoBloqueadoEAP.ClientSideEvents.Click = "function(s, e) {" + corpoEvento.Replace("ARG1", " (VISUALIZAR) ").Replace("ARG2", "RO").Replace("ARG3", "''") + "pcInformacaoEAP.Hide();}";
            
                corpoEvento = "pcInformacaoEAP.Show();";
            }

            string vs = "function(s, e) {" + corpoEvento.Replace("ARG1", " (VISUALIZAR) ").Replace("ARG2", "RO").Replace("ARG3", "funcaoPosModal") + "}";
            ...
            btnVisualizarEAP.ClientSideEvents.Click = "function(s, e) {" + corpoEvento.Replace("ARG1", " (VISUALIZAR) ").Replace("ARG2", "RO").Replace("ARG3", "funcaoPosModal").Replace("'Editar EAP'", "'Visualizar EAP'") + "}";
        }
    }
