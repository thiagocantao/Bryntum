    ...
    document.getElementById('divGrid').style.visibility = '';
                                                    ...
                                                    <Columns>
                                                        <dxwgv:GridViewCommandColumn ButtonRenderMode="Image" Caption="Ação" Name="Acao"
                                                            ShowInCustomizationForm="True" Visible="False" VisibleIndex="0" Width="130px" ShowClearFilterButton="true">
                                                            <CustomButtons>
                                    ...
                                    <tr>
                                        <td align="right" style="padding-top: 5px">
                                            <dxe:ASPxButton ID="btnFechar3" runat="server" AutoPostBack="False"
                                                ClientInstanceName="btnFechar3" ClientVisible="False"
...
CalcularTamanhoModal();
	local_onEnd_pnCallback(s,e);
        ...
        <dxpc:ASPxPopupControl runat="server" AllowDragging="True" ClientInstanceName="pcDados" AllowResize="true"
            CloseAction="None" HeaderText="Detalhes" PopupHorizontalAlign="WindowCenter" PopupVerticalOffset="-15"
            PopupVerticalAlign="WindowCenter" ShowCloseButton="False" ID="pcDados" Font-Bold="False" Width="800px">
	...
	gvDados.SetVisible(true);
            ...
            <ContentCollection>
                <dxpc:PopupControlContentControl runat="server">
                    ...
                    <div style="width: 815px; height: 385px; overflow: auto">
                        <table id="tbForm">
                            <tbody>
                                <tr>
                                    <td>
                                        <table style="width: 100%">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 125px">
                                                        <dxe:ASPxDateEdit runat="server" Width="100%" ClientInstanceName="deDataGeracao"
                                    ...
                                    <td style="padding-top: 5px">
                                        <table cellspacing="0" cellpadding="0" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <dxe:ASPxLabel runat="server" Text="An&#225;lise do Desempenho F&#237;sico: " ID="lblAnaliseDesempenhoFisico">
                                                        </dxe:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <td style="padding-top: 5px">
                                        <table cellspacing="0" cellpadding="0" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <dxe:ASPxLabel runat="server" Text="An&#225;lise do Desempenho Financeiro: " ID="lblAnaliseDesempenhoFinanceiro">
                                                        </dxe:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <td style="padding-top: 5px">
                                        <table cellspacing="0" cellpadding="0" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <dxe:ASPxLabel runat="server" Text="An&#225;lise dos Riscos : " ID="lblAnaliseRiscos">
                                                        </dxe:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <dxe:ASPxLabel ID="lbl_txtAnaliseRiscos" runat="server"
                                                            ClientInstanceName="lbl_txtAnaliseRiscos" Font-Bold="True" ForeColor="#999999">
                                                        </dxe:ASPxLabel>
                                                    </td>
                                                </tr>
                                            </tbody>
                                    ...
                                    <td style="padding-top: 5px">
                                        <table cellspacing="0" cellpadding="0" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <dxe:ASPxLabel runat="server" Text="An&#225;lise das Quest&#245;es: " ID="lblAnaliseQuestoes">
                                                        </dxe:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <td style="padding-top: 5px">
                                        <table cellspacing="0" cellpadding="0" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <dxe:ASPxLabel runat="server" Text="An&#225;lise das Metas: " ID="lblAnaliseMetas">
                                                        </dxe:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <dxe:ASPxLabel ID="lbl_txtAnaliseMetas" runat="server"
                                                            ClientInstanceName="lbl_txtAnaliseMetas" Font-Bold="True" ForeColor="#999999">
                                                        </dxe:ASPxLabel>
                                                    </td>
                                                </tr>
                                            </tbody>
                                ...
                                <td align="right" style="padding-right: 18px">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <dxe:ASPxButton ID="btnSalvar" runat="server" ClientInstanceName="btnSalvar" Text="Salvar" Width="90px">
                                                        <ClientSideEvents Click="function(s, e) {
	e.processOnServer = false;
    ...
    <script type="text/javascript">
        ...
        function CalcularTamanhoModal() {
            //seta tamanho do Modal e o tamanho do seu conteúdo
            var tamanhoModal = 'height:405px';
            var tamanhoConteudoModal = ' overflow: auto; height:390px;';

            //seta tamanho do Modal e o tamanho do seu conteúdo
            tamanhoModal += ' width:250px;';
            tamanhoConteudoModal += ' overflow: auto; width:950px;';
            $('.dxpc-mainDiv').attr({ 'style': tamanhoModal });
            $('#popup_relatorio_status_report').attr({ 'style': tamanhoConteudoModal });
            //alert(tamanhoConteudoModal + '_____' + tamanhoModal);
        }
