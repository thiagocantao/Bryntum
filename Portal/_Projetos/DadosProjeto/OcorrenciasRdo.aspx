<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OcorrenciasRdo.aspx.cs" Inherits="_Projetos_DadosProjeto_OcorrenciasRdo" %>
...
<body style="margin:0px">
        ...
        <table cellpadding="0" cellspacing="0" class="style1">
            <tr>
                <td align="center" class="style2" 
                    style="border: 1px solid #808080; background-color: #FFFFEC;">
            ...
            <tr>
                <td>
                    <dxhe:ASPxHtmlEditor ID="htmlOcorrencias" runat="server" 
                        ClientInstanceName="htmlOcorrencias"  
                        Width="100%">
                        <Toolbars>
                        ...
                        <Settings AllowHtmlView="False" AllowInsertDirectImageUrls="False" 
                            AllowPreview="False" />
                    </dxhe:ASPxHtmlEditor>
                </td>
            </tr>
	...
	if(s.cp_Msg == '')
	{
		window.top.mostraMensagem('Ocorrência salva com sucesso!', 'sucesso', false, false, null);
