...
public partial class _Projetos_DadosProjeto_ResumoProjeto2 : System.Web.UI.Page
{
    dados cDados;
    ...
    {       
        ...
        DataSet dsParametro = cDados.getParametrosSistema("projeto_Grafico001", "projeto_Grafico002", "projeto_Grafico003", "projeto_Grafico004", "projeto_Grafico005", "projeto_Grafico006", "diasAtualizacaoProjeto");
    ...
    private void preencheCampos()
    {
        ...
        if (cDados.DataSetOk(dsDados) && cDados.DataTableOk(dsDados.Tables[0]))
        {
            ...
            lblInicio.Text = dt.Rows[0]["InicioReprogramado"] + "" == "" ? "---" : dt.Rows[0]["InicioReprogramado"].ToString();
            lblTermino.Text = dt.Rows[0]["TerminoReprogramado"] + "" == "" ? "---" : dt.Rows[0]["TerminoReprogramado"].ToString();
            lblInicioLB.Text = dt.Rows[0]["DataInicio"] + "" == "" ? "---" : dt.Rows[0]["DataInicio"].ToString();
            lblTerminoLB.Text = dt.Rows[0]["DataTermino"] + "" == "" ? "---" : dt.Rows[0]["DataTermino"].ToString();
            ...
            lblCusto.Text = dt.Rows[0]["CustoTendenciaTotal"] + "" == "" ? "R$ --" : string.Format("{0:c2}", float.Parse(dt.Rows[0]["CustoTendenciaTotal"].ToString()));
