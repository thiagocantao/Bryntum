...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TarefasItemBacklog.aspx.cs" Inherits="administracao_CadastroRamosAtividades" %>
                                            ...
                                            CustomButtonClick="function(s, e) 
{
     ...
     {
       s.GetRowValues(s.GetFocusedRowIndex(), 'CodigoItem', MontaCamposFormulario);
     }
     ...
     {	
        s.GetRowValues(s.GetFocusedRowIndex(), 'CodigoItem;', MontaCamposFormularioRO);
     }	
}
"></ClientSideEvents>
                                        <Columns>
                                            <dxwgv:GridViewCommandColumn ButtonRenderMode="Image" Width="100px" VisibleIndex="0">
                                                ...
                                                <HeaderTemplate>
                                                    <%# string.Format(@"<table style=""width:100%""><tr><td align=""left"">{0}</td></tr></table>", (podeIncluir) ? @"<img src=""../../imagens/botoes/incluirReg02.png"" title=""Novo"" onclick=""LimpaCamposFormulario();"" style=""cursor: pointer;""/>" : @"<img src=""../../imagens/botoes/incluirRegDes.png"" title=""Novo"" style=""cursor: default;""/>")%>
                                                </HeaderTemplate>
                                                        ...
                                                        <td align="right">
                                                            <table class="formulario-botoes" cellspacing="0" cellpadding="0" border="0">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <dxe:ASPxButton runat="server" AutoPostBack="False" ClientInstanceName="btnSalvar" Text="Salvar" Width="100px" ID="btnSalvar" CssClass="btn">
    ...
    if (window.onClick_btnSalvar)
	    onClick_btnSalvar();
                                                                        ...
                                                                        <td>
                                                                            <dxe:ASPxButton runat="server" AutoPostBack="False" ClientInstanceName="btnFechar" Text="Fechar" Width="90px" ID="btnFechar" CssClass="btn">
                                                                                <ClientSideEvents Click="function(s, e) {
	e.processOnServer = false;
	...
	window.top.fechaModal();
     ...
     var codigoItem = s.cpCodigoItem;
      ...
      var descricaoItemSuperior = s.cpDescricaoItemSuperior;
                //debugger
      var url = window.top.pcModal.cp_Path +  '_Projetos/DadosProjeto/popupItensBacklog.aspx?CI=' + codigoItem  + &quot;&amp;acao=&quot; + acao + &quot;&amp;IDProjeto=&quot; + codigoProjeto + &quot;&amp;CPA=&quot; + codigoProjetoAgil + &quot;&amp;ALT=&quot; + (screen.height - 375).toString();
//window.top.fechaModal();&nbsp; &nbsp;  
window.top.showModal2(url, 'Tarefa' , 900, (screen.height - 270),&nbsp; finalizaEdicao, null);
}"></ClientSideEvents>
        </dxtv:ASPxCallback>
        </div>
    </form>
