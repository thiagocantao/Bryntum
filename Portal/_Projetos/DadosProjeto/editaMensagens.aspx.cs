...
public partial class _Projetos_DadosProjeto_editaMensagens : System.Web.UI.Page
{
   ...
   // bool ExcluirMsg;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            cDados.VerificaAcessoTelaSemMaster(this, idUsuarioLogado, codigoEntidade, codigoProjeto, "null", "PR", 0, "null", "PR_CnsMsg");
        }
    ...
    private void definePermissoesUsuario()
    {
        ...
        cDados.verificaPermissaoProjetoInativo(codigoProjeto, ref IncluiMsg, ref EditarMsg, ref RespMesg);
    }
    ...
    private void carregaGrid()
    {
        ...
        DataSet ds = cDados.getMensagemObjeto("PR", idUsuarioLogado, codigoProjeto, status, enviei
