<%@ Page Language="C#" AutoEventWireup="true" CodeFile="grafico_004.aspx.cs" Inherits="grafico_004" %>
                        ...
                        <tr>
                            <td align="left">
                                <dxe:ASPxLabel ID="ASPxLabel1" runat="server" 
                                    Text="Indicadores por Status">
                                </dxe:ASPxLabel>
                                &nbsp;</td>
                            <td align="right">
                                <img align="right" alt="Visualizar gráfico em modo ampliado" onclick="javascript:f_zoomGrafico('../../zoom.aspx', '', 'Flashs/AngularGauge.swf', '<%=grafico1_xmlzoom %>', '0')"
