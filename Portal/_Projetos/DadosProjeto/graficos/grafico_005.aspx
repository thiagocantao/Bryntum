<%@ Page Language="C#" AutoEventWireup="true" CodeFile="grafico_005.aspx.cs" Inherits="grafico_005" %>
                        ...
                        <tr>
                            <td align="left">
                                <dxe:ASPxLabel ID="ASPxLabel1" runat="server" 
                                    Text="Índice de Desempenho do Prazo">
                                </dxe:ASPxLabel>
                                &nbsp;</td>
                            <td align="right">
                                <img align="right" alt="Visualizar gráfico em modo ampliado" onclick="javascript:f_zoomGrafico('../../zoom.aspx', 'Índice de Desempenho do Prazo', 'Flashs/AngularGauge.swf', '<%=grafico1_xmlzoom %>', '0')"
