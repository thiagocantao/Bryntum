<%@ Page Language="C#" AutoEventWireup="true" CodeFile="grafico_006.aspx.cs" Inherits="grafico_006" %>
                        ...
                        <tr>
                            <td align="left">
                                <dxe:ASPxLabel ID="ASPxLabel1" runat="server" 
                                    Text="Índice de Desempenho do Custo">
                                </dxe:ASPxLabel>
                                &nbsp;</td>
                            <td align="right">
                                <img align="right" alt="Visualizar gráfico em modo ampliado" onclick="javascript:f_zoomGrafico('../../zoom.aspx', 'Índice de Desempenho do Custo', 'Flashs/AngularGauge.swf', '<%=grafico1_xmlzoom %>', '0')"
