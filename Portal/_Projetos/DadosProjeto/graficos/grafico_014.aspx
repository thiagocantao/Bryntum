<%@ Page Language="C#" AutoEventWireup="true" CodeFile="grafico_014.aspx.cs" Inherits="grafico_001" %>
                    ...
                    <tbody>
                        <tr>
                            <td align="left">
                                <dxe:ASPxRadioButtonList ID="rbGrafico" runat="server" AutoPostBack="True" 
                                    ...
                                    <Items>
                                        ...
                                        <dxe:ListEditItem Text="Curva S Orçamento" Value="C" />
                                    </Items>
                            ...
                            <td align="left">
                                &nbsp;</td>
                            <td align="right">
                                <img align="right" alt="Visualizar gráfico em modo ampliado" onclick="javascript:f_zoomGrafico('../../zoom.aspx', 'Desempenho Geral', '<%=grafico1_swfzoom %>', '<%=grafico1_xmlzoom %>', '0')"
