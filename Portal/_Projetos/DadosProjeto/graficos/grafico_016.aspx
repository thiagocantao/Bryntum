<%@ Page Language="C#" AutoEventWireup="true" CodeFile="grafico_016.aspx.cs" Inherits="grafico_016" %>
...
<body style="margin:0px">
    ...
    <table cellpadding="0" cellspacing="0" style="border-style: solid; border-width: 1px; border-color: #CCCCCC; width:100%; height: 65px;">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <dxe:ASPxHyperLink ID="hlProdutosAtrasados" runat="server" 
                                    ClientInstanceName="hlProdutosAtrasados"  
                                    ForeColor="#5D7B9D" Target="_parent" Text="Produtos Atrasados (0)">
                                </dxe:ASPxHyperLink>
                            </td>
                        </tr>
                        <tr>
