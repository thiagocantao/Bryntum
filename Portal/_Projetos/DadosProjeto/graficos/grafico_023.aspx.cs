...
public partial class grafico_001 : System.Web.UI.Page
{
    ...
    public string grafico_titulo = "Curva S de Alocação de Recursos";
    public string grafico_swf = "../../Flashs/MSLine.swf";
    public string grafico_swfZoom = "Flashs/MSLine.swf";
    ...
    private void geraGraficoCurva()
    {
        ...
        DataSet ds = cDados.getRecursosHumanosProjetoCurvaS(codigoProjeto, codigoEntidade, codigoUsuario);

        //função para gerar a estrutura xml para criação do gráfico
        xml = cDados.getGraficoProjetoCurvaS(ds.Tables[0], "", 9, 2, 10, 4, 25);
        ...
        xml = cDados.getGraficoProjetoCurvaS(ds.Tables[0], grafico_titulo, 15, 2, 10, 4, 25);
