<%@ Page Language="C#" AutoEventWireup="true" CodeFile="grafico_025.aspx.cs" Inherits="grafico_001" %>
                        ...
                        <tr>                            
                            <td align="left">
                                <dxe:ASPxLabel ID="ASPxLabel1" runat="server" 
                                    Text="Desempenho Físico - 1ª Linha de Base">
                                </dxe:ASPxLabel>
                                &nbsp;</td>
                            <td align="right">
                                <img align="right" alt="Visualizar gráfico em modo ampliado" onclick="javascript:f_zoomGrafico('../../zoom.aspx', 'Desempenho Físico - 1ª Linha de Base', 'Flashs/AngularGauge.swf', '<%=grafico1_xmlzoom %>', '0')"
