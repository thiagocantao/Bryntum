...
public partial class grafico_001 : System.Web.UI.Page
{
    ...
    private void carregaSpeedometro()
    {
        ...
        string nomeGrafico = @"/ArquivosTemporarios/SpeedometroLB1_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        xml = cDados.getGraficoDesempenhoFisico(dtGrafico, dtIndicadores, 9, "./ImageSaving/FusionChartsSave.aspx", "PercentualPrevistoLB1", "PercentualReal", "", true);
        ...
        nomeGrafico = "/ArquivosTemporarios/PercentualFisicoZoomLB1_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;

        //gera o xml do gráfico Gauge do percentual concluido ZOOM
        xml = cDados.getGraficoDesempenhoFisico(dtGrafico, dtIndicadores, 15, "./ImageSaving/FusionChartsSave.aspx", "PercentualPrevistoLB1", "PercentualReal", "Desempenho Físico - Primeira LB", true);
