...
public partial class _Projetos_DadosProjeto_graficozerotreze : System.Web.UI.Page
{
    dados cDados;
    int codigoProjeto = 0;
    ...
    private void defineLarguraTela()
    {
        ...
        if (modoTela.Equals("fsm"))
        {
            alturaTela = (altura - 135);
            gridProjetos.Settings.VerticalScrollableHeight = alturaTela - 225;
        }
        else
        {
    ...
    protected void menu_Init(object sender, EventArgs e)
    {
        ...
        cDados = CdadosUtil.GetCdados(listaParametrosDados);
        cDados.setaDefinicoesBotoesInserirExportar((sender as ASPxMenu), true, "", true, true, false, "LstMarPrj", "Marcos do Projeto", this);
    }
