<%@ Page Language="C#" MasterPageFile="~/novaCdis.master" AutoEventWireup="true" CodeFile="indexResumoDemanda.aspx.cs"
    Inherits="_Projetos_DadosProjeto_indexResumoDemanda" Title="Portal da Estratégia" %>
                    ...
                    <ClientSideEvents Click="function(s, e) 
{
	abreTelaNovaMensagem();	
                   ...
                   ToolTip="Resumo do projeto selecionado no formato PDF" ClientVisible="False" Visible="False">
                                <ClientSideEvents Click="function(s, e) 
{
	...
	lpAtualizando.Show();
                        ...
                        <td style="width: 25px">
                            <dxe:ASPxImage ID="imgAtualizar" runat="server" ImageUrl="~/imagens/atualizar.PNG"  ToolTip="Atualizar o Projeto" Visible="False">
                                <ClientSideEvents Click="function(s, e) {
    ...
    <table>
        <tr>
            <td style="width: 180px" valign="top">
                <dxnb:ASPxNavBar ID="nvbMenuProjeto" runat="server" Width="180px"  ClientInstanceName="nvbMenuProjeto">
...
lblTituloTela.SetText(&quot;Status da Demanda - &quot; + textoGrupo);*/
}"></ClientSideEvents>
<Groups>
    ...
    <dxnb:NavBarGroup Expanded="False" Name="opFluxos" Text="A&#231;&#245;es">
    </dxnb:NavBarGroup>
</Groups>
</dxnb:ASPxNavBar>
            </td>
    ...
    <dxcb:aspxcallback id="cbkGeral" runat="server" clientinstancename="cbkGeral" oncallback="cbkGeral_Callback"></dxcb:aspxcallback>
</asp:Content>
