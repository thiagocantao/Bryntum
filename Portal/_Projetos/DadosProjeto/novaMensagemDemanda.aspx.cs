...
public partial class _Projetos_DadosProjeto_novaMensagem : System.Web.UI.Page
{
    ...
    {
        string where = "AND us.CodigoUsuario <> " + idUsuarioLogado;
        DataSet ds = cDados.getUsuariosAtivosEntidade(codigoEntidade, where);
        hfCount.Set("QuantidadeSelecionados", ds.Tables[0].Rows.Count);
    ...
    protected void btnSalvar_Click(object sender, EventArgs e)
    {
        ...
        bool incluiu = cDados.incluiMensagemProjeto(codigoEntidade, codigoProjeto, idUsuarioLogado
                                                    ...
                                                    , ckbRespondeMsg.Checked, listaDestinatario, tipoAssociacao
                                                    , ref msgErro);
        if (!incluiu)
        {
