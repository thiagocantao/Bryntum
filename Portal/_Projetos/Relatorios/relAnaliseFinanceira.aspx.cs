...
public partial class _Projetos_Relatorios_relAnaliseFinanceira : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack && !IsCallback)
        {
            ...
            DataSet dsTemp = cDados.getParametrosSistema("exportaOLAPTodosFormatos", "TASQUES_OcultarColunaCusto");
            ...
            f_Custo.Visible = mostraCusto;
            field.Visible = mostraCusto;
            f_Custo.Options.ShowInCustomizationForm = mostraCusto;
            field.Options.ShowInCustomizationForm = mostraCusto;
