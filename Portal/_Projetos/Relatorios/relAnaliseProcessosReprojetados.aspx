<%@ Page Language="C#" MasterPageFile="~/novaCdis.master" AutoEventWireup="true"
    CodeFile="relAnaliseProcessosReprojetados.aspx.cs" Inherits="_Projetos_Relatorios_relAnaliseProcessosReprojetados"
                        ...
                        <tr style="height:26px">
                            <td valign="middle" style="padding-left: 10px">
                                <asp:Label ID="lblTituloTela" runat="server" EnableViewState="False" Font-Bold="True"
                                    ...
                                    Text="Análise dos Processos Reprojetados"></asp:Label>
                            </td>
