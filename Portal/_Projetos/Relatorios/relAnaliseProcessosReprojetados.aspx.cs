...
public partial class _Projetos_Relatorios_relAnaliseProcessosReprojetados : System.Web.UI.Page
{
        ...
        using (MemoryStream stream = new MemoryStream())
        {
            ...
            try
            {
                ...
                if (hfGeral.Get("tipoArquivo").ToString() == "HTML")
                {
                    ...
                    nomeArquivo = "analiseProcessosReprojetados_" + dataHora + ".html";
                ...
                {
                    nomeArquivo = "analiseProcessosReprojetados_" + dataHora + ".pdf";
                ...
                {
                    nomeArquivo = "analiseProcessosReprojetados_" + dataHora + ".xls";
                ...
                {
                    nomeArquivo = "analiseProcessosReprojetados_" + dataHora + ".rtf";
                    ASPxPivotGridExporter1.ExportToRtf(stream);
                    app = "application/rtf";
                }
                if (hfGeral.Get("tipoArquivo").ToString() == "CSV")
                {
                    nomeArquivo = "analiseProcessosReprojetados_" + dataHora + ".csv";
