<%@ Page Language="C#" MasterPageFile="~/novaCdis.master" AutoEventWireup="true" CodeFile="relAnaliseReprojetos.aspx.cs"
    Inherits="_Projetos_Relatorios_relAnaliseProjetos" Title="Portal da Estratégia" %>
                        ...
                        <tr style="height:26px">
                            <td valign="middle" style="padding-left: 10px">
                                <asp:Label ID="lblTituloTela" runat="server" EnableViewState="False" Font-Bold="True"
                                    ...
                                    Text="Análise de Processos Redesenhados"></asp:Label></td>
