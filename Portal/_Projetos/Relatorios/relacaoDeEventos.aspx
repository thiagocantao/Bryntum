<%@ Page Title="" Language="C#" MasterPageFile="~/novaCdis.master" AutoEventWireup="true"
    CodeFile="relacaoDeEventos.aspx.cs" Inherits="_Projetos_Relatorios_relacaoDeEventos" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td align="left" valign="middle" style="padding-left: 10px">
                            <dxe:ASPxLabel ID="lblTituloTela" runat="server" Text="Relação de Eventos" ClientInstanceName="lblTituloTela">
                            </dxe:ASPxLabel>
                        </td>
                    </tr>
                </table>
                                    ...
                                    CustomButtonClick="function(s, e) 
{
	...
	{			
		//onClickBarraNavegacao(&quot;Editar&quot;, gvDados, pcDados);
                                ...
                                <SettingsBehavior AllowSort="False" AllowFocusedRow="True" AutoExpandAllGroups="True"></SettingsBehavior>
                                <SettingsPager Mode="ShowAllRecords">
                                </SettingsPager>
                                <Settings ShowFilterRow="True" VerticalScrollBarMode="Visible" ShowGroupPanel="True"></Settings>
                                <Styles>
