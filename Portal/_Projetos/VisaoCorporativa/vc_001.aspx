                    ...
                    <tr>
                        <td align="left">
                            <dxe:ASPxLabel ID="ASPxLabel1" runat="server" 
                                Text="Projetos - Desempenho Geral">
                            </dxe:ASPxLabel>
                            &nbsp;</td>
                        <td align="right">
                            <img align="right" alt="Visualizar gráfico em modo ampliado" onclick="javascript:f_zoomBullets('../zoomBullets.aspx', 'Projetos - Desempenho Geral' ,'HBullet.swf', '<%=grafico1_xmlzoom %>', 'HBullet.swf', '<%=grafico2_xmlzoom %>', 'HBullet.swf', '<%=grafico3_xmlzoom %>')"
