...
public partial class _Projetos_VisaoCorporativa_vc_003 : System.Web.UI.Page
{
    ...
    public string grafico_titulo = "Projetos por Desempenho e Unidade";
    ...
    private void geraGrafico()
    {
        ...
        DataSet ds = cDados.getDesempenhoProjetosUnidadeVC(int.Parse(cDados.getInfoSistema("IDUsuarioLogado").ToString()), int.Parse(cDados.getInfoSistema("CodigoEntidade").ToString()), where);
        ...
        //função para gerar a estrutura xml para criação do gráfico de quantidade de projetos por entidade
        xml = cDados.getGraficoDesempenhoProjetos(ds.Tables[0], "Projetos - Desempenho/Unidade", 15, false, 0, 1);
