<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vc_004.aspx.cs" Inherits="_Projetos_VisaoCorporativa_vc_004" %>
...
<body style="margin:0px">
    ...
    <div style="text-align: center">
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="#FFFFFF"
            ...
            <HeaderTemplate>
                <table style="WIDTH: 100%" cellspacing="0" cellpadding="0"><TBODY><tr><td align=left><dxe:ASPxLabel id="ASPxLabel1" runat="server" Text="Projetos - Esforço/Unidade(h)">
