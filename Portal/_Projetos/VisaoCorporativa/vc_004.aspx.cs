...
public partial class _Projetos_VisaoCorporativa_vc_004 : System.Web.UI.Page
{
    ...
    public string grafico_titulo = "Esforço dos Projetos/Unidade(h)";
    ...
    private void geraGrafico()
    {
        ...
        string nomeGrafico = @"/ArquivosTemporarios/TrabalhoVC_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        xml = cDados.getGraficoPrevistoReal(ds.Tables[0], "TrabalhoPrevisto", "TrabalhoReal", "", 9, true);
        ...
        nomeGrafico = "\\ArquivosTemporarios\\TrabalhoVCZOOM_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;

        //função para gerar a estrutura xml para criação do gráfico de quantidade de projetos por entidade
        xml = cDados.getGraficoPrevistoReal(ds.Tables[0], "TrabalhoPrevisto", "TrabalhoReal", "Esforço dos Projetos por Unidade (Horas)", 15, false);
