<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vc_005.aspx.cs" Inherits="_Projetos_VisaoCorporativa_vc_005" %>
...
<body style="margin:0px">
    ...
    <div style="text-align: center">
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="#FFFFFF"
            ...
            CssPostfix="PlasticBlue" HeaderText="Despesa/Receita por Categoria"
            ...
            <PanelCollection>
                ...
                <div id="chartdiv" align="center">
                    ...
                    </script></dxp:PanelContent>
            </PanelCollection>
            <HeaderTemplate>
                 <table style="WIDTH: 100%" cellspacing="0" cellpadding="0"><TBODY><tr><td align=left><dxe:ASPxLabel id="ASPxLabel1" runat="server" Text="Projetos - Despesa/Unidade(R$)">
                            </dxe:ASPxLabel></td><td align=right><IMG style="CURSOR: pointer" 
                    onclick="javascript:f_zoomGrafico('../zoom.aspx', '', 'Flashs/MSBar2D.swf', '<%=grafico_xmlzoom %>', '0')" 
