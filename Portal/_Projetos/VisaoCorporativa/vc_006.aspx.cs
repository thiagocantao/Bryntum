...
public partial class _Projetos_VisaoCorporativa_vc_006 : System.Web.UI.Page
{
    dados cDados;
    ...
    public string grafico_titulo = "Projetos - Receita/Unidade(R$)";
    ...
    private void geraGrafico()
    {
        ...
        string nomeGrafico = @"/ArquivosTemporarios/ReceitaVC_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        xml = cDados.getGraficoPrevistoReal(ds.Tables[0], "ReceitaPrevista", "ReceitaReal", "", 9, true);
        ...
        nomeGrafico = "\\ArquivosTemporarios\\ReceitaVCZOOM_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;

        //função para gerar a estrutura xml para criação do gráfico de quantidade de projetos por entidade
        xml = cDados.getGraficoPrevistoReal(ds.Tables[0], "ReceitaPrevista", "ReceitaReal", "Projetos - Receita/Unidade(R$)", 15, false);
