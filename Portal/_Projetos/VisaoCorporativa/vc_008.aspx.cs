...
public partial class _Projetos_VisaoCorporativa_vc_002 : System.Web.UI.Page
{
    ...
    private void defineLarguraTela()
    {
        ...
        else
        {
            ...
            //ASPxRoundPanel1.ContentHeight = 250;
        }
    }
    ...
    private void geraGrafico()
    {
        ...
        xml = cDados.getGraficoDesempenhoEntidade(ds.Tables[0], "", 9, true, 0);
        ...
        //função para gerar a estrutura xml para criação do gráfico de quantidade de projetos por entidade
        xml = cDados.getGraficoDesempenhoEntidade(ds.Tables[0], "Desempenho Projetos", 15, false, 1);
