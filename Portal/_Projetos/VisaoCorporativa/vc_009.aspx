<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vc_009.aspx.cs" Inherits="_Projetos_VisaoCorporativa_vc_003" %>
                        ...
                        <tr>
                            <td align="left">
                                <dxe:ASPxLabel ID="ASPxLabel1" runat="server" 
                                    Text="Produtos do TAI por Status">
                                </dxe:ASPxLabel>
                                &nbsp;</td>
                            <td align="right">
                                <img align="right" alt="Visualizar gráfico em modo ampliado" onclick="javascript:f_zoomGrafico('../zoom.aspx', '', 'Flashs/Column2D.swf', '<%=grafico_xmlzoom %>', '0')"
