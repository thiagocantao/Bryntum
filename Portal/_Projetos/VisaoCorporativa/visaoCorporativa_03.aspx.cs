...
public partial class _Portfolios_visaoCorporativa_01 : System.Web.UI.Page
{
    ...
    public string grafico1 = "", grafico2 = "", grafico3 = "", grafico4 = "", grafico5 = "", numeros1 = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataSet dsParametro = cDados.getParametrosSistema("vc_grafico001", "vc_grafico002", "vc_grafico003", "vc_grafico004", "vc_grafico005",
        ...
        if (cDados.DataSetOk(dsParametro) && cDados.DataTableOk(dsParametro.Tables[0]))
        {
            ...
            grafico5 = dsParametro.Tables[0].Rows[0]["vc_grafico005"] + "" == "" ? grafico5 : dsParametro.Tables[0].Rows[0]["vc_grafico005"] + ".aspx?Largura=" + larguraGraficoGrande + "&Altura=" + alturaGrafico + "&" + Request.QueryString;
