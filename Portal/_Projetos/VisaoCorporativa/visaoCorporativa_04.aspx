<%@ Page Language="C#" AutoEventWireup="true" CodeFile="visaoCorporativa_04.aspx.cs" Inherits="_Portfolios_visaoCorporativa_01" %>
                        ...
                        <tr>
                            <td>
                                ...
                                <iframe frameborder="0" height="<%=metadeAlturaTela %>" scrolling="no" src="<%=grafico2 %>"
                                    width="<%=larguraTela %>" id="I3" name="I3"></iframe>
                                        </td>
                                        <td>
                                <iframe frameborder="0" height="<%=metadeAlturaTela %>" scrolling="no" src="<%=grafico3 %>"
                                    width="<%=larguraTela %>" id="I4" name="I4"></iframe>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td>
                                <iframe frameborder="0" height="<%=metadeAlturaTela %>" scrolling="no" src="<%=grafico4 %>"
                                    width="<%=larguraTelaMaior %>" id="I1" name="I1"></iframe>
                            </td>
                        </tr>
                    </table>
                </td>
