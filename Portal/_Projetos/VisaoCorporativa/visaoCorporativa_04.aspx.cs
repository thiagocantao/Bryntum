...
public partial class _Portfolios_visaoCorporativa_01 : System.Web.UI.Page
{
    ...
    public string larguraTela = "", larguraTelaMaior = "", alturaTela = "", larguraTabela = "", metadeAlturaTela = "", larguraGraficoBarras = "", alturaNumeros = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataSet dsParametro = cDados.getParametrosSistema("vc_grafico001", "vc_grafico002", "vc_grafico003", "vc_grafico004",
        ...
        if (cDados.DataSetOk(dsParametro) && cDados.DataTableOk(dsParametro.Tables[0]))
        {
            ...
            grafico4 = dsParametro.Tables[0].Rows[0]["vc_grafico004"] + "" == "" ? grafico4 : dsParametro.Tables[0].Rows[0]["vc_grafico004"] + ".aspx?Largura=" + larguraGraficoGrande + "&Altura=" + alturaGrafico + "&NumeroColunas=20" + "&" + Request.QueryString;
    ...
    private void defineLarguraTela()
    {
        ...
        larguraTelaMaior = ((largura - 250)).ToString() + "px";
        ...
        larguraGraficoGrande = ((largura - 253)).ToString();
    }
}
