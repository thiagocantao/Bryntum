<%@ Page Language="C#" AutoEventWireup="true" CodeFile="visaoCorporativa_05.aspx.cs" Inherits="_Portfolios_visaoCorporativa_01" %>
                        ...
                        <tr>
                            <td>
                                ...
                                <iframe frameborder="0" height="<%=metadeAlturaTela %>" scrolling="no" src="<%=grafico1 %>"
                                    width="<%=larguraTela %>" id="I12" name="I12"></iframe>
                                        </td>
                                        <td>
                                <iframe frameborder="0" height="<%=metadeAlturaTela %>" scrolling="no" src="<%=grafico2 %>"
                                    width="<%=larguraTelaGrande %>" id="I13" name="I13"></iframe>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td>
                                ...
                                <iframe frameborder="0" height="<%=metadeAlturaTela %>" scrolling="no" src="<%=grafico3 %>"
                                    width="<%=larguraTelaGrande %>" id="I17" name="I17"></iframe>
                                        </td>
                                        <td>
                                <iframe frameborder="0" height="<%=metadeAlturaTela %>" scrolling="no" src="<%=grafico4 %>"
                                    width="<%=larguraTela %>" id="I16" name="I16"></iframe>
                                        </td>
                                    </tr>
                                </table>
                            </td>
