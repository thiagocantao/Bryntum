<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dem_003.aspx.cs" Inherits="_Portfolios_VisaoDemandas_dem_003" %>
                        ...
                        <tr>
                            <td align="left">
                                <dxe:ASPxLabel ID="ASPxLabel1" runat="server" 
                                    Text="Projetos X Demandas X Processos por Unidade">
                                </dxe:ASPxLabel>
                                &nbsp;</td>
                            <td align="right">
                                <img align="right" alt="Visualizar gráfico em modo ampliado" onclick="javascript:f_zoomGrafico('../zoom.aspx', '', 'Flashs/ScrollStackedColumn2D.swf', '<%=grafico_xmlzoom %>', '0')" 
