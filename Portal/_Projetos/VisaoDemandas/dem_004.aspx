<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dem_004.aspx.cs" Inherits="_Portfolios_VisaoDemandas_dem_004" %>
            ...
            <HeaderTemplate>
                <table>
                    <tbody>
                        <tr>
                            <td align="left">
                                Alocação (Projeto, Demanda e Processo)*</td>
                            <td align="right">
                                <img align="right" alt="Visualizar gráfico em modo ampliado" onclick="javascript:f_zoomGrafico('../zoom.aspx', '', 'Flashs/Pie2D.swf', '<%=grafico_xmlzoom %>', '0')" 
