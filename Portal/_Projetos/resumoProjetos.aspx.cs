...
public partial class _Projetos_resumoProjetos : System.Web.UI.Page
{
    ...
    public string alturaTabela, displayLaranja = "", displayUnidadeAtendimento = "", displayGerenteProjeto = "", displayCategoria = "", displayStatus = "", displaySuspensos = "N", displayCancelados = "N", displayEncerrados = "N";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        hfGeral.Set("definicaoUnidadeAtendimento", lblUnidadeAtendimento.Text);
         ...
         dsParametros = cDados.getParametrosSistema("urlTelaInclusaoProjeto", "mostrarValoresReceita", "mostrarBoletinsUnidade", "MostraFisicoLaranja",
                                                           ...
                                                           "MostraCorTrabalho", "MostraCorMeta", "MostraCor_IAM", "MostraCorConvenio", "cig_Custo", "cig_Escopo", "cig_Fisico", "cig_Trabalho",
                                                           "cig_Receita", "cig_Risco", "cig_Meta", "cig_IAM", "cig_convenio", "MostraUltimaAtualizacao", "labelDespesa",
                                                           "codigoCarteiraListaProcessos", "tituloTelaListaProcessos");
        ...
        if (cDados.DataSetOk(ds) && cDados.DataTableOk(ds.Tables[0]))
        {
            ...
            foreach (string valorCampo in ds.Tables[0].Rows[0]["FiltroAplicado"].ToString().Split('¥'))
            {
                if (valorCampo.Contains(";;ddlGerentes;;"))
                {
                    ...
                    {
                        string comandoSQLUsuario = string.Format(@"SELECT NomeUsuario FROM Usuario WHERE CodigoUsuario = " + ddlGerentes.Value);
