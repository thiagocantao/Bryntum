...
(function (l,
    t) {
    var s = typeof exports == "object"; if (typeof define == "function" && define.amd) define([

    ],
        t); else if (typeof module == "object" && module.exports) module.exports = t(); else {
            var c = t(),
                u = s ? exports : l; for (var m in c) u[
                    m
                ] = c[
                    m
                    ]
    ...
    () => {
        var l = {
            ...
            b = (e,
                ...
                o,
                r) => {
                if (a && typeof a == "object" || typeof a == "function") for (let n of u(a)) !m.call(e,
                    n) && n !== o && s(e,
                        n,
                        {
                            get: () => a[
                ...
                t.exports = f(p); var d = class {
                    static mergeLocales(...e) {
                        ...
                        let o = (r,
                            ...
                            Object.keys(a[
                                r
                            ]).length > 0 ? Object.keys(a[
                                r
                            ]).forEach(n => o(r,
                                n)) : o(r)
                        })
                    } static normalizeLocale(e,
                        a) {
                        if (!e) throw new Error('"nameOrConfig" parameter can not be empty'); if (typeof e == "string") {
                            if (!a) throw new Error('"config" parameter can not be empty'); a.locale ? a.name = e || a.name : a.localeName = e
                        } else a = e; let o = {

                        }; if (a.name || a.locale) o = Object.assign({
                            localeName: a.name
                        },
                            a.locale),
                            a.desc && (o.localeDesc = a.desc),
                            a.code && (o.localeCode = a.code),
                            a.path && (o.localePath = a.path); else {
                            if (!a.localeName) throw new Error(`"config" parameter doesn't have "localeName" property`); o = Object.assign({
                        ...
                        r
                        ]; if (!o.localeName) throw new Error("Locale name can not be empty"); return o
                    } static get locales() {
                        return globalThis.bryntum.locales || {

                        }
                    } static set locales(e) {
                        globalThis.bryntum.locales = e
                    } static get localeName() {
                        return globalThis.bryntum.locale || "En"
                    } static set localeName(e) {
                        globalThis.bryntum.locale = e || d.localeName
                    } static get locale() {
                        return d.localeName && this.locales[
                            d.localeName
                        ] || this.locales.En || Object.values(this.locales)[
                            0
                            ] || {
                                localeName: "",
                                localeDesc: "",
                    ...
                    } static publishLocale(e,
                        a) {
                        let {
                            locales: o
                        } = globalThis.bryntum,
                            r = d.normalizeLocale(e,
                                a),
                            {
                                localeName: n
                            } = r; return !o[
                        ...
                        i._$name = "LocaleHelper"; var h = {
                            ...
                            C = {
                                ...
                                Field: {
                                    ...
                                    rangeOverflow: e => `O valor deve ser inferior ou igual a ${e.max}`,
                                    rangeUnderflow: e => `O valor deve ser superior ou igual a ${e.min}`,
                                ...
                                PagingToolbar: {
                                    ...
                                    pageCountTemplate: e => `de ${e.lastPage}`,
                                    summaryTemplate: e => `A apresentar registos ${e.start} - ${e.end} até ${e.allCount}`
                                },
                                PanelCollapser: {
                                    Collapse: "Fechar",
                                    Expand: "Expandir"
                            ...
                            E = {
                                ...
                                HeaderMenu: {
                                    moveBefore: e => `Mover para antes de "${e}"`,
                                    moveAfter: e => `Mover para depois de "${e}"`,
                                ...
                                Column: {
                                    columnLabel: e => `${e.text ? `${
                                        e.text
                                        }coluna.` : ""}ESPAÇO para menu de contexto${e.sortable ? ", ENTER para ordenar" : ""}`,
                                    cellLabel: y
                                },
                                Checkbox: {
                                ...
                                RatingColumn: {
                                    cellLabel: e => {
                                        var a; return `${e.text ? e.text : ""} ${(a = e.location) != null && a.record ? `avaliação ${
                                            e.location.record.get(e.field) || 0
                                            }` : ""}`
                                    }
                                },
                                GridBase: {
                                    ...
                                    moveColumnTo: e => `Mover coluna para ${e}`
                                },
                                CellMenu: {
                                    removeRow: "Eliminar"
                                },
                            ...
                            T = {
                                ...
                                ResourceInfoColumn: {
                                    eventCountText: e => e + " evento" + (e !== 1 ? "s" : "")
                                },
                                Dependencies: {
                                    from: "De",
                                    to: "Até",
                            ...
                            F = i.publishLocale(A); if (typeof t.exports == "object" && typeof l == "object") {
                                var R = (e,
                                    a,
                                    o,
                                    r) => {
                                    if (a && typeof a == "object" || typeof a == "function") for (let n of Object.getOwnPropertyNames(a)) !Object.prototype.hasOwnProperty.call(e,
                                        n) && n !== o && Object.defineProperty(e,
                                            n,
                                            {
                                                get: () => a[
                                                    n
                                                ],
                                                enumerable: !(r = Object.getOwnPropertyDescriptor(a,
                                                    n)) || r.enumerable
                                            }); return e
