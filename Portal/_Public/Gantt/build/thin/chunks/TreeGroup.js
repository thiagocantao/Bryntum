 ...
 *
 */
import { InstancePlugin, FunctionHelper, ObjectHelper } from './Editor.js';
...
class TreeGroup extends InstancePlugin {
  ...
  async waitForReadiness() {
    ...
    if (crudManager) {
      ...
      await ((_me$client$project = me.client.project) === null || _me$client$project === void 0 ? void 0 : _me$client$project.commitAsync());
    }
  }
  async applyLevels(levels) {
    ...
    if (treeColumn !== null && treeColumn !== void 0 && treeColumn.field && modelClass.getFieldDefinition(treeColumn.field)) {
    ...
    if (levels.length > 0) {
      ...
      await me.trigger('beforeDataLoad', {
        store,
    ...
    client.trigger('treeGroupChange', {
      levels
    });
  }
  doDisable(disable) {
   ...
   */
  refreshGroups() {
    var _this$applyLevels;
    // since we have a buffered wrapper of this function
    // we have to check if applyLevels exists in case the feature is destroyed
    return (_this$applyLevels = this.applyLevels) === null || _this$applyLevels === void 0 ? void 0 : _this$applyLevels.call(this, this._levels);
  }
  /**
