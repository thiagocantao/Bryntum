...
//---------------------------------------------------------------------------------------------------------------------
export class WalkDepthNoCyclesNoVisitStateRecursive extends Base {
    constructor() {
        super(...arguments);
...
//---------------------------------------------------------------------------------------------------------------------
export class WalkDepthNoCyclesNoVisitStateExternalStack extends Base {
    constructor() {
        super(...arguments);
        this.visited = new Set();
    }
...
//---------------------------------------------------------------------------------------------------------------------
export class WalkDepthNoCyclesNoVisitStateExternalStackGenerator extends Base {
    constructor() {
        super(...arguments);
        this.visited = new Set();
    }
