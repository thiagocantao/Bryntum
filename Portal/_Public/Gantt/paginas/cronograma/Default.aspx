...
<body style="height: 95%">
    ...
    <form runat="server">
        <div style="display: none;">
            <dxe:ASPxButton ID="btnConfirmaEdicaoCronograma" AutoPostBack="False" ClientInstanceName="btnConfi2rmaEdicaoCronograma" runat="server" Text="btnConfirmaEdicaoCronograma">
...
<%--        <script src="../../build/locales/gantt.locale.Pt_BR.js"></script>--%>
        ...
        <script data-default-locale="Pt_BR" src="../../build/gantt.umd.min.js"></script>
