 ...
 *
 */
declare module "bryntum-gantt/gantt.lite.umd.js" {
    ...
    export class Store extends Base implements StoreChained, StoreCRUD, StoreFilter, StoreGroup, StoreSearch, StoreSort, StoreState, StoreSum, StoreTree, Events, StoreStm {        
        static stores: Store[];
        allCount: number;
        allRecords: Model[];
        autoCommit: boolean;
    ...
    export class UndoRedo extends Container {        
    ...
    export class SchedulerProCalendarModel extends Model implements PartOfProject {        
        ...
        addInterval(interval: SchedulerProCalendarIntervalModel): void;
        addIntervals(intervals: SchedulerProCalendarIntervalModel[]): void;
    }
    ...
    type SchedulerProProjectModelConfig = {        
        ...
        assignmentStoreClass: SchedulerProAssignmentStore|object;
        assignmentsData: SchedulerAssignmentModel[];
        autoLoad: boolean;
        autoSync: boolean;
        autoSyncTimeout: number;
        ...
        dependencyStoreClass: SchedulerProDependencyStore|object;
        direction: string;
        ...
        resourceStoreClass: SchedulerProResourceStore|object;
        resourceTimeRangesData: ResourceTimeRangeModel[];
        resourcesData: SchedulerResourceModel[];
        silenceInitialCommit: boolean;
        stm: object|StateTrackingManager;
    ...
    type TimelineConfig = {        
        ...
        presets: object[];
        preventTooltipOnTouch: boolean;
        project: SchedulerProProjectModel|object;
        readOnly: boolean;
        ref: string;
        removeUnassignedEvent: boolean;
        resizeToFitIncludesHeader: boolean;
