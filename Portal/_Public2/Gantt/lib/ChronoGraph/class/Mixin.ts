 ...
 * for example the creation of the Mixin3Â will reuse the minimal class of the Mixin2Â instead of creating a new intermediate class.
 ...
 *
 * This is a [well-known problem](https://github.com/microsoft/TypeScript/issues/35822) in the TypeScript world â€“ the *.d.ts files do not represent
 ...
 * This is why the compiler may generate false positives in the incremental compilation mode â€“ it uses *.d.ts files internally.
 *
