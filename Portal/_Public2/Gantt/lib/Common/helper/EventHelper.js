            ...
            if (!isOption[eventName]) {
                ...
                if (BrowserHelper.isTouchDevice) {
                    if (eventName === 'contextmenu') {
                        ...
                        handlerDetails.push(EventHelper.addElementListener(targetElement, 'touchend', {
                            handler : EventHelper.createDblClickWrapper(targetElement, handlerSpec.handler, handlerSpec.thisObj || thisObj),
                            delay   : 10,
                            capture : true
                        }, options));
                    }
