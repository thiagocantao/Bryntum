...
export default class Rectangle {
     ...
     * @param [devicePixelRatio] device pixel ratio which defaults to `window.devicePixelRatio`
     */
     ...
     * @param {Number} [spec.constrainPadding] The amount of pixels to pad from the constraining element
