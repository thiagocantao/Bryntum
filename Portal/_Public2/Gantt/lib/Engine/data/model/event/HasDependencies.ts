...
import { generic_field, field, calculate } from "../../../../ChronoGraph/replica/Entity.js"
...
//---------------------------------------------------------------------------------------------------------------------
export const HasDependencies = <T extends AnyConstructor<ConstrainedEvent>>(base : T) => {
    ...
    class HasDependencies extends base {
        ...
        protected * calculateEarlyStartDateConstraintIntervals () : ChronoIterator<ConstraintInterval[]> {
        ...
        protected * calculateEarlyEndDateConstraintIntervals () : ChronoIterator<ConstraintInterval[]> {
            // if (window.DEBUG) debugger
        ...
        protected * calculateLateStartDateConstraintIntervals () : ChronoIterator<ConstraintInterval[]> {
            // if (window.DEBUG) debugger
        ...
        protected * calculateLateEndDateConstraintIntervals () : ChronoIterator<ConstraintInterval[]> {
            // if (window.DEBUG) debugger
