...
export default class WidgetColumn extends Column {
     ...
     * @param {Grid.column.Column} event.column Rendered column
     * @param {Core.data.Model} event.record Rendered record
     * @private
     */
    renderer(event) {
        const
     ...
     * @param {Core.data.Model} event.record Rendered record
     */
    onBeforeWidgetSetValue(widget, event) {}
     ...
     * @param {Core.data.Model} event.record Rendered record
     */
    onAfterWidgetSetValue(widget, event) {}
