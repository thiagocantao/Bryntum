...
export default class Row extends Delayable(Base) {
    ...
    renderCell(cellElement, record, index, updatingSingleRow = true, height) {
        ...
        // Using new record for this row, consider it repurposed and inform Grid that cell is now visible
        // if (record.id !== oldId && col.reactiveRenderer) {
        //     const oldRecord = me.grid.store.getById(oldId);
        //     me.grid.cellBecameInvisible({ oldRecord : record, row : cellElementData.row, cell : cellElement });
        //     me.grid.cellBecameVisible({ record, row : cellElementData.row, cell : cellElement });
        // }

        // if (column.reactiveRenderer) {
        //     return null;
        // }
        ...
        const
            ...
            size         = { configuredHeight : height, height : null },
            rendererData = {
                cellElement,
                dataField,
                rowElement,
