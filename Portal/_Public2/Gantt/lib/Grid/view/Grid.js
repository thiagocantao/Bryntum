...
import '../feature/ContextMenu.js'; // TODO: 'contextMenu' is deprecated. Please see https://bryntum.com/docs/grid/#guides/upgrades/3.1.0.md for more information.
 ...
 * <h2>Features</h2>
 * To avoid the Grid core being bloated, its main features are implemented in separate Â´featureÂ´ classes. These can be turned on and off based
 ...
 * you want to use. Each feature has an Â´idÂ´ that you use as a key in the features object:
 *
 *      let grid = new Grid({
 *          appendTo : document.body,
 *
 ...
 *      });
 *
 * {@inlineexample feature/CellMenu.js}
 * {@endregion}
 * {@region Grouping}
