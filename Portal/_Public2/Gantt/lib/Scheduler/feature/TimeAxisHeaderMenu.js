 ...
 * |--------------------|-----------------------|--------|----------------------|--------------------|----------------------------------------------------------------------------------------------------|
 * | `eventsFilter`     | Filter tasks          | 100    | `EventFilter`        | true               | Shows a submenu to control events filtering                                                        |
 * | \>`nameFilter`     | By name               | 110    | `EventFilter`        | true               | Filters the event store records by `name` field using the input value                              |
 * | `zoomLevel`        | Zoom                  | 200    | `TimeAxisHeaderMenu` | true               | Shows a submenu to control the timeline zooming                                                    |
 * | \>`zoomSlider`     | -                     | 210    | `TimeAxisHeaderMenu` | true               | Changes current zoom level                                                                         |
 * | `dateRange`        | Date range            | 300    | `TimeAxisHeaderMenu` | true               | Shows a submenu to control the timeline range                                                      |
 * | \>`startDateField` | Start date            | 310    | `TimeAxisHeaderMenu` | true               | Sets start date fot the timeline                                                                   |
 * | \>`endDateField`   | End date              | 320    | `TimeAxisHeaderMenu` | true               | Sets end date fot the timeline                                                                     |
 * | \>`leftShiftBtn`   | <                     | 330    | `TimeAxisHeaderMenu` | true               | Shifts start and end dates backward                                                                |
 * | \>`todayBtn`       | Today                 | 340    | `TimeAxisHeaderMenu` | true               | Sets start date equal to the current day and end date equal to the next day after the current day. |
 * | \>`rightShiftBtn`  | \>                    | 350    | `TimeAxisHeaderMenu` | true               | Shifts start and end dates forward                                                                 |
 * | `currentTimeLine`  | Show current timeline | 400    | `TimeRanges`         | true               | When selected shows the current time line on the timeline                                          |
 *
...
export default class TimeAxisHeaderMenu extends HeaderMenu {
    ...
    onTodayBtnClick() {
        ...
        this.client.timeAxis.setTimeSpan(today, DateHelper.add(today, 1, 'day'));
        this.initDates();
    }
