...
export default class DragCreateBase extends InstancePlugin {
    ...
    initResizer(event, data) {
        ...
        me.resize = new ResizeHelper({
            ...
            dragThreshold : me.dragTolerance,
            grab          : {
                element : me.proxy,
                edge,
            ...
            scroller        : client.timeAxisSubGrid.scrollable, // Scroll in both directions
            listeners       : {
                resizing : 'onResizing',
                resize   : 'onResize',
                cancel   : 'onCancel',
