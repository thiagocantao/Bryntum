 ...
 *
 * <img src="../examples/basic/meta/thumb.classic-light.png" alt="Classic-Light theme" width="300" style="margin-right: .5rem">
 * <img src="../examples/basic/meta/thumb.classic.png" alt="Classic theme" width="300" style="margin-right: .5rem">
 * <img src="../examples/basic/meta/thumb.classic-dark.png" alt="Classic-Dark theme" width="300" style="margin-right: .5rem">
 * <img src="../examples/basic/meta/thumb.stockholm.png" alt="Stockholm theme" width="300" style="margin-right: .5rem">
 ...
 * To programatically convert an occurrence to be a single exception to its owner's sequence use:
 *
 * ```
 ...
 * ```
 *
 * That will cause that event to be inserted into the store as a concrete event defintion, firing
 * an `add` event as would be expected, and will add an `exceptionDate` to its owning recurring event.
 *
 ...
 * the `dateFormat` of the EventModel. The system-supplied default value for this is
 * `'YYYY-MM-DDTHH:mm:ssZ'`
 *
 * ### Convert an occurrence to a new recurring event sequence.
 * To programatically convert an occurrence to be the start of a new recurring sequence, use:
 *
 * ```
 * myOccurrence.beginBatch();
 ...
 * defintion, firing an `add` event as would be expected, and will terminate the previous
