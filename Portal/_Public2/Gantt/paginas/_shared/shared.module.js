import { WidgetHelper, AjaxHelper, DomHelper, IdHelper, Tooltip, Toast, BrowserHelper, StringHelper, LocaleManager, Localizable, DataGenerator, Fullscreen, Events, GlobalEvents, VersionHelper, EventHelper, Panel, ResizeHelper, Rectangle } from '../../build/gantt.module.js';
...
class CodeEditor extends Panel {
    ...
    updateDownloadLink() {
        ...
        downloadLink.href = `data:text/${this.filename.endsWith('.css') ? 'css' : 'javascript'};charset=utf-8,${escape(this.pre.innerText)}`;
    }
