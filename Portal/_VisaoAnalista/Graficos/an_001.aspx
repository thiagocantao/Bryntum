<%@ Page Language="C#" AutoEventWireup="true" CodeFile="an_001.aspx.cs" Inherits="_VisaoAnalista_Graficos_an_001" %>
                ...
                <HeaderTemplate>
                    <table style="width: 100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td align="left">
                                    <dxe:ASPxLabel ID="ASPxLabel1" runat="server" Text="Minhas Metas">
                                    </dxe:ASPxLabel>
                                </td>
                                <td align="right">
