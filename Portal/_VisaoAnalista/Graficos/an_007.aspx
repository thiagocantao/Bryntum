<%@ Page Language="C#" AutoEventWireup="true" CodeFile="an_007.aspx.cs" Inherits="_VisaoAnalista_Graficos_an_007" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function abreLancamentosFinanceiros(statusParam) {
            if (statusParam == "A")
                window.top.gotoURL('_Projetos/Administracao/LancamentosFinanceiros.aspx?Atrasados=S', '_top');
            else
                window.top.gotoURL('_Projetos/Administracao/LancamentosFinanceiros.aspx', '_top');
        }
