...
public partial class _VisaoAnalista_Graficos_an_007 : System.Web.UI.Page
{
    dados cDados;
    ...
    private void geraTabela()
    {
        ...
        if (cDados.DataSetOk(ds) && cDados.DataTableOk(ds.Tables[0]))
        {
            ...
            float tarefasTotal, tarefasAtrasadas, indicadoresTotal, indicadoresAtrasados, lancamentosFinanceirosTotal, lancamentosFinanceirosAtrasados, toDoList, toDoListAtrasadas;
            ...
            lancamentosFinanceirosTotal = float.Parse(dt.Rows[2]["Total"].ToString());
            lancamentosFinanceirosAtrasados = float.Parse(dt.Rows[2]["Atrasados"].ToString());
            ...
            constroiMensagemLancamentosFinanceiros(lancamentosFinanceirosTotal, lancamentosFinanceirosAtrasados);
        }
    }
    ...
    private void constroiMensagemLancamentosFinanceiros(float total, float atrasados)
    {
