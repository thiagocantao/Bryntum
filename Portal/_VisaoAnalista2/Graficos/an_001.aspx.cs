...
public partial class _VisaoAnalista2_Graficos_an_001 : System.Web.UI.Page
{
    dados cDados;
    ...
    public string grafico_titulo = "Processos Comigo";
    ...
    private void geraGrafico()
    {
        ...
        string nomeGrafico = @"/ArquivosTemporarios/ProcessosComigo_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        if(cDados.getInfoSistema("DsOperacional") != null)
            dt = ((DataSet)cDados.getInfoSistema("DsOperacional")).Tables[0];

        //função para gerar a estrutura xml para criação do gráfico de quantidade de projetos por entidade
        xml = cDados.getGraficosPainelAnalista2(dt, "", 9, "TipoContratacao", "&ProcessoComigo=S");
        ...
        nomeGrafico = "\\ArquivosTemporarios\\ProcessosComigoZOOM_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;

        //função para gerar a estrutura xml para criação do gráfico de quantidade de projetos por entidade
        xml = cDados.getGraficosPainelAnalista2(dt, "Processos Comigo", 15, "", "");
