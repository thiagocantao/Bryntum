...
public partial class _VisaoAnalista2_Graficos_an_005 : System.Web.UI.Page
{
    dados cDados;
    ...
    public string grafico_titulo = "Contratos";
    ...
    private void geraGrafico()
    {
        ...
        string nomeGrafico = @"/ArquivosTemporarios/Contratos_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        if (cDados.getInfoSistema("DsOperacional") != null)
            dt = ((DataSet)cDados.getInfoSistema("DsOperacional")).Tables[4];

        //função para gerar a estrutura xml para criação do gráfico de quantidade de projetos por entidade
        xml = cDados.getGraficosPainelAnalista2(dt, "", 9, "SituacaoAtualContrato", ""); //SituacaoAtualContrato
        ...
        nomeGrafico = "\\ArquivosTemporarios\\ContratosZOOM_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
                
        //função para gerar a estrutura xml para criação do gráfico de quantidade de projetos por entidade
        xml = cDados.getGraficosPainelAnalista2(dt, "Contratos", 15, "", "");
