<%@ Page Language="C#" MasterPageFile="~/novaCdis.master" AutoEventWireup="true" CodeFile="visaoCorporativa.aspx.cs" Inherits="_VisaoAnalista2_visaoCorporativa" Title="Portal da Estratégia" %>
                    ...
                    <tr style="height:26px">
                        <td valign="middle" style="padding-left: 10px">
                            <asp:Label ID="lblTituloTela" runat="server" EnableViewState="False" Font-Bold="True"
                                ...
                                Text="Meu Painel de Bordo Operacional"></asp:Label></td>
                        <td style="width: 5px">
                        </td>
                    </tr>
                </table>
