...
public partial class _VisaoEPC_Graficos_epc_001 : System.Web.UI.Page
{
    dados cDados;
    ...
    private void geraGrafico()
    {
        ...
        string nomeGrafico = @"/ArquivosTemporarios/EPC_001_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        DataTable dt = cDados.getContratoEPC(codigoContrato, 'S', periodicidade).Tables[0];
        ...
        nomeGrafico = "\\ArquivosTemporarios\\EPC_001ZOOM_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
