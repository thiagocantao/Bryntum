<%@ Page Language="C#" AutoEventWireup="true" CodeFile="epc_002.aspx.cs" Inherits="_VisaoEPC_Graficos_epc_002" %>
                    ...
                    <tbody>
                        <tr>
                            <td align="left" style="margin: 0px; width:55px">
                                ...
                                Width="280px" SelectedIndex="2">
                             </dxe:ASPxComboBox>
                        
                                </td>
                            <td align="right" style="margin: 0px; width:50px">
                                <img align="right" alt="Visualizar gráfico em modo ampliado" onclick="javascript:f_zoomGrafico('../zoom.aspx', '', 'Flashs/ScrollLine2D.swf', '<%=grafico_xmlzoom %>', '0')"
