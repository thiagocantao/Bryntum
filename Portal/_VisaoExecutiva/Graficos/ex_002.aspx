<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ex_002.aspx.cs" Inherits="_VisaoExecutiva_Graficos_ex_002" %>
...
<body style="margin:0px">
    ...
    <div style="text-align: center">
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="#FFFFFF"
            ...
            <HeaderTemplate>
                <table style="WIDTH: 100%" cellspacing="0" cellpadding="0"><TBODY><tr><td align=left><dxe:ASPxLabel id="ASPxLabel1" runat="server" Text="Projetos">
