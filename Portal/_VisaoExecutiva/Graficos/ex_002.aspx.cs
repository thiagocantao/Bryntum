...
public partial class _VisaoExecutiva_Graficos_ex_002 : System.Web.UI.Page
{
    dados cDados;
    ...
    private void geraGrafico()
    {
        ...
        string nomeGrafico = @"/ArquivosTemporarios/desempenhoEntidadeVC_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        xml = cDados.getGraficoDesempenhoProjetosExecutivo(ds.Tables[0], "", 9, permissaoLink, 1);
        ...
        //função para gerar a estrutura xml para criação do gráfico de quantidade de projetos por entidade
        xml = cDados.getGraficoDesempenhoProjetosExecutivo(ds.Tables[0], "Projetos", 15, false, 1);
