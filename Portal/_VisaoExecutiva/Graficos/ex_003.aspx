<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ex_003.aspx.cs" Inherits="_VisaoExecutiva_Graficos_ex_003" %>
                ...
                <table>
                    <tr>
                        <td align="left">
                            ...
                            &nbsp;</td>
                        <td align="right">
                            <img align="right" alt="Visualizar gráfico em modo ampliado" onclick="javascript:f_zoomBullets('../zoomBullets.aspx', 'Orçamento' ,'HBullet.swf', '<%=grafico1_xmlzoom %>', '', '', 'HBullet.swf', '<%=grafico3_xmlzoom %>')"
