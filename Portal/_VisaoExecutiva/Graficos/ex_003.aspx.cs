...
public partial class _VisaoExecutiva_Graficos_ex_003 : System.Web.UI.Page
{
    dados cDados;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataSet ds = cDados.getOrcamentoTrabalhoProjetos(int.Parse(cDados.getInfoSistema("IDUsuarioLogado").ToString()), int.Parse(cDados.getInfoSistema("CodigoEntidade").ToString()), -1, where);

        DataTable dt = ds.Tables[0];

        DataSet dsBullets = cDados.getCoresBulletsVCProjetos(int.Parse(cDados.getInfoSistema("IDUsuarioLogado").ToString()), int.Parse(cDados.getInfoSistema("CodigoEntidade").ToString()),-1, where);
    ...
    private void defineLarguraTela()
    {
        ...
        if (Request.QueryString["Altura"] != null && Request.QueryString["Largura"] != null)
        {
            ...
            ASPxRoundPanel1.ContentHeight = altura - 70;
            
            alturaGrafico = ((altura - 100) / 2).ToString();
        ...
        else
        {
            ...
            larguraGrafico = ((largura - 60) / 3).ToString();

            ASPxRoundPanel1.Width = ((largura - 60) / 3);
            ASPxRoundPanel1.ContentHeight = (altura - 310) / numeroGraficos;

            alturaGrafico = (((altura - 310) / 2) / numeroGraficos).ToString();            
        }        
    }
    ...
    public void geraGrafico1(DataTable dt, DataTable dtBullets)
    {
        ...
        nomeGrafico = "/ArquivosTemporarios/bulletCustosExecutivo_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        //cria uma variável com o nome e o caminho do XML do gráfico bullet de custo dos Projetos 
        nomeGrafico = "ArquivosTemporarios/bulletCustosExecutivoZoom_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
    ...
    public void geraGrafico3(DataTable dt, DataTable dtBullets)
    {
        ...
        //cria uma variável com o nome e o caminho do XML do gráfico bullet de custo dos Projetos 
        nomeGrafico = "/ArquivosTemporarios/bulletReceitasExecutivo_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        //cria uma variável com o nome e o caminho do XML do gráfico bullet de custo dos Projetos 
        nomeGrafico = "ArquivosTemporarios/bulletReceitasExecutivoZoom_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
