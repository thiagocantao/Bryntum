<%@ Page Language="C#" AutoEventWireup="true" CodeFile="visaoCorporativa_01.aspx.cs" Inherits="_VisaoExecutiva_Graficos_visaoCorporativa_01" %>
    ...
    <div>
        <table>
            <tr>
                ...
                <td valign="top" align="center" style="width: <%=larguraTela %>">
                    <iframe frameborder="0" height="<%=alturaTela %>" scrolling="no" src="<%=grafico2 %>"
                                    width="<%=larguraTela %>"></iframe>
                </td>
                <td valign="top" align="center" style="width: <%=larguraTela %>">
