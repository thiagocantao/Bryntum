...
public partial class _VisaoExecutiva_Graficos_visaoCorporativa_02 : System.Web.UI.Page
{
    dados cDados;

    public string larguraTela = "", alturaTela = "", larguraTabela = "", larguraTela2 = "", metadeAlturaTela = "", larguraGraficoBarras = "", alturaNumeros = "", alturaGrafico = "", larguraGrafico = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            grafico1 = dsParametro.Tables[0].Rows[0]["ex_grafico002"] + "" == "" ? grafico1 : dsParametro.Tables[0].Rows[0]["ex_grafico002"] + ".aspx?DivideLargura=N";
    ...
    private void defineLarguraTela()
    {
        ...
        larguraTela2 = (largura - ((largura) / 3)).ToString() + "px";
