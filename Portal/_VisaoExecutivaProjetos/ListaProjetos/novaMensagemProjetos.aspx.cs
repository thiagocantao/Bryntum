...
public partial class _VisaoExecutivaProjetos_ListaProjetos_novaMensagemProjetos : System.Web.UI.Page
{
    dados cDados;
    private int codigoProjeto = -1, codigoResponsavel = -1;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            iniciaisAcao = Request.QueryString["INI"].ToString();
        }
    ...
    protected void btnSalvar_Click(object sender, EventArgs e)
    {
        ...
        bool incluiu = cDados.incluiMensagemObjeto(idEntidadeLogada, codigoProjeto, idUsuarioLogado, "", txtMensagem.Text.Replace("'", ""), auxDt, true, "",listaUsuariosSelecionados, iniciaisAcao, ref msgErro);
        if (!incluiu)
        {
