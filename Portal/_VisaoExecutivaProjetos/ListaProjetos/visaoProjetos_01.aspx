<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="visaoProjetos_01.aspx.cs" Inherits="_VisaoExecutivaProjetos_ListaProjetos_visaoProjetos_01" %>
    ...
    <script type="text/javascript" language="javascript">
       var myObject = new Object();
        ...
        function abreMensagens(codigoProjeto, codigoResponsavel, nomeProjeto, iniciais, codigoUnidade)
        {
            ...
            if (iniciais == 'EN')
                codigoProjeto = codigoUnidade;

            window.top.showModal("../../Mensagens/EnvioMensagens.aspx?CR=" + codigoResponsavel + "&CO=" + codigoProjeto + "&TA=" + iniciais, "Nova Mensagem - " + nomeProjeto, 950, 480, "", myObject);
        ...
        function abreMensagensNovas(codigoMensagem, codigoProjeto) {
            novoCodigoMsg = codigoMensagem;
            codigoProjetoModal = codigoProjeto;
            window.top.showModal("../../Mensagens/MensagensPainelBordo.aspx?EsconderBotaoNovo=S&TA=PR&CO=" + codigoProjeto, 'Mensagens', 1010, 600, "", null);
        }

         function abreRiscosQuestoes(tipoTela, codigoProjeto, nomeProjeto) {
             window.top.gotoURL('_Projetos/DadosProjeto/indexResumoProjeto.aspx?IDProjeto=' + codigoProjeto + '&NomeProjeto=' + nomeProjeto + '&TI=' + tipoTela, '_top');
         }
    </script>
</head>
<body style="margin:0px">
	...
	{
		document.getElementById('frm2_' + e.group.name).src = 'pr_001.aspx?CP=' + e.group.name.substring(0, e.group.name.indexOf(&quot;_&quot;));
	}
}" />
