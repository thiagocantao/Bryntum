<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ie_002.aspx.cs" Inherits="_VisaoIntegrante_Graficos_ie_002" %>
...
<body class="body" style="margin:0px">
    ...
    <div style="text-align: center;">
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="#FFFFFF"
            CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" HeaderText="Desempenho" Width="210px" ImageFolder="~/App_Themes/PlasticBlue/{0}/">
