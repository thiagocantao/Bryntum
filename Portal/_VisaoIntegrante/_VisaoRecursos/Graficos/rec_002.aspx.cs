...
public partial class _VisaoAnalista_Graficos_an_002 : System.Web.UI.Page
{
    dados cDados;
    ...
    private void geraGrafico()
    {
        ...
        xml = cDados.getGraficoDesempenhoProjetosRecurso(ds.Tables[0], "", 9, permissaoLink, 1, int.Parse(cDados.getInfoSistema("IDUsuarioLogado").ToString()));
        ...
        //função para gerar a estrutura xml para criação do gráfico de quantidade de projetos por entidade
        xml = cDados.getGraficoDesempenhoProjetosRecurso(ds.Tables[0], "Meus Projetos", 15, false, 1, int.Parse(cDados.getInfoSistema("IDUsuarioLogado").ToString()));
