<%@ Page Language="C#" AutoEventWireup="true" CodeFile="numeros_003.aspx.cs" Inherits="_VisaoMaster_Graficos_numeros_003" %>
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%; display: none;">
                                    ...
                                    <tr>
                                        <td align="left" style="border-top: #c6c6c6 1px solid; padding-left: 8px; color: white;
                                            ...
                                            <asp:Label ID="lblTituloTotal5" runat="server" Font-Bold="False" 
                                                 ForeColor="#404040" Text="Sítio"></asp:Label>
                                            </span></strong>
                                        </td>
                                        <td align="right" 
                                            
                                            style="border-top: #c6c6c6 1px solid; padding-left: 8px; color: white;
                                            border-bottom: #c6c6c6 1px solid; height: 20px; background-color: #ebebeb; padding-right: 1px; width: 150px;">
                                            <strong><span>
                                            <asp:Label ID="lblTituloTotal6" runat="server" Font-Bold="False" 
                                                 ForeColor="#404040" 
                                                Text="Realizado (I0) - R$ Mil"></asp:Label>
                                            </span></strong>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td style="padding-left: 1px; padding-bottom: 1px; padding-top: 1px">
                                <span ID="spanContratos_T2" runat="server" 
