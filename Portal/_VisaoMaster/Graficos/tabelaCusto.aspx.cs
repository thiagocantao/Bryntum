...
public partial class _VisaoMaster_Graficos_tabelaCusto : System.Web.UI.Page
{
		#region Fields (3) 
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            gvDados.Settings.VerticalScrollableHeight = int.Parse(Request.QueryString["Altura"].ToString()) - 80;
        }
    }
		// Private Methods (1) 
    ...
    protected void ASPxGridViewExporter1_RenderBrick(object sender, DevExpress.Web.ASPxGridViewExportRenderingEventArgs e)
    {
		...
		#endregion Methods 
    protected void gvDados_CustomColumnSort(object sender, DevExpress.Web.CustomColumnSortEventArgs e)
    {
        // se estiver ordenando a coluna 'Mes' 
        if (e.Column.Name == "Conta")
        {
            object valor1 = e.Value1.ToString();
            object valor2 = e.Value2.ToString();
