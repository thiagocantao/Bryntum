<%@ Page Language="C#" AutoEventWireup="true" CodeFile="visaoCorporativa_02.aspx.cs" Inherits="_VisaoMaster_Graficos_visaoCorporativa_02" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.parent.urlAnterior = '4'
        window.parent.urlProximo = '6'

        window.parent.lblTitulo.SetText('Painel de Gerenciamento - Sítio Pimental');
        ...
        window.parent.verificaImagemEvolucaPimentalVisivel();
        window.parent.verificaLabelImagensVisivel();
        
        window.parent.iniciaisAssociacao = 'St_Pimental';
        window.parent.nomeSitio = 'Sítio Pimental';
            ...
            <tr>
                ...
                <td valign="top">
                    <table>
                        <tr>
                            <td align="center">
                    <iframe id="tdNumeros" frameborder="0" height="<%=alturaNumeros %>" scrolling="no" src="numeros_006.aspx?CR=St_Pimental"
                        width="100%"></iframe>
