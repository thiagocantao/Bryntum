<%@ Page Language="C#" AutoEventWireup="true" CodeFile="visaoCorporativa_03.aspx.cs" Inherits="_VisaoMaster_Graficos_visaoCorporativa_03" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.parent.urlAnterior = '5'
        window.parent.urlProximo = '7'

        window.parent.lblTitulo.SetText('Painel de Gerenciamento - Sítio Belo Monte');
        ...
        window.parent.verificaImagemEvolucaoBeloMonteVisivel();
        window.parent.verificaLabelImagensVisivel();
        
        window.parent.iniciaisAssociacao = 'St_BeloMonte';
        window.parent.nomeSitio = 'Sítio Belo Monte';
            ...
            <tr>
                ...
                <td valign="top">
                    <table>
                        <tr>
                            <td align="center">
                    <iframe id="tdNumeros" frameborder="0" height="<%=alturaNumeros %>" scrolling="no" src="numeros_006.aspx?CR=St_BeloMonte"
                        width="100%"></iframe>
