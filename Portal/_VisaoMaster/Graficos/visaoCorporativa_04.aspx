<%@ Page Language="C#" AutoEventWireup="true" CodeFile="visaoCorporativa_04.aspx.cs" Inherits="_VisaoMaster_Graficos_visaoCorporativa_04" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.parent.urlProximo = '8'

        window.parent.lblTitulo.SetText('Painel de Gerenciamento - Sítio Infraestrutura');
        ...
        window.parent.iniciaisAssociacao = 'Infraestrutura';
        window.parent.nomeSitio = 'Sítio Infraestrutura';
            ...
            <tr>
                ...
                <td valign="top">
                    <table>
                        <tr>
                            <td align="center">
                    <iframe id="tdNumeros" frameborder="0" height="<%=alturaNumeros %>" scrolling="no" src="numeros_006.aspx?CR=Infraestrutura"
                        width="100%"></iframe>
