...
public partial class _VisaoMaster_Graficos_visaoCorporativa_04 : System.Web.UI.Page
{
    dados cDados;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        grafico1 = "vm_001.aspx?Altura=" + alturaGrafico + "&Largura=" + larguraGrafico2 + "&CR=Infraestrutura&CA=" + codigoArea + "&NA=" + nomeArea;
        grafico2 = "vm_004.aspx?Altura=" + alturaGrafico + "&Largura=" + larguraGrafico + "&CR=Infraestrutura&CA=" + codigoArea + "&NA=" + nomeArea;
        grafico3 = "vm_006.aspx?Altura=" + alturaGrafico + "&Largura=" + larguraGrafico + "&CR=Infraestrutura&CA=" + codigoArea + "&NA=" + nomeArea;
