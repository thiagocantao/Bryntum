<%@ Page Language="C#" AutoEventWireup="true" CodeFile="visaoCorporativa_05.aspx.cs" Inherits="_VisaoMaster_Graficos_visaoCorporativa_05" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.parent.urlAnterior = '7'
        window.parent.urlProximo = '9'

        window.parent.lblTitulo.SetText('Painel de Gerenciamento - Sítio Canais de Derivação, Transposição e Enchimento');
        ...
        window.parent.iniciaisAssociacao = 'Cnl_Derivacao';
        window.parent.nomeSitio = 'Sítio Canais de Derivação, Transposição e Enchimento';

        window.parent.verificaImagemEscavacaoVisivel();
            ...
            <tr>
                ...
                <td valign="top">
                    <table>
                        <tr>
                            <td align="center">
                    <iframe id="tdNumeros" frameborder="0" height="<%=alturaNumeros %>" scrolling="no" src="numeros_006.aspx?CR=Cnl_Derivacao"
                        width="100%"></iframe>
