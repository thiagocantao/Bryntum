...
public partial class _VisaoMaster_Graficos_visaoCorporativa_05 : System.Web.UI.Page
{
    dados cDados;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        grafico1 = "vm_001.aspx?Altura=" + alturaGrafico + "&Largura=" + larguraGrafico2 + "&CR=Cnl_Derivacao&CA=" + codigoArea + "&NA=" + nomeArea;
        grafico2 = "vm_004.aspx?Altura=" + alturaGrafico + "&Largura=" + larguraGrafico + "&CR=Cnl_Derivacao&CA=" + codigoArea + "&NA=" + nomeArea;
        grafico3 = "vm_006.aspx?Altura=" + alturaGrafico + "&Largura=" + larguraGrafico + "&CR=Cnl_Derivacao&CA=" + codigoArea + "&NA=" + nomeArea;
