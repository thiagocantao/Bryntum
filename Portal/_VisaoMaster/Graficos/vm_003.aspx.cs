...
public partial class _VisaoMaster_Graficos_vm_003 : System.Web.UI.Page
{
    dados cDados;
    ...
    public string grafico1_titulo = "Desempenho Físico";
    ...
    private void carregaSpeedometro()
    {
        ...
        toolTip = string.Format(@"Objetivo/descrição - Apresentar o desempenho físico da UHE Belo Monte, referente à Área selecionada (Civil / Fornecimento e Montagem). O velocímetro sinaliza o desempenho em 3 níveis (verde, amarelo e vermelho). O ponteiro indica o realizado e a linha pontilhada o previsto.");

        string nomeGrafico = @"/ArquivosTemporarios/SpeedometroFisico_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        DataSet dsGrafico = cDados.getDesempenhoFisicoPainelGerenciamento(codigoReservado, codigoEntidade, int.Parse(codigoArea), "");
        ...
        grafico1_titulo = string.Format("Desempenho Físico até {0:MMM/yyyy}", dataParam);
