<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vm_006.aspx.cs" Inherits="_VisaoMaster_Graficos_vm_006" %>
...
<body style="margin:0px">
    ...
    <div style="text-align: center">
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="#FFFFFF"
            ...
            <HeaderTemplate>
                <table title="<%=toolTip %>" style="WIDTH: 100%" cellspacing="0" cellpadding="0"><TBODY><tr><td align=left><%=getTitulo() %></td><td align=right><IMG style="CURSOR: pointer" 
