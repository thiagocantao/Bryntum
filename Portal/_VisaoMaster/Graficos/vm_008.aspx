<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vm_008.aspx.cs" Inherits="_VisaoMaster_Graficos_vm_008" %>
...
<body style="margin:0px">
    ...
    <div style="text-align: center">
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="#FFFFFF"
            ...
            <HeaderTemplate>
                <table style="WIDTH: 100%" cellspacing="0" cellpadding="0"><TBODY><tr><td align=left><dxe:ASPxLabel id="ASPxLabel1" runat="server" Text="Mão de Obra e Equipamentos">
