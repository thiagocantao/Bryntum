<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vm_011.aspx.cs" Inherits="_VisaoMaster_Graficos_vm_011" %>
            ...
            <tr>
                <td align="left" valign="top">
                    <dxe:ASPxLabel ID="ASPxLabel1" runat="server" Font-Italic="True" 
                        ...
                        Text="Fonte: Gerência de Informações Gerenciais" EncodeHtml="False">
                    </dxe:ASPxLabel>
                </td>
            </tr>
        </table>                   
