<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vm_012.aspx.cs" Inherits="_VisaoMaster_Graficos_vm_012" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function abreGrafico(cs, ca, titulo) {
            window.top.showModal(window.top.pcModal.cp_Path + '_VisaoMaster/Graficos/vm_013.aspx?CS=' + cs + '&CA=' + ca, titulo, 1000, 500, '', null);
        }
    </script>
    <style type="text/css">
        .style1
...
<body style="margin:0px">
    ...
    <div style="text-align: center">
        ...
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="#FFFFFF"
            ...
            <tr>
                <td align="left" valign="top">
                    <dxe:ASPxLabel ID="ASPxLabel1" runat="server" Font-Italic="True" 
                        ...
                        Text="Fonte: Medições dos Contratos">
                    </dxe:ASPxLabel>
                </td>
            </tr>
        </table> 
            ...
            <HeaderTemplate>
                <table title="<%=toolTip %>" style="WIDTH: 100%" cellspacing="0" cellpadding="0"><TBODY><tr><td align=left><%=grafico_titulo %></td><td align=right><IMG style="CURSOR: pointer" 
