<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vm_016.aspx.cs" Inherits="_VisaoMaster_Graficos_vm_016" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function abreTabela(codigoArea) {
            largura = screen.width - 60;
            altura = screen.height - 260;
            var titulo = 'Itens do Desembolso Financeiro';
            window.top.showModal(window.top.pcModal.cp_Path + '_VisaoMaster/Graficos/tabelaPrevisaoDesembolso.aspx?Altura=' + (altura - 100) + '&CA=' + codigoArea, titulo, largura, altura, '', null);
        }
    </script>
    <style type="text/css">
        .style1
        ...
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="#FFFFFF"
            ...
            <tr>
                <td align="left" valign="top">
                    <dxe:ASPxLabel ID="ASPxLabel1" runat="server" Font-Italic="True" 
                        ...
                        Text="Fonte: Superintendência Financeira">
                    </dxe:ASPxLabel>
                </td>
            </tr>
        </table> 
            ...
            <HeaderTemplate>
                <table style="WIDTH: 100%" cellspacing="0" cellpadding="0"><TBODY><tr><td align=left><%=tituloPainel %></td><td align=right><IMG style="CURSOR: pointer" 
                    onclick="javascript:f_zoomGrafico('../zoom.aspx', '', 'Flashs/MSCombiDY2D.swf', '<%=grafico_xmlzoom %>', '0')" 
