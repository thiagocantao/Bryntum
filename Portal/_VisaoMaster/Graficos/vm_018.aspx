<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vm_018.aspx.cs" Inherits="_VisaoMaster_Graficos_vm_018" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function abreCusto(codigoArea, nomeArea) {
            ...
            altura = screen.height - 200;
            var titulo = 'Acompanhamento do Orçamento' + (nomeArea != '' ? (' - ' + nomeArea) : '');

            popup = window.open(window.top.pcModal.cp_Path + '_VisaoMaster/PlanilhaOrcamentoAprovadoCA.aspx?Popup=S', "frameOrcamento", "menubar=no, scrollbars=1");
            if (popup != null)
                popup.focus();
...
<body style="margin:0px">
    ...
    <div style="text-align: center">
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="#FFFFFF" CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css"
            ...
            Width="210px" EnableViewState="False">
