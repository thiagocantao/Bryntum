<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vne_003.aspx.cs" Inherits="_VisaoNE_VisaoCorporativa_vne_003" %>
...
<body style="margin:0px">
    ...
    <div style="text-align: center">
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="White" CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css"
            ...
            <HeaderTemplate>
                <table>
                    <tbody>
                        <tr>
                             <td align="left">
                                <%# "Evolução Quantitativa das Obras do Entorno"%>
                                </td>                            
                            <td align="right">
                                <img align="right" alt="Visualizar gráfico em modo ampliado" onclick="javascript:f_zoomGrafico('../zoom.aspx', '', 'Flashs/StackedColumn2D.swf', '<%=grafico_xmlzoom %>', '0')"
