<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vne_004.aspx.cs" Inherits="_VisaoNE_VisaoCorporativa_vne_004" %>
            ...
            <HeaderTemplate>
                <table>
                    <tbody>
                        <tr>
                            <td align="left">
                                <%# "Evolução Financeira das Obras Contratadas"%>
                                </td>
                            <td align="right">
                                <img align="right" alt="Visualizar gráfico em modo ampliado" onclick="javascript:f_zoomGrafico('../zoom.aspx', '', 'Flashs/MSBar2D.swf', '<%=grafico_xmlzoom %>', '0')"
