...
public partial class _VisaoNE_VisaoExecutiva_visaoCorporativa : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            cDados.VerificaAcessoTela(this, codigoUsuarioResponsavel, codigoEntidade, codigoEntidade, "NULL", "EN", 0, "NULL", "EN_AcsPnlExeObr");
        ...
        if (!IsPostBack)
        {
            ...
            Master.verificaAcaoFavoritos(true, lblTituloTela.Text, "PNL_NEEX", "ENT", -1, Resources.traducao.adicionar_aos_favoritos);
        }
