...
public partial class _VisaoNE_VisaoExecutiva_vne_002 : System.Web.UI.Page
{
    dados cDados;
    ...
    private void defineLarguraTela()
    {
        ...
        larguraGrafico = ((largura - 325) / 2).ToString();
    ...
    private void geraGrafico()
    {
        ...
        string nomeGrafico = @"/ArquivosTemporarios/EX_desempenhoFinanceiroAnoVNE_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;
        ...
        DataTable dt = cDados.getContratosPorTipoContrato(codigoEntidade, int.Parse(cDados.getInfoSistema("CodigoCarteira").ToString()), int.Parse(cDados.getInfoSistema("IDUsuarioLogado").ToString()), anoParam, "").Tables[0];
        //função para gerar a estrutura xml para criação do gráfico
        xml = cDados.getGraficoContratosPorValoresTipoContrato(dt, "", 9, false);
        ...
        nomeGrafico = "\\ArquivosTemporarios\\EX_desempenhoFinanceiroAnoVNEZOOM_" + cDados.getInfoSistema("IDUsuarioLogado").ToString() + "_" + dataHora;

        xml = cDados.getGraficoContratosPorValoresTipoContrato(dt, "Contratos de Obra por Tipo - " + anoParam, 15, false);
    ...
    {
        return "Contratos de Obra por Tipo";
    }
}
