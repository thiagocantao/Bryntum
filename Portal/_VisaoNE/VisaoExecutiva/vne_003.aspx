<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vne_003.aspx.cs" Inherits="_VisaoNE_VisaoExecutiva_vne_003" %>
...
<body style="margin:0px">
    ...
    <div style="text-align: center">
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" BackColor="White"
            CssPostfix="PlasticBlue" HeaderText="Desempenho" ImageFolder="~/App_Themes/MaterialCompact/{0}/"
            Width="210px">
