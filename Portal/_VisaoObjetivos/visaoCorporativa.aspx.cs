...
public partial class _VisaoObjetivos_visaoCorporativa : System.Web.UI.Page
{
    dados cDados;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            Master.verificaAcaoFavoritos(true, lblTituloTela.Text, "PNL_OE", "ENT", -1, "Adicionar Painel aos Favoritos");
        }
    }
