...
public partial class administracao_CadastroRamosAtividades : System.Web.UI.Page
{
    ...
    private void HeaderOnTela()
    {
        ...
        Header.Controls.Add(cDados.getLiteral(@"<script type=""text/javascript"" language=""javascript"" src=""../scripts/AprovacaoMedicao.js""></script>"));
        Header.Controls.Add(cDados.getLiteral(@"<script type=""text/javascript"" language=""javascript"" src=""../scripts/_Strings.js""></script>"));
        Header.Controls.Add(cDados.getLiteral(@"<script type=""text/javascript"" language=""javascript"" src=""../scripts/barraNavegacao.js""></script>"));
        this.TH(this.TS("barraNavegacao", "_Strings", "AprovacaoMedicao"));
    ...
    protected void pnCallback_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
    {
        ...
        if (e.Parameter == "A")
        {
            mensagemErro_Persistencia = persisteEdicaoRegistro("A");
        }
        if (e.Parameter == "R")
        {
            mensagemErro_Persistencia = persisteEdicaoRegistro("A");
    ...
    private string persisteEdicaoRegistro(string statusAprovacao) // Método responsável pela Atualização do registro
    {
        int codigoRamoAtividade = int.Parse(getChavePrimaria());

        string comentariosAprovacao = mmObservacoes.Text;

        bool result = cDados.atualizaTipoRamoAtividade(codigoRamoAtividade, comentariosAprovacao);
