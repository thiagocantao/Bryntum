<%@ Page Language="C#" MasterPageFile="~/novaCdis.master" AutoEventWireup="true" CodeFile="CadastroCriteriosMedicao.aspx.cs" Inherits="administracao_CadastroCriterioMedicao" %>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="middle" style="padding-left: 10px">
                            <dxe:ASPxLabel id="lblTituloTela" runat="server" Font-Bold="True"
                                Text="Cadastro de Critérios de Medição de Contratos" 
...
<dxp:PanelContent runat="server"><dxhf:ASPxHiddenField runat="server" ClientInstanceName="hfGeral" ID="hfGeral"></dxhf:ASPxHiddenField>
 <dxwgv:ASPxGridView runat="server" ClientInstanceName="gvDados" 
        KeyFieldName="CodigoCriterioMedicaoContrato" AutoGenerateColumns="False" Width="100%" 
         ID="gvDados" 
...
<dxwgv:GridViewDataTextColumn FieldName="DescricaoCriterioMedicaoContrato" Name="DescricaoCriterioMedicaoContrato" 
        Caption="Critério de Medição" VisibleIndex="2">
...
<dxpc:PopupControlContentControl runat="server">
    <table>
        ...
        <tr>
            <td>
                <dxe:ASPxTextBox ID="txtCriterioMedicao" runat="server" ClientInstanceName="txtCriterioMedicao"
...
<ClientSideEvents EndCallback="function(s, e) 
{
	...
	if(&quot;Incluir&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(&quot;Critério de medição incluído com sucesso!&quot;);
    else if(&quot;Editar&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(&quot;Critério de medição alterado com sucesso!&quot;);
    else if(&quot;Excluir&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(&quot;Critério de medição excluído com sucesso!&quot;);
}"></ClientSideEvents>
