<%@ Page Language="C#" MasterPageFile="~/novaCdis.master" AutoEventWireup="true" CodeFile="CadastroFontesContratacao.aspx.cs" Inherits="administracao_CadastroFontesContratacao" %>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="middle" style="padding-left: 10px">
                            <dxe:ASPxLabel ID="lblTituloTela" runat="server" Font-Bold="True"
                                Text="Cadastro de Tipos de Fontes de Contratação"
                    ...
                    <PanelCollection>
                        <dxp:PanelContent runat="server">
                            ...
                            <dxwgv:ASPxGridView runat="server" ClientInstanceName="gvDados"
                                KeyFieldName="CodigoFonteRecursosFinanceiros" AutoGenerateColumns="False" Width="100%"
                                ID="gvDados"
...
"></ClientSideEvents>
                                <Columns>
                                    ...
                                    <dxwgv:GridViewDataTextColumn FieldName="NomeFonte" Name="NomeFonte"
                                        Caption="Tipo de Fonte de Contratação" VisibleIndex="2">
                                            ...
                                            <tr>
                                                <td>
                                                    <dxe:ASPxLabel ID="ASPxLabel1" runat="server"
                                                        Text="Tipo de Fonte de Contratação:">
                                                    </dxe:ASPxLabel>
                                                </td>
                                            </tr>
                                            <tr>
                    ...
                    <ClientSideEvents EndCallback="function(s, e) 
{
	...
	if(&quot;Incluir&quot; == s.cp_OperacaoOk)
		window.top.mostraMensagem(&quot;Fonte de contratação incluída com sucesso!&quot;, 'sucesso', false, false, null);
    else if(&quot;Editar&quot; == s.cp_OperacaoOk)
		window.top.mostraMensagem(&quot;Fonte de contratação alterada com sucesso!&quot;, 'sucesso', false, false, null);
    else if(&quot;Excluir&quot; == s.cp_OperacaoOk)
		window.top.mostraMensagem(&quot;Fonte de contratação excluída com sucesso!&quot;, 'sucesso', false, false, null);
}"></ClientSideEvents>
