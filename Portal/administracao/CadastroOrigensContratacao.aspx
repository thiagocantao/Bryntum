<%@ Page Language="C#" MasterPageFile="~/novaCdis.master" AutoEventWireup="true" CodeFile="CadastroOrigensContratacao.aspx.cs" Inherits="administracao_CadastroSegmentos" %>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="middle" style="padding-left: 10px">
                            <dxe:ASPxLabel ID="lblTituloTela" runat="server" Font-Bold="True"
                                Text="Cadastro de Origens de Contratação">
                            </dxe:ASPxLabel>
                        </td>
                    </tr>
                </table>
                    ...
                    <PanelCollection>
                        <dxp:PanelContent runat="server">
                            ...
                            <dxwgv:ASPxGridView runat="server" ClientInstanceName="gvDados"
                                KeyFieldName="CodigoOrigemObra" AutoGenerateColumns="False" Width="100%"
                                ID="gvDados"
...
"></ClientSideEvents>
                                <Columns>
                                    ...
                                    <dxwgv:GridViewDataTextColumn FieldName="DescricaoOrigemObra" Name="DescricaoOrigemObra"
                                        Caption="Origem de Contratação" VisibleIndex="2">
                    ...
                    <ClientSideEvents EndCallback="function(s, e) 
{
	...
	if(&quot;Incluir&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(&quot;Origem de Contratacão incluída com sucesso!&quot;);
    else if(&quot;Editar&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(&quot;Origem de Contratacão alterada com sucesso!&quot;);
    else if(&quot;Excluir&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(&quot;Origem de Contratacão excluída com sucesso!&quot;);
}"></ClientSideEvents>
