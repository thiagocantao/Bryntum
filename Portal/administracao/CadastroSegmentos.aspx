<%@ Page Language="C#" MasterPageFile="~/novaCdis.master" AutoEventWireup="true" CodeFile="CadastroSegmentos.aspx.cs" Inherits="administracao_CadastroSegmentos" %>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="middle" style="padding-left: 10px">
                            <dxe:ASPxLabel ID="lblTituloTela" runat="server" Font-Bold="True"
                                Text="Cadastro de Tipos de Segmentos">
                            </dxe:ASPxLabel>
                        </td>
                    </tr>
                </table>
                    ...
                    <PanelCollection>
                        <dxp:PanelContent runat="server">
                            ...
                            <dxwgv:ASPxGridView runat="server" ClientInstanceName="gvDados"
                                KeyFieldName="CodigoSegmentoObra" AutoGenerateColumns="False" Width="100%"
                                ID="gvDados"
...
"></ClientSideEvents>
                                <Columns>
                                    ...
                                    <dxwgv:GridViewDataTextColumn FieldName="DescricaoSegmentoObra" Name="DescricaoSegmentoObra"
                                        Caption="Tipo de Segmento" VisibleIndex="2">
                    ...
                    <ClientSideEvents EndCallback="function(s, e) 
{
	...
	if(&quot;Incluir&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(&quot;Segmento incluído com sucesso!&quot;);
    else if(&quot;Editar&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(&quot;Segmento alterado com sucesso!&quot;);
    else if(&quot;Excluir&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(&quot;Segmento excluído com sucesso!&quot;);
}"></ClientSideEvents>
