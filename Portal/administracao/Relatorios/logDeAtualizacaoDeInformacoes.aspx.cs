...
public partial class administracao_Relatorios_logDeAtualizacaoDeInformacoes : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            cDados.VerificaAcessoTela(this, codigoUsuarioLogado, codigoEntidade, codigoEntidade, "null", "EN", 0, "null", "EN_CnsLogAlt");
        }
        ...
        if(!Page.IsPostBack && !Page.IsCallback)
        {
            ...
            txtTermino.Text = DateTime.Now.AddDays(15).ToString("dd/MM/yyyy");
        }
    ...
    private void defineAlturaTela()
    {
        ...
        larguraTabela = logAtualizacaoDeInformacoes.Width.ToString();
        logAtualizacaoDeInformacoes.Settings.VerticalScrollableHeight = alturaPrincipal - 315;
        ...
        using (MemoryStream stream = new MemoryStream())
        {
            ...
            else
            {
                string script = @"<script type='text/Javascript' language='Javascript'>
                                    window.top.mostraMensagem(traducao.logDeAtualizacaoDeInformacoes_erro_ao_exportar_os_dados__verifique_se_n_o_foi_ultrapassado_o_n_mero_m_ximo_de_256_colunas_, 'erro', true, false, null);                                   
                                 </script>";
    ...
    private void populaGrid()
    {
        ...
        DataSet ds = cDados.getRelLogAtualizacaoInformacoes(codigoUsuarioLogado, codigoEntidade, txtInicio.Text, txtTermino.Text);
        if (cDados.DataSetOk(ds))
        {
            logAtualizacaoDeInformacoes.DataSource = ds.Tables[0];
            logAtualizacaoDeInformacoes.DataBind();
        }
    ...
    protected void logAtualizacaoDeInformacoes_AutoFilterCellEditorInitialize(object sender, DevExpress.Web.ASPxGridViewEditorEventArgs e)
    {
