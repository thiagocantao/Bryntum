<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_crud_caminhoCondicional.en-US.ascx.cs" Inherits="administracao_UC_Workflow_uc_crud_caminhoCondicional_en_us" %>
...
<dx:ASPxPopupControl ID="pcDvCaminhoCondicional" runat="server" Width="700px" ClientInstanceName="pcDvCaminhoCondicional" AllowDragging="True" CloseAction="CloseButton" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" HeaderText="Conditional Ways">
    <ContentCollection>
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td rowspan="2" style="width: 120px; vertical-align: bottom;">
                                    <dx:ASPxButton ID="btnConfirmarEtapa" runat="server" ClientInstanceName="btnConfirmarEtapa" AutoPostBack="false" Text="Confirm step" >
                                ...
                                <td rowspan="2" style="width: 90px; vertical-align: bottom;">
                                    <dx:ASPxButton ID="btnCancelarConfirmacao" runat="server" ClientInstanceName="btnCancelarConfirmacao" Text="Cancel" Width="90px" >
                                        <ClientSideEvents Click="function(s, e) {
            ...
            <dxcp:ASPxPanel ID="dvGridCondicoes" ClientInstanceName="dvGridCondicoes" runat="server" Width="100%" ClientIDMode="Static">
                <PanelCollection>
                    <dxcp:PanelContent runat="server">
                        <table style="width: 100%">
                            <tr>
                                <td style="width: 250px">Origin Step:</td>
                                <td>Option:</td>
                                <td style="width: 200px">Alternative step way:</td>
                            </tr>
                            <tr>
                                <td>
                        ...
                        <dxwgv:ASPxGridView runat="server" ClientInstanceName="gv_Condicoes" KeyFieldName="CodigoExpressao"
                            ...
                            <Columns>
                                <dxwgv:GridViewCommandColumn ButtonRenderMode="Image" Caption="Action" VisibleIndex="0"
                                    Width="80px">
                                    <CustomButtons>
                                ...
                                <dxtv:GridViewDataTextColumn Caption="Conditional Expression" FieldName="ExpressaoExtenso" Name="colExpressaoExtenso" VisibleIndex="2">
                                    <PropertiesTextEdit Width="150px">
                                    </PropertiesTextEdit>
                                </dxtv:GridViewDataTextColumn>
                                <dxtv:GridViewDataTextColumn Caption="Destination Step" FieldName="NomeEtapaDestino" Name="colNomeEtapaDestino" VisibleIndex="3" Width="200px">
                            ...
                            <SettingsText PopupEditFormCaption="People with step access" EmptyDataRow="there is no registered access profile" Title="Conditions"></SettingsText>
                        ...
                        <div id="dvComandosEncerrar">
                            <table style="width: 100%">
                                ...
                                {
                                    window.top.mostraMensagem('Enter the the option name.', 'atencao', true, false, null);
                                    return;
                                }
                                else if (cmbEtapaDestinoPadrao.GetText()=='')
                                {
                                    window.top.mostraMensagem('Enter the name of the alternative path step.', 'atencao', true, false, null);
                                    return;
                                }
                                else if (arrayRegistrosGridExpressoes.length == 0)
                                {
                                    window.top.mostraMensagem('Include at least one condition that directs the flow to a different alternate path step:  (' + cmbEtapaDestinoPadrao.GetText() + ').', 'atencao', true, false, null);
                                    return;
                                }
                                ...
                                if (salvaCaminhoCondicional())
                                    ...
                                    <td style="width: 90px">
                                        <dx:ASPxButton ID="btnCancelar" runat="server" Text="Cancel" Width="90px"  ClientInstanceName="btnCancelar" AutoPostBack="False">
                                            <ClientSideEvents Click="function(s, e) {
                                                pcDvCaminhoCondicional.Hide();
}" />
                                        </dx:ASPxButton>
...
<dx:ASPxPopupControl ID="pcDesignerCondicoes" runat="server" Width="700px" ClientInstanceName="pcDesignerCondicoes" AllowDragging="True" CloseAction="CloseButton" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" HeaderText="Conditional way expression">
    <ContentCollection>
        <dx:PopupControlContentControl runat="server">
	...
	incluiCampoEditorCondicao(s.GetSelectedItem().value, s.GetSelectedItem().text, 'CAMPO');
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td style="width: 90px">
                        <dxcp:ASPxButton ID="btnSalvarCondicao" runat="server" Text="Save" Width="90px"  ClientInstanceName="btnCancelarCondicao" AutoPostBack="False">
                            <ClientSideEvents Click="function(s, e) {
                                        // se não selecionou a etapa, sai sem fazer nada
                                        if (cmbEtapaDestinoDvCaminhoCondicional.GetSelectedIndex() == -1)
                                        {
                                            window.top.mostraMensagem('Select the destination step.', 'atencao', true, false, null);
                                            return false;
                                        }

                                        if (!validaExpressaoCondicional())
                                            window.top.mostraMensagem('Conditional expression is not valid!', 'atencao', true, false, null);
                                        else
                    ...
                    <td style="width: 90px">
                        <dxcp:ASPxButton ID="btnCancelarCondicao" runat="server" Text="Cancel" Width="90px"  ClientInstanceName="btnCancelarCondicao" AutoPostBack="False">
                            <ClientSideEvents Click="function(s, e) {
...
<%--<script src="../../scripts/uc_crud_caminhoCondicional.js"></script>--%>
