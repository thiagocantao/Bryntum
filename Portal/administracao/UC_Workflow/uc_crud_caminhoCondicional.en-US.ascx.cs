...
public partial class administracao_UC_Workflow_uc_crud_caminhoCondicional_en_us : System.Web.UI.UserControl
{
    dados cDados;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        gv_Condicoes.SettingsText.Title = @"<table cellpadding=""0"" cellspacing=""0"" style=""width: 100%""><tr><td style=""width: 50px"">
                                            <img style=""cursor: pointer"" onclick=""preparaTelaParaNovaCondicao();"" src=""../imagens/botoes/incluirReg02.png"" alt=""Add New Condition""/>                                               
                                            </td><td align=""center"">Conditions</td><td style=""width: 50px""></td></tr></table>";
    }
