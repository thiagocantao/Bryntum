<%@ Page Language="C#" AutoEventWireup="true" CodeFile="auditoria_Atualizacao.aspx.cs" Inherits="administracao_auditoria" %>
    ...
    <tr>
        <td align="center">
            <dxm:ASPxMenu ID="menu" runat="server" BackColor="Transparent" 
                ...
                <dxwgv:GridViewDataTextColumn FieldName="NovoValor" VisibleIndex="3" 
                    Caption="Novo Valor">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn FieldName="IndicaAlterado" Visible="False" 
                    VisibleIndex="4">
                </dxwgv:GridViewDataTextColumn>
            </Columns>
            <SettingsPager Mode="ShowAllRecords">
            </SettingsPager>
            <Settings VerticalScrollBarMode="Visible" VerticalScrollableHeight="210" 
                ShowFooter="True" />
            ...
            <Templates>
                <FooterRow>
                    <table cellspacing="0" cellpadding="0">
                        <tr>
                            <td style="border: 1px solid #808080; width: 10px; background-color: #FF0000">
                                &nbsp;</td>
                            <td style="padding-left: 3px; padding-right: 10px">
                                <dxe:ASPxLabel ID="ASPxLabel6" runat="server" 
                                    Font-Size="7pt" Text="Campos alterados">
                                </dxe:ASPxLabel>
                            </td>
                        </tr>
                    </table>
...
<Title Font-Bold="True" ></Title>
        ...
        <tr>
            <td class="style2">
                &nbsp;</td>
            <td align="right">
                                <dxe:ASPxButton ID="btnCancelar" runat="server" CssClass="btn_inicialMaiuscula"
