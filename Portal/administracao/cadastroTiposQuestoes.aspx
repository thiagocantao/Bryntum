<%@ Page Title="" Language="C#" MasterPageFile="~/novaCdis.master" AutoEventWireup="true" CodeFile="cadastroTiposQuestoes.aspx.cs" Inherits="administracao_cadastroTiposQuestoes" %>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="middle" style="padding-left: 10px">
                            <dxe:ASPxLabel ID="lblTituloTela" runat="server" Font-Bold="True"
                                Text="Cadastro de Tipos de Questões">
                            </dxe:ASPxLabel>
                        </td>
                    </tr>
                </table>
                ...
                <dxcp:ASPxCallbackPanel ID="pnCallback" runat="server" ClientInstanceName="pnCallback"
                    ...
                    <PanelCollection>
                        <dxp:PanelContent ID="PanelContent1" runat="server">
                            ...
                            <dxwgv:ASPxGridView runat="server" ClientInstanceName="gvDados" KeyFieldName="CodigoTipoRiscoQuestao"
...
"></ClientSideEvents>
                                <Columns>
                                    ...
                                    <dxwgv:GridViewDataTextColumn FieldName="CodigoTipoRiscoQuestao" Caption="CodigoTipoRiscoQuestao"
                                        VisibleIndex="2" Visible="False">
                                        <Settings AllowAutoFilter="False" />
                                    </dxwgv:GridViewDataTextColumn>
                                    <dxwgv:GridViewDataTextColumn Caption="Descrição"
                                        FieldName="DescricaoTipoRiscoQuestao" ShowInCustomizationForm="True"
                                        VisibleIndex="3">
                                        <Settings AllowAutoFilter="True" AutoFilterCondition="Contains" />
                                    </dxwgv:GridViewDataTextColumn>
                                    <dxwgv:GridViewDataTextColumn Caption="IndicaControladoSistema"
                                        FieldName="IndicaControladoSistema" ShowInCustomizationForm="True"
                                        VisibleIndex="4" Visible="False">
                                        <Settings AllowAutoFilter="False" />
                                    </dxwgv:GridViewDataTextColumn>
                                    <dxwgv:GridViewDataTextColumn Caption="IndicaRiscoQuestao"
                                        FieldName="IndicaRiscoQuestao" ShowInCustomizationForm="True"
                                ...
                                <Templates>
                                    <FooterRow>
                                        <table class="grid-legendas" cellpadding="0" cellspacing="0" style="width: 100%;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="grid-legendas-label grid-legendas-label-controlado-sistema">
                                                        <span>
                                                            <asp:Literal runat="server" Text="<%$ Resources:traducao, cadastroTiposQuestoes_controlados_pelo_sistema %>" /></span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <dxpc:ASPxPopupControl runat="server" ClientInstanceName="pcDados" CloseAction="None"
                                ...
                                ShowCloseButton="False" Width="485px"
                                ID="pcDados">
                                <ContentStyle>
                                            ...
                                            <tr>
                                                <td>
                                                    <table width="100%">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <dxe:ASPxTextBox ID="txtTipoDeQuestao" runat="server" ClientInstanceName="txtTipoDeQuestao"
                    ...
                    <ClientSideEvents EndCallback="function(s, e) 
{
	...
	if(&quot;Incluir&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(traducao.cadastroTiposQuestoes_tipo_de_quest_o_inclu_da_com_sucesso_);
    else if(&quot;Editar&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(traducao.cadastroTiposQuestoes_tipo_de_quest_o_alterada_com_sucesso_);
    else if(&quot;Excluir&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(traducao.cadastroTiposQuestoes_tipo_de_quest_o_exclu_da_com_sucesso_);
}"></ClientSideEvents>
