<%@ Page Title="" Language="C#" MasterPageFile="~/novaCdis.master" AutoEventWireup="true" CodeFile="dotacoesOrcamentarias.aspx.cs" Inherits="administracao_dotacoesOrcamentarias" %>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="middle" style="padding-left: 10px">
                            <dxe:ASPxLabel id="lblTituloTela" runat="server" Font-Bold="True"
                                Text="Cadastro de Dotações Orçamentárias">
                            </dxe:ASPxLabel>
                        </td>
                    </tr>
                </table>
    ...
    <table>
        ...
        <tr>
            <td>
                &nbsp;</td>
            <td>
                <dxe:ASPxCheckBox ID="ckbExcluidas" runat="server" AutoPostBack="True" 
                    ClientInstanceName="ckbExcluidas"  
                    Text="Trazer somente dotações excluídas">
                </dxe:ASPxCheckBox>
            </td>
            <td>
                &nbsp;</td>
        ...
        KeyFieldName="Dotacao;CodigoEntidade" AutoGenerateColumns="False" Width="100%" 
         ID="gvDados" 
...
}" CustomButtonClick="function(s, e) 
{
     ...
     {
        OnGridFocusedRowChanged1(s,true); 
     }
        ...
        <td align="center">
            <dxm:ASPxMenu ID="menu" runat="server" BackColor="Transparent" 
                ...
                <Border BorderStyle="None" />
                                    ...
                                    <dxwgv:GridViewDataTextColumn FieldName="Dotacao" Name="NomeFonte" 
        Caption="Dotação" VisibleIndex="1">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dxwgv:GridViewDataTextColumn>
                                    <dxwgv:GridViewDataTextColumn FieldName="CodigoEntidade" 
                            ...
                            <dxpc:ASPxPopupControl runat="server" ClientInstanceName="pcDados" 
                                ...
                                PopupVerticalAlign="WindowCenter" ShowCloseButton="False" Width="350px" 
                                 ID="pcDados">
                                <ContentStyle>
                    ...
                    Text="Dotação:">
                     ...
                     MaxLength="60" Width="100%" style="margin-bottom: 0px">
                                                        <ClientSideEvents KeyUp="function(s, e) {
        var descricao = s.GetValue();
        hfGeral.Set(&quot;txtDescricao&quot;, descricao);
}" />
                                                        <MaskSettings Mask="9999'.'9999'.'99'.'999'.'999'.'9999'.'9999'.'999999'.'99'.'99'.'99" 
                                                            ShowHints="True" IncludeLiterals="All" />
                                            ...
                                            <tr>
                                                <td style="height: 15px;width:100%" align="right" >
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" style="width:100%;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="WIDTH: 70px" align="center" rowspan="3">
                                                        <dxe:ASPxImage runat="server" ImageUrl="~/imagens/Workflow/salvarBanco.png" ImageAlign="TextTop" ClientInstanceName="imgSalvar" ID="imgSalvar">
                                                        </dxe:ASPxImage>
                                                    </td>
                                                </tr>
                                                <tr>
                    ...
                    <ClientSideEvents EndCallback="function(s, e) 
{
	...
	if(&quot;Incluir&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(&quot;Dotação Orçamentária incluída com sucesso!&quot;);
    else if(&quot;Editar&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(&quot;Dotação Orçamentária alterada com sucesso!&quot;);
    else if(&quot;Excluir&quot; == s.cp_OperacaoOk)
		mostraDivSalvoPublicado(&quot;Dotação Orçamentária excluída com sucesso!&quot;);
    else if(&quot;Restaurar&quot; == s.cp_OperacaoOk)
        mostraDivSalvoPublicado(&quot;Dotação Orçamentária restaurada com sucesso!&quot;);
}">
                    </ClientSideEvents>
