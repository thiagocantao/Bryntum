<%@ Page Title="" Language="C#" MasterPageFile="~/novaCdis.master" AutoEventWireup="true" CodeFile="ppag_Acoes.aspx.cs" Inherits="administracao_ppag_Acoes" %>
	...
	comando = e.command;
       ...
       s.cp_Sucesso = '';
                                    ...
                                    <Columns>
                                        ...
                                        <dxwgv:GridViewDataTextColumn FieldName="CodigoAcao" Caption="CodigoAcao" Visible="False" VisibleIndex="1"></dxwgv:GridViewDataTextColumn>
                                        ...
                                        <dxwgv:GridViewDataTextColumn FieldName="CodigoPrograma" Caption="CodigoPrograma" VisibleIndex="3" Width="120px" Visible="False"></dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn FieldName="NumeroAcao" Caption="Número" VisibleIndex="5" Width="110px"></dxwgv:GridViewDataTextColumn>
                                        <dxtv:GridViewDataTextColumn Caption="Ação" FieldName="NomeAcao" VisibleIndex="6">
                                        </dxtv:GridViewDataTextColumn>
                                        <dxtv:GridViewDataTextColumn Caption="DataExclusao" FieldName="DataExclusao" Visible="False" VisibleIndex="7">
                                        </dxtv:GridViewDataTextColumn>
                                        <dxtv:GridViewDataTextColumn Caption="Programa" FieldName="NomePrograma" GroupIndex="0" SortIndex="0" SortOrder="Ascending" VisibleIndex="4">
                                        </dxtv:GridViewDataTextColumn>
                                    </Columns>
                        ...
                        <dxpc:PopupControlContentControl runat="server">
                            <table cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <dxe:ASPxLabel runat="server" Text="Ação:" ID="ASPxLabel3"></dxe:ASPxLabel>

                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <dxtv:ASPxTextBox ID="txtAcao" runat="server" ClientInstanceName="txtAcao" Width="100%" MaxLength="500">
                                                <DisabledStyle BackColor="#EBEBEB" ForeColor="Black">
                                                </DisabledStyle>
                                            </dxtv:ASPxTextBox>
                                    ...
                                    <tr>
                                        <td>
                                            <dxtv:ASPxLabel ID="ASPxLabel4" runat="server" Text="Programa:">
                                            </dxtv:ASPxLabel>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <dxtv:ASPxComboBox ID="ddlPrograma" runat="server" ClientInstanceName="ddlPrograma" ValueType="System.Int32" Width="100%">
                                                <Paddings Padding="0px" />
                                            </dxtv:ASPxComboBox>
                                        </td>
                                    </tr>
