<%@ Page Title="" Language="C#" MasterPageFile="~/novaCdis.master" AutoEventWireup="true" CodeFile="tipoPagamentos.aspx.cs" Inherits="administracao_tipoPagamentos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="AreaTrabalho" runat="Server">
                    ...
                    <tr>
                        ...
                        <td align="left" valign="middle" style="padding-left: 10px">
                            <dxe:ASPxLabel ID="lblTituloTela" runat="server" Font-Bold="True"
                                Text="Cadastro de Tipos de Pagamentos">
                            </dxe:ASPxLabel>
                        </td>
                    </tr>
                </table>
	...
	if(&quot;Incluir&quot; == s.cp_OperacaoOk)
		window.top.mostraMensagem(&quot;Tipo de pagamento incluído com sucesso!&quot;, 'sucesso', false, false, null);
    else if(&quot;Editar&quot; == s.cp_OperacaoOk)
		window.top.mostraMensagem(&quot;Tipo de pagamento alterado com sucesso!&quot;, 'sucesso', false, false, null);
    else if(&quot;Excluir&quot; == s.cp_OperacaoOk)
		window.top.mostraMensagem(&quot;Tipo de pagamento excluído com sucesso!&quot;, 'sucesso', false, false, null);
}" />
                    <PanelCollection>
                        <dxp:PanelContent runat="server" SupportsDisabledAttribute="True">
                            ...
                            <dxwgv:ASPxGridView ID="gvDados" runat="server" AutoGenerateColumns="False"
                                ...
                                KeyFieldName="CodigoTipoPagamentos"
...
"
	...
	OnGridFocusedRowChanged(s);
                                ...
                                <Columns>
                                    ...
                                    <dxwgv:GridViewDataTextColumn Caption="Codigo" FieldName="CodigoTipoPagamentos"
                                        Name="CodigoTipoPagamentos" ShowInCustomizationForm="True" Visible="False"
                                        VisibleIndex="1">
                                    </dxwgv:GridViewDataTextColumn>
                                    <dxwgv:GridViewDataTextColumn Caption="Descrição"
                                        FieldName="DescricaoTipoPagamentos" ShowInCustomizationForm="True"
                                        VisibleIndex="2">
                                    </dxwgv:GridViewDataTextColumn>
                                    ...
                                    <dxwgv:GridViewDataTextColumn Caption="DataExclusao" FieldName="DataExclusao"
                                ...
                                <ContentCollection>
                                    <dxpc:PopupControlContentControl runat="server"
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <dxe:ASPxTextBox ID="txtDescricaoTipoPagamento" runat="server"
                                                        ClientInstanceName="txtDescricaoTipoPagamento"
