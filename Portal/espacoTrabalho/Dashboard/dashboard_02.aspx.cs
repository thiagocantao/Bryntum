...
public partial class espacoTrabalho_VisaoCorporativa_dashboard_02 : System.Web.UI.Page
{
    dados cDados;
    public string larguraTela = "", alturaTela = "", larguraTabela = "", metadeAlturaTela = "";

    public string telaEstrategia = "", telaPortfolio01 = "", telaPortfolio02 = "",telaOrcamento01 = "", telaOrcamento02 = "", telaProjetos01 = "", telaProjetos02 = "";
    ...
    private void criaFrames()
    {
        ...
        larguraTela = ((largura) / 4).ToString() + "px";
        int altura = int.Parse(ResolucaoCliente.Substring(ResolucaoCliente.IndexOf('x') + 1)); ;

        alturaTela = (altura - 160).ToString() + "px";
        metadeAlturaTela = ((altura - 160) / 2).ToString() + "px";
        
        string larguraGraficoProjetos = ((largura - 5) / 4 - 15).ToString();
        string alturaGraficoProjetos = ((altura - 160) / 2 - 45).ToString();

        telaPortfolio01 = "../../_Portfolios/VisaoCorporativa/vc_003.aspx?Largura=" + ((largura - 5) / 4) + "&Altura=" + ((altura - 160) / 2);
        telaPortfolio02 = "../../_Portfolios/VisaoCorporativa/vc_004.aspx?Largura=" + ((largura - 5) / 4) + "&Altura=" + ((altura - 160) / 2);
        telaProjetos01 = "../../_Projetos/VisaoCorporativa/vc_001.aspx?Largura=" + ((largura - 5) / 4) + "&Altura=" + ((altura - 160) / 2);
        telaProjetos02 = "../../_Projetos/VisaoCorporativa/vc_002.aspx?Largura=" + larguraGraficoProjetos + "&Altura=" + alturaGraficoProjetos;
        telaOrcamento01 = "../../_Orcamentos/graficos/vc_002.aspx?Largura=" + ((largura - 5) / 4) + "&Altura=" + ((altura - 160) / 2);
        telaOrcamento02 = "../../_Orcamentos/graficos/vc_001.aspx?Largura=" + ((largura - 5) / 4) + "&Altura=" + ((altura - 160) / 2);
        telaEstrategia = "../../_Estrategias/telaDashboard.aspx?Largura=" + ((largura - 5) / 4) + "&Altura=" + (altura - 160);
