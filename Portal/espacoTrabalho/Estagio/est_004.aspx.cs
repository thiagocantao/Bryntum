    ...
    private DataTable getDataTableGrid()
    {
        ...
        if (cDados.getInfoSistema("DataEstagio") != null && cDados.getInfoSistema("DataEstagio").ToString() != "")
        {
            ...
            if (cDados.DataSetOk(ds) && cDados.DataTableOk(ds.Tables[0]))
            {
                ...
                dr["Coluna01"] = String.Format("{0:n0}", double.Parse(ds.Tables[0].Rows[0]["QuantidadeVagasOfertadas"].ToString()));
                dr["Coluna02"] = String.Format("{0:n0}", double.Parse(ds.Tables[0].Rows[0]["QuantidadeVagasPreenchidas"].ToString()));
                dr["Coluna03"] = String.Format("{0:n0}", double.Parse(ds.Tables[0].Rows[0]["QuantidadeVagasNaoPreenchidas"].ToString()));
                ...
                if (ds.Tables[0].Rows.Count > 1)
                {
                    ...
                    dr["Coluna01"] = String.Format("{0:n0}", double.Parse(ds.Tables[0].Rows[1]["QuantidadeVagasOfertadas"].ToString()));
                    dr["Coluna02"] = String.Format("{0:n0}", double.Parse(ds.Tables[0].Rows[1]["QuantidadeVagasPreenchidas"].ToString()));
                    dr["Coluna03"] = String.Format("{0:n0}", double.Parse(ds.Tables[0].Rows[1]["QuantidadeVagasNaoPreenchidas"].ToString()));
                    ...
                    valorMesAnterior = double.Parse(ds.Tables[0].Rows[0]["QuantidadeVagasOfertadas"].ToString());
                    valorMesAtual = double.Parse(ds.Tables[0].Rows[1]["QuantidadeVagasOfertadas"].ToString());

                    variacaoColuna1 = valorMesAnterior == 0 ? 0 : (valorMesAtual - valorMesAnterior) / valorMesAnterior;

                    valorMesAnterior = double.Parse(ds.Tables[0].Rows[0]["QuantidadeVagasPreenchidas"].ToString());
                    valorMesAtual = double.Parse(ds.Tables[0].Rows[1]["QuantidadeVagasPreenchidas"].ToString());

                    variacaoColuna2 = valorMesAnterior == 0 ? 0 : (valorMesAtual - valorMesAnterior) / valorMesAnterior;

                    valorMesAnterior = double.Parse(ds.Tables[0].Rows[0]["QuantidadeVagasNaoPreenchidas"].ToString());
                    valorMesAtual = double.Parse(ds.Tables[0].Rows[1]["QuantidadeVagasNaoPreenchidas"].ToString());
                ...
                if (cDados.DataSetOk(dsVariacoes) && cDados.DataTableOk(dsVariacoes.Tables[0]))
                {
                    ...
                    dr["Coluna01"] = dsVariacoes.Tables[0].Rows[0]["MaxOfertadas"].ToString().Replace('.', ',');
                    dr["Coluna02"] = dsVariacoes.Tables[0].Rows[0]["MaxPreenchidas"].ToString().Replace('.', ',');
                    dr["Coluna03"] = dsVariacoes.Tables[0].Rows[0]["MaxNaoPreenchidas"].ToString().Replace('.', ',');
                    ...
                    dr["Coluna01"] = dsVariacoes.Tables[0].Rows[0]["MinOfertadas"].ToString().Replace('.', ',');
                    dr["Coluna02"] = dsVariacoes.Tables[0].Rows[0]["MinPreenchidas"].ToString().Replace('.', ',');
                    dr["Coluna03"] = dsVariacoes.Tables[0].Rows[0]["MinNaoPreenchidas"].ToString().Replace('.', ',');
