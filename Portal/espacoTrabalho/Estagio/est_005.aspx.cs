    ...
    private DataTable getDataTableGrid()
    {
        ...
        if (cDados.getInfoSistema("DataEstagio") != null && cDados.getInfoSistema("DataEstagio").ToString() != "")
        {
            ...
            if (cDados.DataSetOk(ds) && cDados.DataTableOk(ds.Tables[0]))
            {
                ...
                dr["Coluna01"] = String.Format("{0:n0}", double.Parse(ds.Tables[0].Rows[0]["QuantidadeAlunos"].ToString()));
                dr["Coluna02"] = String.Format("{0:n0}", double.Parse(ds.Tables[0].Rows[0]["QuantidadeEmpresas"].ToString()));
                dr["Coluna03"] = String.Format("{0:n0}", double.Parse(ds.Tables[0].Rows[0]["QuantidadeIES"].ToString()));
                ...
                if (ds.Tables[0].Rows.Count > 1)
                {
                    ...
                    dr["Coluna01"] = String.Format("{0:n0}", double.Parse(ds.Tables[0].Rows[1]["QuantidadeAlunos"].ToString()));
                    dr["Coluna02"] = String.Format("{0:n0}", double.Parse(ds.Tables[0].Rows[1]["QuantidadeEmpresas"].ToString()));
                    dr["Coluna03"] = String.Format("{0:n0}", double.Parse(ds.Tables[0].Rows[1]["QuantidadeIES"].ToString()));
                    ...
                    valorMesAnterior = double.Parse(ds.Tables[0].Rows[0]["QuantidadeAlunos"].ToString());
                    valorMesAtual = double.Parse(ds.Tables[0].Rows[1]["QuantidadeAlunos"].ToString());

                    variacaoColuna1 = valorMesAnterior == 0 ? 0 : (valorMesAtual - valorMesAnterior) / valorMesAnterior;

                    valorMesAnterior = double.Parse(ds.Tables[0].Rows[0]["QuantidadeEmpresas"].ToString());
                    valorMesAtual = double.Parse(ds.Tables[0].Rows[1]["QuantidadeEmpresas"].ToString());

                    variacaoColuna2 = valorMesAnterior == 0 ? 0 : (valorMesAtual - valorMesAnterior) / valorMesAnterior;

                    valorMesAnterior = double.Parse(ds.Tables[0].Rows[0]["QuantidadeIES"].ToString());
                    valorMesAtual = double.Parse(ds.Tables[0].Rows[1]["QuantidadeIES"].ToString());
                ...
                if (cDados.DataSetOk(dsVariacoes) && cDados.DataTableOk(dsVariacoes.Tables[0]))
                {
                    ...
                    dr["Coluna01"] = dsVariacoes.Tables[0].Rows[0]["MaxAlunos"].ToString().Replace('.', ',');
                    dr["Coluna02"] = dsVariacoes.Tables[0].Rows[0]["MaxEmpresas"].ToString().Replace('.', ',');
                    dr["Coluna03"] = dsVariacoes.Tables[0].Rows[0]["MaxIES"].ToString().Replace('.', ',');
                    ...
                    dr["Coluna01"] = dsVariacoes.Tables[0].Rows[0]["MinAlunos"].ToString().Replace('.', ',');
                    dr["Coluna02"] = dsVariacoes.Tables[0].Rows[0]["MinEmpresas"].ToString().Replace('.', ',');
                    dr["Coluna03"] = dsVariacoes.Tables[0].Rows[0]["MinIES"].ToString().Replace('.', ',');
