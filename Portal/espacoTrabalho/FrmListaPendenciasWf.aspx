<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="FrmListaPendenciasWf.aspx.cs" Inherits="espacoTrabalho_PendenciasWorkflow" %>
...
<body style="margin: 0px">
	...
	var url = '';
	var titulo = '';
	var largura = screen.width - 30;
	var altura  =  window.top.innerHeight - 20;


    if (e.buttonID == 'btnGrafico')
	{
		url = window.top.pcModal.cp_Path + '_Portfolios/GraficoProcessoInterno.aspx?CW=' + codigoWorkflow + '&amp;CI=' + codigoInstanciaWf + '&amp;CF=' + codigoFluxo + '&amp;CP=-1&amp;Altura=' + (window.top.innerHeight - 250).toString() + '&amp;Largura=' + (screen.width - 80).toString();
		titulo = traducao.FrmListaPendenciasWf_gr_fico;
	 }
	else
	{
		url = window.top.pcModal.cp_Path + 'wfEngineInterno.aspx?CW=' + codigoWorkflow + '&amp;CI=' + codigoInstanciaWf + '&amp;CE=' + codigoEtapa + '&amp;CS=' + ocorrencia + '&amp;Altura=' +  (window.top.innerHeight - 222).toString() + '&amp;Largura=' + (largura - 80).toString();
		titulo = traducao.FrmListaPendenciasWf_etapa;
	}  
...
"></ClientSideEvents>
                            <Columns>
                                ...
                                <dxcp:GridViewDataTextColumn FieldName="NomeInstanciaWf"
                                    ...
                                    Caption="Nome do Fluxo" VisibleIndex="2">
                            ...
                            <Settings ShowFilterRow="True" ShowHeaderFilterBlankItems="False" ShowGroupPanel="True"
                                VerticalScrollBarMode="Auto" ShowStatusBar="Visible"></Settings>
