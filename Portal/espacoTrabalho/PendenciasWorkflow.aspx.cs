...
public partial class espacoTrabalho_PendenciasWorkflow : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            HttpContext.Current.Response.Redirect(HttpContext.Current.Request.RawUrl.Replace(HttpContext.Current.Request.RawUrl, "FrmListaPendenciasMobileWf2.aspx"));
        }
        ...
        if (!IsPostBack)
        {
            ...
            Master.verificaAcaoFavoritos(true, Resources.traducao.minhas_pend_ncias_de_workflow, "PNDFLX", "ENT", -1, "Adicionar Painel aos Favoritos");
        }
