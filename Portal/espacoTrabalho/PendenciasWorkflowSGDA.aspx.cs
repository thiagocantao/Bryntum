...
public partial class espacoTrabalho_PendenciasWorkflowSGDA : System.Web.UI.Page
{
    dados cDados;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if(Request.QueryString["IP"] + "" == "S")
            url = "./FrmListaPendenciasWfSGDA.aspx?" + Request.QueryString.ToString();
        else
    ...
    private void defineAlturaTela()
    {
        ...
        alturaTela = (alturaPrincipal - 146) + "px";
    }
