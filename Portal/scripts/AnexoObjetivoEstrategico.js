...
function abrePopUp(origem, modoOperacao)
{
    ...
    //se nao for incluir da raiz e sim de uma outra pasta e o numero de linhas for zero
    //colocar codigo de pasta atual também igual a zero.
    window.top.showModal("../../espacoTrabalho/AnexosProjeto_PopUp.aspx?TA=" + hfGeral.Get("IniciaisTipoAssociacao") + "&ID=" + hfGeral.Get("IDObjetoAssociado") + "&O=" + origem + "&CPS=" + codigoPastaSuperior + "&CPA=" + codigoPastaAtual + "&MO=" + modoOperacao + "&CA=" + codigoAnexo + "&UN=" + tlAnexos.cp_UN, traducao.AnexoObjetivoEstrategico_anexos, 650, 265, executaPosPopUp, null);
 }           
