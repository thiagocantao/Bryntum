...
function abrePopUp(origem, modoOperacao)
{
    ...
    window.top.showModal("../../espacoTrabalho/AnexosProjeto_PopUp.aspx?TA=" + hfGeral.Get("IniciaisTipoAssociacao") + "&ID=" + hfGeral.Get("IDObjetoAssociado") + "&O=" + origem + "&CPS=" + codigoPastaSuperior + "&CPA=" + codigoPastaAtual + "&MO=" + modoOperacao + "&CA=" + codigoAnexo, traducao.AnexosProjeto_anexos, 650, 265, executaPosPopUp, window);
