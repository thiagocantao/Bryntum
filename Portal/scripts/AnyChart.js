...
/* ACG:02/06/2015 - Correção do chamado P302525 - TASQUES
   A partir da versão 11, a propriedade "appname" do internet explorer retorna "Netscape" e 
   quando isso acontecer ele não deve ser tratado como "IE", por isso, ajustei a variável para "false" 
------------------------------------------------------------------------------------------------------ */
if (window.navigator.appName == "Netscape")
    ACBrowserInfo.isIE = false;
...
AnyChart.prototype = {
    ...
    * @field {String}
    */
    preloaderInitText: "Carregando...",

    /**
    * Text to be shown while AnyChart is loading  AnyChart.Swf
    * @field {String}
    */
    preloaderLoadingText: "Carregando...",
    ...
    */
    ...
    constructor: function() {
        ...
        this.xmlLoadingText = "Carregando...";
        this.resourcesLoadingText = AnyChart.resourcesLoadingText;
        this.noDataText = "Nenhuma informação a apresentar";
        this.waitingForDataText = "Aguarde...";
        this.templatesLoadingText = "Carregando...";
...
//                }
    ...
    _buildFlashVars: function() {
        ...
        else if (this._mppFile != null)
            res += '&MPPFile=' + this._mppFile;
        if (AnyChart.useBrowserResize && !ACBrowserInfo.isIE)
            res += '&__jsresize=1';
    ...
    */
    ...
    setMPPFile: function(path) {
        path = this._checkPath(path);
        if (this._created || this._loaded)
            this.setMPPFileFromURL(path);
        else
            this._mppFile = path;
    },
    ...
    */
    ...
    setMPPFileFromURL: function(url) {
        if (this.flashObject != null && this.flashObject.SetMPPFileURL != null)
            this.flashObject.SetMPPFileURL(url);
    },
 ...
 * @field {String}
 */
AnyChart.preloaderLoadingText = "Carregando... ";
 ...
 * @field {String}
 */
AnyChart.initText = "Inicializando...";
 ...
 * @field {String}
 */
AnyChart.xmlLoadingText = "Carregando...";
 ...
 * @field {String}
 */
AnyChart.resourcesLoadingText  = "Carregando...";
 ...
 * @field {String}
 */
AnyChart.noDataText = "Nenhuma informação a apresentar.";
/**
 * Text to be shown when AnyChart gets no data source (neither XMLFile nor XMLText is set to chart) 
 * @static
 * @field {String}
 */
AnyChart.waitingForDataText = "Aguardando Dados...";
 ...
 * @field {String}
 */
AnyChart.templatesLoadingText = "Carregando...";
