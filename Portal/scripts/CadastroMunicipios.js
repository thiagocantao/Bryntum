...
{    
   ...
   var numAux = 0;
    ...
    {
        numAux++;
        mensagem += "\n" + numAux + ") " + traducao.CadastroMunicipios_o_nome_do_munic_pio_deve_ser_informado_;
    }
    if(ddlUF.GetValue() == null)
    {
        numAux++;
        mensagem += "\n" + numAux + ") " + traducao.CadastroMunicipios_a_uf_deve_ser_informada_;
    }
...
function OnGridFocusedRowChanged(grid, forcarMontaCampos) 
{
    ...
    {
        grid.GetRowValues(grid.GetFocusedRowIndex(),'CodigoMunicipio;NomeMunicipio;SiglaUF;', MontaCamposFormulario);
    }
}
