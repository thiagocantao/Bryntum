...
{    
   ...
   var numAux = 0;
    ...
    {
        numAux++;
        mensagem += "\n" + numAux + ") " + traducao.CadastroOrigensContratacao_a_origem_de_contrata__o_deve_ser_informada_;
    }
...
function OnGridFocusedRowChanged(grid, forcarMontaCampos) 
{
    ...
    {
        grid.GetRowValues(grid.GetFocusedRowIndex(), 'CodigoOrigemObra;DescricaoOrigemObra;', MontaCamposFormulario);
    }
}
