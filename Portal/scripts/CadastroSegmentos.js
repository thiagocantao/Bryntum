...
{    
   ...
   var numAux = 0;
    ...
    {
        numAux++;
        mensagem += "\n" + numAux + ") " + traducao.CadastroSegmentos_o_segmento_deve_ser_informado_;
    }
...
function OnGridFocusedRowChanged(grid, forcarMontaCampos) 
{
    ...
    {
        grid.GetRowValues(grid.GetFocusedRowIndex(), 'CodigoSegmentoObra;DescricaoSegmentoObra;', MontaCamposFormulario);
    }
}
