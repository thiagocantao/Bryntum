...
function getGraficoMapa(param1, param2, param3, param4, paramXML, paramDiv) {
    var vchart = new FusionMaps(param1, "Map1Id", param3, param4, "0", "0");

    vchart.setDataURL(paramXML);
...
function f_zoomGrafico(caminho, Titulo, graficoSWF, arquivoXml, tipo) {
    window.top.showModal(caminho + "?TIT=" + Titulo + "&Tipo=" + tipo + "&SWF=" + graficoSWF + "&XML=" + arquivoXml, Titulo, 930, (screen.height - 255), null);
}
