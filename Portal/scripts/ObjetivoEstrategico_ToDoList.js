...
function MontaCamposFormulario(valores) {
    ...
    if (values) {
        ...
        if (window.PesoObjetoLink3 != undefined) {
            PesoObjetoLink3.SetValue(pesoObjetoLink);
        }
...
function desabilitaHabilitaComponentes() {
    ...
    if (window.PesoObjetoLink3 != undefined) {
        PesoObjetoLink3.SetEnabled(BoolEnabled);
    }
