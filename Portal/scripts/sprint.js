...
function abrePopupSelecionarItensBacklog(valores) {
    ...
    window.top.showModal(url, traducao.sprint_associar_itens_de_backlog, null, null, atualizaGrid, null);
}
...
function abrePopupSprint(valores) {
    ...
    //function showModal(sUrl, sHeaderTitulo, sWidth, sHeight, sFuncaoPosModal, objParam) {
    window.top.showModal(url, traducao.sprint_editar_sprint, null, null, atualizaGrid, null);
}

function abrePopupSprintInclusao(codigoProjetoAgil) {
    var url = './popupSprint.aspx?CPA=' + codigoProjetoAgil + '&CI=-1&RO=N&ALT=' + 490;
    //function showModal(sUrl, sHeaderTitulo, sWidth, sHeight, sFuncaoPosModal, objParam) {
    window.top.showModal(url, traducao.sprint_incluir_sprint, null, null, atualizaGrid, null);
}
...
function abrePopupSprintReadOnly(valores) {
    ...
    //function showModal(sUrl, sHeaderTitulo, sWidth, sHeight, sFuncaoPosModal, objParam) {
    window.top.showModal(url, 'Visualizar Sprint', null, null, atualizaGrid, null);
}
