...
public partial class wfEngineInternoMobile2 : System.Web.UI.Page
{
    dados cDados;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (CodigoWorkflow > 0)
        {
            ...
            string formularioEdicao = "wfRenderizaFormularioMobile2.aspx?CWF=" + CodigoWorkflow + strReadOnly + engine + acessoEtapaInicial;
            //string formularioEdicao = "wfRenderizaFormulario2.aspx?AT=" + alturaFrameForms + "&WSCR=" + (larguraTela) + "&AlturaWf=" + alturaFrameFluxo.ToString() + strAdd + "&CWF=" + CodigoWorkflow + strReadOnly + engine + acessoEtapaInicial;
            string urlDestinoAposExecutarAcao = "./espacoTrabalho/FrmListaPendenciasMobileWf2.aspx";


            bool mostraBotoes = Request.QueryString["PND"] + "" != "S";

            WorkflowMobile myFluxo = new WorkflowMobile(cDados.classeDados, codigoUsuarioResponsavel, IsPostBack, CodigoWorkflow, CodigoInstanciaWf, CodigoEtapaAtual, OcorrenciaAtual, CodigoProjeto, this.Page, stringConexao, true);
            ...
            form1_div.Controls.Add(pnFluxo);
