...
public partial class wfRenderizaFormularioMobile : System.Web.UI.Page
{
    dados cDados;
    ...
    private void renderizaFormulario()
    {
        ...
        if (codigoModeloFormulario > 0)
        {
            ...
            Control ctrl = myForm.constroiInterfaceFormulario(IsPostBack, codigoFormulario, codigoObjetoAssociado, iniciaisTipoObjeto, "", "");
