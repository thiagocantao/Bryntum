<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfRenderizaFormularioMobile2.aspx.cs"
    Inherits="wfRenderizaFormularioMobile2" %>
         ...
         $(function () {
             jQuery(document).ready(function ($) {
                 ...
                 $('#pnExterno_pnFormulario_pcFormulario_TC').click(
                     function () {
                         closeFirstTab();
                         //$('#pnExterno_pnFormulario_pcFormulario_TC').animate({ width: "120px" }, 10);
                     }
                 );
                 $('#pnExterno_pnFormulario_pcFormulario_CC').click(
                     function () {
                         closeFirstTab();
                         //$('#pnExterno_pnFormulario_pcFormulario_TC').animate({ width: "20px" }, 10);
                     }
                 );
             });
            ...
            //function()
            //{
            //     if($('#pnExterno_pnFormulario_pcFormulario_AT0T').css('margin-left') == '-105px' && 
            //        $('#pnExterno_pnFormulario_pcFormulario_T1T').css('margin-left') == '-105px' && (
            //        $('#pnExterno_pnFormulario_pcFormulario_TC').css('width') == '120px' || 
            //        $('#pnExterno_pnFormulario_pcFormulario_TC').css('width') == '121px'))
            //     {
            //          $('#pnExterno_pnFormulario_pcFormulario_TC').animate({ width: "20px" }, 10);
            //     }
            // });
