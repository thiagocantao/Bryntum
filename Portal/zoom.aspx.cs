...
public partial class zoom : System.Web.UI.Page
{
    ...
    public string alturaGrafico = "", larguraGrafico = "";
    dados cDados;
    ...
    {
        int altura;
        if (cDados.getInfoSistema("ResolucaoCliente") != null && cDados.getInfoSistema("ResolucaoCliente").ToString() != "")
        {
            string ResolucaoCliente = cDados.getInfoSistema("ResolucaoCliente").ToString();
            altura = int.Parse(ResolucaoCliente.Substring(ResolucaoCliente.IndexOf('x') + 1));

            alturaGrafico = (altura - 185).ToString();
        }
