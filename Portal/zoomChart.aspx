<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zoomChart.aspx.cs" Inherits="zoom" %>
                            ...
                            <tr>
                                ...
                                <td style="width: 50px; height: 22px;">
                                    ...
                                    <table style="text-align:center !important">
                                        ...
                                        <tr>
                                            <td><table width="100%" style="align-content:center"><tr><td><div id="chartdiv" style="width:100%; text-align:center !important;" align="center">
                                                </div></td></tr>
                                                </table>
                                            </td>
                                        </tr>
