<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zoomMapaBrasil.aspx.cs" Inherits="zoomMapaBrasil" %>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <script type="text/javascript">
                                                    getGraficoMapa('<%=grafico_swf %>', "grafico_1", '100%', '<%=alturaGrafico %>', '<%=grafico_xml %>', 'chartdiv');
                                                </script>                                                 
                                            </td>
                                        </tr>
                                    </table>
