...
{
    public class FOrcGetEtapasPrevisaoOrcamentariaRepository : RepositoryBaseQuery<FOrcGetEtapasPrevisaoOrcamentariaDomain>, IRepository
    {
        #region Properties
        ...
        /// </summary>
        public FOrcGetEtapasPrevisaoOrcamentariaRepository(DbContext contexto, UnitOfWorkRepository<DomainContext> unitOfWork)
            : base(contexto)
        {
        ...
        /// 
        /// </summary>        
        public IQueryable<FOrcGetEtapasPrevisaoOrcamentariaDomain> ExecFunction(int codEntidade)
        {
            string query = string.Format("SELECT * FROM f_orc_GetEtapasPrevisaoOrcamentaria ({2})",
