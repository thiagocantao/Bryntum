...
{
    public class PSescoopRelMinisterio5200Repository : RepositoryBaseQuery<PSescoopRelMinisterio5200Domain>, IRepository
    {
        #region Properties
        ...
        /// </summary>
        public PSescoopRelMinisterio5200Repository(DbContext contexto, UnitOfWorkRepository<DomainContext> unitOfWork)
            : base(contexto)
        {
        ...
        /// 
        /// </summary>        
        public IQueryable<PSescoopRelMinisterio5200Domain> ExecStoredProcedure(string codigoColigada, int ano1, int ano2, int ano3 )
        {
            string query = string.Format("EXEC [{0}].[{1}].[p_sescoop_relMinisterio_5200] {2}, {3}, {4}, {5}",
