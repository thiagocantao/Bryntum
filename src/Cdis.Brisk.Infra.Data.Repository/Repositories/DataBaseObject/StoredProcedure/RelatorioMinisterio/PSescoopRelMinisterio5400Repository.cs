...
{
    public class PSescoopRelMinisterio5400Repository : RepositoryBaseQuery<PSescoopRelMinisterio5400Domain>, IRepository
    {
        #region Properties
        ...
        /// </summary>
        public PSescoopRelMinisterio5400Repository(DbContext contexto, UnitOfWorkRepository<DomainContext> unitOfWork)
            : base(contexto)
        {
        ...
        /// 
        /// </summary>        
        public IQueryable<PSescoopRelMinisterio5400Domain> ExecStoredProcedure(string codigoColigada, int ano1, int ano2, int ano3)
        {
            string query = string.Format("EXEC [{0}].[{1}].[p_sescoop_relMinisterio_5400] {2}, {3}, {4}, {5}",
